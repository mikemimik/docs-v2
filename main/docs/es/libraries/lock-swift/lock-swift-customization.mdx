...
Color utilizado para el fondo del encabezado. De forma predeterminada, no tiene color, solo un desenfoque.
...
Imagen del logotipo del encabezado. La resolución mínima recomendada es de 200 píxeles (ancho) por 200 píxeles (alto).
...
El icono &quot;close&quot; del encabezado se puede cambiar.
...
El icono de &quot;atrás&quot; del encabezado puede cambiarse.
...
Oculta el título del encabezado y muestra solo el logotipo. De forma predeterminada, esta opción tiene el valor false.
...
Color utilizado para el tinte del botón principal.
...
Color utilizada para el componente deshabilitado de Lock.
...
Color utilizado para el texto de los componentes deshabilitados de Lock.
...
Oculta el título del botón principal y muestra solo el icono. El valor predeterminado de esta opción es false.
...
Color del texto del campo de entrada.
...
El color del texto del marcador de posición en los campos de entrada.
...
El estilo de la barra de búsqueda de Lock <Tooltip tip="Passwordless: Método de autenticación que no depende de una contraseña como primer factor." cta="Ver glosario" href="/docs/es/glossary?term=Passwordless">Passwordless</Tooltip>.
...
Color utilizado como color de fondo de Lock.
...
Cualquier conexión OAuth2 que no sea db puede tener estilos personalizados al mapear un nombre de conexión a un `AuthStyle`
...
Color de la etiqueta separadora de Social.
...
El color del tinte de la pestaña de inicio de sesión con base de datos.
