...
Color utilizado como fondo del encabezado. De forma predeterminada no tiene color, solo un efecto de desenfoque.
...
El icono de &quot;cerrar&quot; del encabezado se puede cambiar.
...
Se puede cambiar el icono &quot;atrás&quot; del encabezado.
...
Oculta el título del encabezado y muestra solo el logotipo. Por defecto, esta opción es false.
...
Texto del título utilizado en el encabezado
...
Color utilizado para los componentes deshabilitados de Lock.
...
Color que se usa como color del texto de los componentes deshabilitados de Lock.
...
Oculta el título del botón principal y muestra solo el icono. Por defecto, esta opción es false.
...
Cualquier conexión OAuth2 que no sea de base de datos puede tener estilos personalizados mediante el mapeo de un nombre de conexión a un `AuthStyle`
...
Color de la etiqueta del separador de Social.
...
El color del tinte de la pestaña de inicio de sesión de base de datos.
