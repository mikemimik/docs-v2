...
Estilo de desenfoque utilizado. Puede ser cualquier valor definido en `UIBlurEffectStyle`.
...
Color usada para el fondo del encabezado. De forma predeterminada, no tiene color, solo un desenfoque.
...
El icono de &quot;cerrar&quot; del encabezado puede modificarse.
...
El icono de &quot;volver&quot; en el encabezado se puede cambiar.
...
Color usada para el tinte del botón principal.
...
Color utilizada para los componentes deshabilitados de Lock.
...
Color utilizada como color del texto del componente deshabilitado de Lock.
...
Color que se usa como color principal de Lock.
...
El estilo de la barra de búsqueda de Lock <Tooltip tip="Passwordless: Forma de autenticación que no utiliza una contraseña como primer factor." cta="Ver glosario" href="/docs/es/glossary?term=Passwordless">Passwordless</Tooltip>.
...
Imagen que se usa como fondo de Lock
...
Cualquier conexión de OAuth2 que no sea de base de datos puede tener estilos personalizados mediante el mapeo de un nombre de conexión a un `AuthStyle`
