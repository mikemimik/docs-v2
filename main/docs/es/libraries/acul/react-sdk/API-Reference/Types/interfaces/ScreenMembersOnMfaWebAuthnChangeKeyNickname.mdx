...
export interface ScreenMembersOnMfaWebAuthnChangeKeyNickname extends ScreenMembers {
  /**
   * Datos específicos de la pantalla que contienen el nickname actual de la clave de WebAuthn.
   * @type {{ nickname: string; } | null}
   */
  data: {
    /**
     * El nickname actual de la clave de seguridad de WebAuthn que el usuario está a punto de cambiar.
  ...
  * Declaración de tipo: `{ nickname: string; }`
  ...
  <Expandable title="propiedades">
    <ParamField body="nickname" type="string">
      ...
      Este valor debe mostrarse al usuario para darle contexto.
