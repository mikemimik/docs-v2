...
<ParamField body="alternateConnections" type={<span><a href="#connection">[conexión]</a> | <a href="/docs/es/libraries/acul/react-sdk/API-Reference/Types/interfaces/EnterpriseConnection">[EnterpriseConnection][]</a></span>} />
...
<ParamField body="currentConnection" type={<span><a href="#connection">[conexión]</a></span>} />
...
<ParamField body="passwordSecurityInfo?" type={<span><a href="/docs/es/libraries/acul/react-sdk/API-Reference/Types/interfaces/PasswordComplexityRule">[PasswordComplexityRule][]</a></span>} />
