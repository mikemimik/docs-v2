...
A continuación, se presentan una serie de preguntas o incidencias que han surgido al usar el SDK.

<div id="how-do-i-import-different-screens-in-my-project">
  ## ¿Cómo puedo importar diferentes pantallas en mi proyecto?
</div>
...
<details>
  <summary>Importación de todas las demás pantallas</summary>
...
<div id="where-can-i-see-errors-related-to-my-screen-and-how-to-handle-them">
  ## Dónde puedo ver los errores relacionados con mi pantalla y cómo manejarlos
</div>
...
1. **Método `getErrors` para errores específicos de la pantalla**
   Puedes usar `getErrors`, una función de nivel superior, para recuperar errores de autenticación detallados cuando falla la validación del backend.
   ```javascript
      import Login from "@auth0/auth0-acul-js/login";
...
Actualmente, este SDK solo está disponible para su instalación a través del registro de npm y no puede usarse directamente desde una CDN.
...
<div id="can-i-build-a-reactjs-application-with-this-sdk">
  ## ¿Puedo desarrollar una aplicación con ReactJS con este SDK?
</div>

Sí, este SDK se puede integrar fácilmente en una aplicación con ReactJS.

Aunque el SDK está escrito en JavaScript puro, es totalmente compatible con cualquier framework basado en JavaScript, incluidos React, Angular, Vue y otros. Puedes usarlo sin problemas dentro de tus componentes o hooks de React.