---
mode: wide
description: Esta guía de inicio rápido muestra cómo añadir la autenticación de Auth0 a una aplicación Java Servlet. Crearás una aplicación web segura con funcionalidades de login, cierre de sesión y perfil de usuario usando el SDK Auth0 Java MVC Commons.
sidebarTitle: Java
title: Añade Login a tu aplicación Java Servlet
---
...
<Accordion title="Usa IA para integrar Auth0" icon="microchip-ai" iconType="solid" defaultOpen>
  ...
  **Luego pídele a tu asistente de IA:**
  ...
  ```text
  Añade la autenticación de Auth0 a mi aplicación Java servlet
  ```

  Tu asistente de IA creará automáticamente tu aplicación de Auth0, obtendrá las credenciales, añadirá la dependencia del SDK Auth0 Java MVC Commons, configurará tu web.xml e implementará flujos de inicio y cierre de sesión con filtros de servlet. [Documentación completa de Agent Skills →](/docs/es/quickstart/agent-skills)
</Accordion>
...
Esta guía de inicio rápido muestra cómo agregar autenticación de Auth0 a una aplicación Java Servlet. Crearás una aplicación web segura con funcionalidades de inicio de sesión, cierre de sesión y perfil de usuario mediante el SDK Auth0 Java MVC Commons.
...
<Steps>
  <Step title="Crear un nuevo proyecto web en Java" stepNumber={1}>
    ...
    <Tabs>
      ...
      <Tab title="Gradle">
        Crea un directorio nuevo e inicializa un proyecto de Gradle:
  ...
  <Step title="Instala el SDK de Auth0 Java MVC Commons" stepNumber={2}>
  ...
  <Step title="Configura tu aplicación de Auth0" stepNumber={3}>
    ...
    6. Por último, en la pestaña **Settings** de la página de detalles de tu aplicación, configura las siguientes URL:
  ...
  <Step title="Configurar el SDK de Auth0" stepNumber={4}>
    Configura tu aplicación servlet para usar el SDK de Auth0 mediante la configuración de `web.xml` con las credenciales de Auth0 generadas anteriormente.

    Crea o actualiza `src/main/webapp/WEB-INF/web.xml` y sustituye los valores de marcador por la configuración real de tu aplicación de Auth0:
    ...
    **Importante**: Reemplaza `YOUR_AUTH0_DOMAIN`, `YOUR_AUTH0_CLIENT_ID` y `YOUR_AUTH0_CLIENT_SECRET` por los valores reales de la configuración de tu aplicación en Auth0.
  </Step>

  <Step title="Crear componentes de autenticación y filtro" stepNumber={5}>
  ...
  <Step title="Páginas de la interfaz de «Crear usuario»" stepNumber={6}>
    ...
    <AuthCodeGroup>
      ...
      <html>
        <head>
          <title>Ejemplo de Java Servlet de Auth0</title>
          <style>
            body {
        ...
        <body>
          <div class="container">
            <h1>Ejemplo de Java Servlet de Auth0</h1>
            <p>
              Este ejemplo muestra cómo agregar autenticación a una aplicación Java servlet
  ...
  <Step title="Compila y ejecuta tu aplicación" stepNumber={7}>
    Ahora ya puedes compilar y ejecutar tu aplicación.
...
<Check>
  **Checkpoint**
  ...
  Ahora ya debería tener una aplicación servlet totalmente funcional integrada con Auth0 en ejecución en [http://localhost:8080/](http://localhost:8080/)

  **Pruebe su implementación:**

  1. Vaya a la URL de su aplicación
  2. Haga clic en &quot;Iniciar sesión con Auth0&quot;
  3. Complete el proceso de inicio de sesión de Auth0
  4. Se le debería redirigir a la página de su perfil, donde se muestran los tokens
...
<Accordion title="Mejore su aplicación">
  Ahora que ya tiene funcionando la autenticación básica, considere estas mejoras:

  * **Información del perfil del usuario**: Decodifique el token de identidad para mostrar información del usuario
  * **Llamadas a la API**: Use el token de acceso para llamar a la Management API de Auth0 o a sus propias API
...
<Accordion title="Recursos adicionales">
  * [Documentación de Auth0 Java MVC Commons](https://github.com/auth0/auth0-java-mvc-common) - [Dashboard
    de Auth0](https://manage.auth0.com/) - Administre sus aplicaciones de Auth0 -
    [Repositorio de ejemplo de Auth0 Servlet](https://github.com/auth0-samples/auth0-servlet-sample) - Ejemplos
    completos - [Documentación de Auth0 Java SDK](https://auth0.com/docs/libraries/auth0-java) - Uso avanzado del SDK
</Accordion>
...
<Accordion title="Resolución de problemas">
  ...
  * Verifique que la URL de devolución de llamada en la configuración de su aplicación de Auth0 coincida exactamente: `http://localhost:8080/callback`

  **Error &quot;Missing domain, clientId, or clientSecret&quot;**

  * Compruebe que la configuración de su `web.xml` tenga los valores correctos de la aplicación de Auth0
  ...
  * Revise los registros del servidor para ver mensajes de error específicos

  **La sesión no persiste**

  * Asegúrese de que su contenedor de servlets esté configurado para la gestión de sesiones
  * Compruebe que las cookies estén habilitadas en su navegador
  * Verifique que se use HTTPS en entornos de producción
