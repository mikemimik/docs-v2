---
mode: wide
description: En este Quickstart se muestra cómo agregar la autenticación de Auth0 a una aplicación Java Servlet. Crearás una aplicación web segura con funciones de inicio de sesión, cierre de sesión y perfil de usuario mediante el SDK Auth0 Java MVC Commons.
sidebarTitle: Java
...
<Accordion title="Usa IA para integrar Auth0" icon="microchip-ai" iconType="solid" defaultOpen>
  Si usas un asistente de programación con IA como Claude Code, Cursor o GitHub Copilot, puedes añadir autenticación de Auth0 automáticamente en cuestión de minutos con [Agent Skills](https://agentskills.io/home).
  ...
  **Luego, pídele a tu asistente de IA:**
  ...
  Tu asistente de IA creará automáticamente tu aplicación de Auth0, obtendrá las credenciales, añadirá la dependencia del SDK Auth0 Java MVC Commons, configurará tu web.xml e implementará los flujos de inicio y cierre de sesión con filtros de servlet. [Documentación completa de Agent Skills →](/docs/es/quickstart/agent-skills)
</Accordion>
...
Este Quickstart muestra cómo añadir autenticación de Auth0 a una aplicación Java Servlet. Crearás una aplicación web segura con funciones de inicio de sesión, cierre de sesión y perfil de usuario usando el SDK Auth0 Java MVC Commons.

<Steps>
  <Step title="Crear un nuevo proyecto web en Java" stepNumber={1}>
    Cree un nuevo proyecto de aplicación web Java para este Quickstart.
    ...
    <Tabs>
      ...
      <Tab title="Gradle">
        Cree un nuevo directorio e inicialice un proyecto de Gradle:
  ...
  <Step title="Instala el SDK de Java MVC Commons de Auth0" stepNumber={2}>
  ...
  <Step title="Configura tu aplicación de Auth0" stepNumber={3}>
    A continuación, debes crear una nueva aplicación en tu tenant de Auth0 y añadir la configuración a tu proyecto.
    ...
    6. Por último, en la pestaña **Settings** de la página Application Details de tu aplicación, configura las siguientes URL:
  ...
  <Step title="Configurar el SDK de Auth0" stepNumber={4}>
    Configura tu aplicación servlet para usar el SDK de Auth0 configurando el archivo `web.xml` con las credenciales de Auth0 generadas anteriormente.

    Crea o actualiza `src/main/webapp/WEB-INF/web.xml` y sustituye los valores de ejemplo por la configuración real de tu aplicación de Auth0:
    ...
    **Importante**: Reemplaza `YOUR_AUTH0_DOMAIN`, `YOUR_AUTH0_CLIENT_ID` y `YOUR_AUTH0_CLIENT_SECRET` por los valores reales de la sección Settings de tu aplicación de Auth0.
  </Step>

  <Step title="Create Componentes de autenticación y Filter" stepNumber={5}>
  ...
  <Step title="Páginas de la interfaz de Crear usuario" stepNumber={6}>
        ...
        <body>
          <div class="container">
            ...
            <p>
              ...
              servlet Java con el SDK Auth0 Java MVC Commons.
            </p>
            <p>
              Haga clic en el siguiente botón para autenticarse con Auth0 y acceder
              a su perfil.
            </p>
  ...
  <Step title="Compila y ejecuta tu aplicación" stepNumber={7}>
    Ya estás listo para compilar y ejecutar tu aplicación.
...
<Check>
  **Comprobación**
  ...
  Ahora deberías tener una aplicación servlet totalmente funcional integrada con Auth0 en ejecución en [http://localhost:8080/](http://localhost:8080/)
  ...
  **Prueba tu implementación:**
  ...
  5. Haz clic en &quot;Cerrar sesión&quot; para borrar la sesión
</Check>
...
<Accordion title="Mejora tu aplicación">
  Ahora que ya tienes la autenticación básica funcionando, considera estas mejoras:
  ...
  * **Acceso basado en roles**: Implementa la autorización usando roles y permisos de Auth0
  * **Inicio de sesión único**: Configura el SSO en varias aplicaciones
</Accordion>
...
<Accordion title="Recursos adicionales">
  * [Documentación de Auth0 Java MVC Commons
    ...
    Dashboard](https://manage.auth0.com/) - Administra tus aplicaciones de Auth0 -
    [Repositorio de ejemplo de Auth0 Servlet
    ](https://github.com/auth0-samples/auth0-servlet-sample) - Ejemplos
    completos - [Documentación de Auth0 Java SDK
    ](https://auth0.com/docs/libraries/auth0-java) - Uso avanzado del SDK
</Accordion>

<Accordion title="Resolución de problemas">
  **Problemas comunes**

  **La autenticación falla con &quot;URL de devolución de llamada no válida&quot;**
  ...
  **Error de &quot;Falta domain, clientId o clientSecret&quot;**
  ...
  * Revisa los registros del servidor para identificar mensajes de error específicos
