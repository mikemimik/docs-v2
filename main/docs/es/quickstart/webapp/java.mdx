---
mode: wide
description: Este guía de inicio rápido muestra cómo añadir la autenticación de Auth0 a una aplicación Java Servlet. Crearás una aplicación web segura con funciones de inicio de sesión, cierre de sesión y perfil de usuario mediante el SDK Auth0 Java MVC Commons.
sidebarTitle: Java
title: Añade el inicio de sesión a tu aplicación Java Servlet
---
...
Esta guía de inicio rápido muestra cómo agregar autenticación de Auth0 a una aplicación Java Servlet. Crearás una aplicación web segura con funciones de inicio de sesión, cierre de sesión y perfil de usuario mediante el SDK Auth0 Java MVC Commons.

<Steps>
  <Step title="Crear un nuevo proyecto web en Java" stepNumber={1}>
    Cree un nuevo proyecto de aplicación web en Java para este Quickstart.
  ...
  <Step title="Configurar el SDK de Auth0" stepNumber={4}>
    Configura tu aplicación servlet para que use el SDK de Auth0 configurando `web.xml` con las credenciales de Auth0 generadas anteriormente.
  ...
  <Step title="Crear componentes y un filtro de autenticación" stepNumber={5}>
  ...
  <Step title="Crear páginas para la interfaz de usuario" stepNumber={6}>
      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <p>
              Haga clic en el botón de abajo para autenticarse con Auth0 y acceder a
              su perfil.
            </p>
  ...
  <Step title="Compila y ejecuta tu aplicación" stepNumber={7}>
    Ya puedes compilar y ejecutar tu aplicación.
...
<Check>
  **Verificación**
  ...
  Ahora debería tener una aplicación servlet totalmente funcional integrada con Auth0 ejecutándose en [http://localhost:8080/](http://localhost:8080/)

  **Pruebe su implementación:**

  1. Vaya a la URL de su aplicación
  2. Haga clic en &quot;Iniciar sesión con Auth0&quot;
  3. Complete el proceso de inicio de sesión con Auth0
...
<Accordion title="Mejora tu aplicación">
  ...
  * **Llamadas a API**: Usa el token de acceso para llamar a la Management API de Auth0 o a tus propias API
  * **Acceso basado en roles**: Implementa la autorización con roles y permisos de Auth0
  * **Inicio de sesión único**: Configura el inicio de sesión único en varias aplicaciones
</Accordion>

<Accordion title="Recursos adicionales">
  * [Documentación de Auth0 Java MVC Commons
    ](https://github.com/auth0/auth0-java-mvc-common) - [Dashboard de Auth0
    ](https://manage.auth0.com/) - Administra tus aplicaciones de Auth0 -
...
<Accordion title="Solución de problemas">
  ...
  **Error &quot;Falta domain, clientId o clientSecret&quot;**
  ...
  * Verifica que se use HTTPS en entornos de producción
  ...
  Para obtener ayuda adicional, visita la [Comunidad de Auth0](https://community.auth0.com/).
</Accordion>