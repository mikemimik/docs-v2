---
title: Agrega el inicio de sesión a tu aplicación Nuxt.js
...
<Accordion title="Usa IA para integrar Auth0" icon="microchip-ai" iconType="solid" defaultOpen>
  ...
  **Luego, pídele a tu asistente de IA:**
  ...
  Tu asistente de IA creará automáticamente tu aplicación de Auth0, obtendrá las credenciales, instalará `@auth0/auth0-nuxt`, configurará el módulo y configurará tus rutas. [Documentación completa de Agent Skills →](/docs/es/quickstart/agent-skills)
</Accordion>
...
Esta guía de inicio rápido muestra cómo añadir la autenticación de Auth0 a una aplicación de Nuxt.js. Crearás una aplicación web de página única segura con funcionalidades de inicio de sesión, cierre de sesión y perfil de usuario mediante el SDK de Auth0 para Nuxt.

<Steps>
  <Step title="Crea un nuevo proyecto" stepNumber={1}>
    Crea un proyecto de Nuxt para esta Quickstart
  ...
  <Step title="Configura tu Auth0 App" stepNumber={3}>
    ...
    <Tabs>
      <Tab title="CLI">
        Ejecuta el siguiente comando de shell en el directorio raíz de tu proyecto para crear una app de Auth0 y generar un archivo `.env`:
      ...
      <Tab title="Dashboard">
        ...
        **Orígenes web permitidos:**
        ...
        <Info>
          ...
          **Allowed Web Origins** es fundamental para la autenticación silenciosa. Sin esta configuración, se les cerrará la sesión a los usuarios cuando actualicen la página o vuelvan más tarde a tu aplicación.
        </Info>
      </Tab>
    </Tabs>
  </Step>

  <Step title="Configurar el módulo de Auth0 para Nuxt" stepNumber={4}>
...
<Check>
  **Verificación**
  ...
  Ahora deberías tener una Auth0 Login Page completamente funcional en ejecución en tu [localhost](http://localhost:3000/)
</Check>