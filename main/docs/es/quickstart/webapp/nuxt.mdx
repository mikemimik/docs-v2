...
description:  Esta guía muestra cómo integrar Auth0, añadir autenticación y mostrar información del perfil de usuario en una aplicación de página única (SPA) que usa Nuxt.js mediante el SDK de Auth0 para Nuxt.js.
mode: wide
---
...
<Callout icon="pencil" color="#FFC107" iconType="solid">
  Este guía de inicio rápido está actualmente en **Beta**. ¡Nos encantaría recibir tus comentarios!
</Callout>

<Accordion title="Usa IA para integrar Auth0" icon="microchip-ai" iconType="solid" defaultOpen>
  Si usas un AI coding assistant como Claude Code, Cursor o GitHub Copilot, puedes añadir la autenticación con Auth0 automáticamente en cuestión de minutos usando [Agent Skills](https://agentskills.io/home).
...
<Note>
  ...
  **Compatibilidad de versiones de Nuxt:** Este guía de inicio rápido funciona con **Nuxt 3.x** sin configuración adicional. Para **Nuxt 4.x**, asegúrate de usar Nuxt 4.2+.
</Note>
...
Esta guía de inicio rápido muestra cómo integrar la autenticación de Auth0 en una aplicación de Nuxt.js. Crearás una aplicación web de página única segura con funciones de inicio de sesión, cierre de sesión y perfil de usuario mediante el SDK de Auth0 para Nuxt.
...
<Steps>
  ...
  <Step title="Configura tu Auth0 App" stepNumber={3}>
    ...
    <Tabs>
      <Tab title="CLI">
        Ejecuta el siguiente comando de shell en el directorio raíz de tu proyecto para crear una Auth0 App y generar un archivo `.env`:
  ...
  <Step title="Configurar el módulo Nuxt de Auth0" stepNumber={4}>
  ...
  <Step title="Crear componentes de inicio de sesión, cierre de sesión y perfil" stepNumber={5}>
    ...
    <CodeGroup>
      ...
      // Simular estado de carga para mejorar la experiencia de usuario
      onMounted(() => {
        pending.value = true
        nextTick(() => {
          pending.value = false
