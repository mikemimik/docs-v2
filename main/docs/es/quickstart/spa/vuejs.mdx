...
sidebarTitle: Vue
description: Esta guía muestra cómo integrar Auth0, agregar autenticación y mostrar información del perfil de usuario en cualquier aplicación de Vue con el SDK de Auth0 para Vue.
mode: wide
---
...
Este Quickstart muestra cómo integrar la autenticación de Auth0 en una aplicación de Vue.js 3. Crearás una aplicación web de página única adaptable con autenticación de usuario segura mediante la API de composición de Vue y el Auth0 Vue SDK.
...
<Steps>
  <Step title="Crear un nuevo proyecto" stepNumber={1}>
    Crea un nuevo proyecto en Vue 3 para este Quickstart
  ...
  <Step title="Instalar el Auth0 Vue SDK" stepNumber={2}>
    ```shellscript
    ...
    <Tabs>
      ...
      <Tab title="CLI">
        ...
        <Note>
          ...
          1. Comprobará si ya estás autenticado (y te pedirá iniciar sesión si es necesario)
      ...
      <Tab title="Dashboard">
        ...
        3. En la ventana emergente, escribe un nombre para tu app, selecciona `Single Page Web Application` como tipo de app y haz clic en **Create**
        ...
        **Allowed Web Origins:**
        ...
        <Info>
          ...
          **Allowed Web Origins** es fundamental para la autenticación silenciosa. Sin esta configuración, los usuarios cerrarán sesión al actualizar la página o al volver más tarde a tu app.
        </Info>
      </Tab>
    </Tabs>
...
<Accordion title="Llamadas a APIs protegidas">
  Configura tu plugin de Auth0 para incluir una audience de API y hacer requests autenticadas:
  ...
  Luego, haz llamadas a la API autenticadas en tus componentes:
