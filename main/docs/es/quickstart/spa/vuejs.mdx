---
title: Añade el inicio de sesión a tu aplicación de Vue
sidebarTitle: Vue
...
<Note>
  ...
  **Compatibilidad de versiones de Vue:** Este Quickstart funciona con **Vue 3.x** y versiones posteriores.
</Note>
...
<Steps>
  <Step title="Crear un nuevo proyecto" stepNumber={1}>
    Crea un nuevo proyecto de Vue 3 para seguir este Quickstart
  ...
  <Step title="Instalar el SDK de Auth0 para Vue" stepNumber={2}>
    ```shellscript
  ...
  <Step title="Configura tu Auth0 App" stepNumber={3}>
    ...
    Tienes tres opciones para configurar tu aplicación de Auth0: usar la herramienta de configuración rápida (recomendada), ejecutar un comando de CLI o configurar manualmente desde el Dashboard:
    ...
    <Tabs>
      ...
      <Tab title="CLI">
        ...
        <Note>
          ...
          1. Comprobará si ya has iniciado sesión (y te pedirá que lo hagas si hace falta)
      ...
      <Tab title="Dashboard">
        ...
        4. Cambia a la pestaña **Settings** en la página de detalles de la aplicación
        ...
        **Allowed Web Origins:**
        ...
        <Info>
          ...
          **Allowed Logout URLs** son esenciales para ofrecer una experiencia de usuario fluida al cerrar sesión. Sin una URL coincidente, los usuarios no volverán a ser redirigidos a tu aplicación después del cierre de sesión y se quedarán en una página genérica de Auth0.
