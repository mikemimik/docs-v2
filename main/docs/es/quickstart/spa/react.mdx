...
Esta guía de inicio rápido muestra cómo añadir la autenticación de Auth0 a una aplicación de React. Crearás una aplicación web de página única segura con funciones de inicio de sesión, cierre de sesión y perfil de usuario con el SDK de Auth0 para React.
...
<Steps>
  <Step title="Crear un nuevo proyecto" stepNumber={1}>
    Crea un nuevo proyecto de React para esta guía de Quickstart
  ...
  <Step title="Agregar el proveedor" stepNumber={4}>
    ...
    import './index.css'; // Importando el archivo CSS principal
  ...
  <Step title="Crear componentes de inicio y cierre de sesión, y de perfil" stepNumber={5}>
    Crear archivos
...
<Accordion title="Proteger rutas con React Router">
...
<Accordion title="Llamar a APIs protegidas">
  ...
  Luego, haz llamadas autenticadas a la API:
