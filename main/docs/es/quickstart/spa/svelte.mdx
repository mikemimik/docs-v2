...
sidebarTitle: Svelte
title: Agrega el inicio de sesión a tu aplicación de Svelte
---
...
<Accordion title="Prompt para IA" defaultOpen icon="microchip-ai" iconType="sharp-solid">
  **¿Usas IA para integrar Auth0?** Añade este prompt a Cursor, Windsurf, Copilot, Claude Code o a tu IDE con IA favorito para acelerar el desarrollo.
  ...
  ROL DE IA Y OBJETIVO PRINCIPAL
  ...
  4. SECUENCIA ESTRICTA: Sigue el "Flujo de ejecución" que se indica a continuación en el orden exacto especificado, sin desviaciones.
  5. CONSTRUIR UNA INTERFAZ ATRACTIVA: DEBES crear una interfaz de inicio de sesión moderna y visualmente atractiva con un estilo adecuado, animaciones y la identidad visual de Auth0.
  ...
  - Crear una aplicación web de página única configurada para http://localhost:5173
...
<Note>
  ...
  **Compatibilidad con versiones de Svelte:** Esta guía de inicio rápido funciona con **Svelte 5.x** y versiones posteriores.
</Note>
...
<Steps>
  <Step title="Crear un nuevo proyecto" stepNumber={1}>
    Crea un nuevo proyecto en Svelte para este Quickstart
  ...
  <Step title="Instala el SDK de SPA de Auth0" stepNumber={2}>
    ```shellscript
    ...
    <Tabs>
      ...
      <Tab title="CLI">
        ...
        <Note>
          ...
          1. Comprobará si ya te autenticaste (y te pedirá iniciar sesión si hace falta)
      ...
      <Tab title="Dashboard">
        ...
        **Allowed Web Origins:**
        ...
        <Info>
          ...
          **Allowed Web Origins** es fundamental para la autenticación silenciosa. Sin esta configuración, los usuarios cerrarán sesión al recargar la página o al volver más tarde a tu aplicación.
        </Info>
      </Tab>
    </Tabs>
  </Step>

  <Step title="Crea la tienda de Auth0" stepNumber={4}>
...
<Tip>
  ¿Sigues atascado? Consulta la [Auth0 Community](https://community.auth0.com/) o el [Discord de SvelteKit](https://svelte.dev/chat) para obtener ayuda.
</Tip>