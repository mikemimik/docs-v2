...
Solo puedes registrar [aplicaciones de terceros](/docs/es/get-started/applications/third-party-applications) mediante CIMD manual, que están sujetas a [controles de seguridad reforzados](/docs/es/get-started/applications/third-party-applications/security-controls). Una vez registradas, [configura tu cliente CIMD](#set-up-cimd-client) como una aplicación de terceros en Auth0.
...
* **Clientes confidenciales**:
  * Solo se admite la [autenticación con Private Key JWT](/docs/es/get-started/authentication-and-authorization-flow/authenticate-with-private-key-jwt#authenticate-with-private-key-jwt); establece `token_endpoint_auth_method` en `private_key_jwt` en los metadatos del cliente
...
* [Promover conexiones al nivel del dominio](/docs/es/get-started/applications/third-party-applications/configure-third-party-applications#configure-connections): Haz que las conexiones estén disponibles a nivel de dominio o de tenant para autenticar a tus usuarios
...
Asegúrate de actualizar el registro de tus claves en Auth0 después de rotarlas. Para obtener más información, consulta [Rotate signing keys](/docs/es/secure/tokens/json-web-tokens/json-web-key-sets#rotate-signing-keys).