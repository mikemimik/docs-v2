...
<Warning>
  ...
  Agreement de Okta](https://www.okta.com/agreements/). Para obtener más información, consulte [Fases
  de lanzamiento del producto](/docs/es/troubleshoot/product-lifecycle/product-release-stages).
</Warning>

Auth0 Universal Components se basa en un sistema de diseño flexible que utiliza [Tailwind CSS](https://tailwindcss.com/docs/installation/using-vite) y [primitivas de Radix UI](https://www.radix-ui.com/primitives/docs/overview/introduction). El estilo se gestiona mediante [`Auth0ComponentProvider`](/docs/es/get-started/universal-components/auth0-component-provider), lo que le permite elegir entre preajustes generales o sobrescrituras detalladas de variables CSS.

Esta arquitectura garantiza que sus flujos de identidad se vean y se sientan como partes nativas de su aplicación.
...
<Tabs>
  <Tab title="React">
    ...
    Listo. Todos los botones, enlaces y estados activos ahora reflejan tu marca.
    ...
    * `classes` - clases de Tailwind o personalizadas aplicadas a partes específicas del componente
    ...
    <Accordion title="Destinos de clase disponibles por componente">
  ...
  <Tab title="Next.js">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      ...
      **Usuarios de Shadcn:** No hace falta importar nada: los estilos ya están incluidos en tu build de Tailwind.
    </Callout>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Radios de borde mayores para una apariencia más suave</td>
        </tr>
      </tbody>
    </table>
    ...
    * `variables` - sobrescrituras de propiedades personalizadas de CSS restringidas al componente
    * `classes` - clases de Tailwind o personalizadas aplicadas a partes concretas del componente
  ...
  <Tab title="shadcn">
    ...
    1. No se necesita ningún import de estilos.
    ...
    ***
    ...
    Los componentes responden automáticamente a la configuración `mode` en `themeSettings`. Para sincronizarlo con el modo oscuro de tu aplicación:
