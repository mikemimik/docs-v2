...
description: Asistente de varios pasos para crear proveedores de SSO con selección de proveedor, configuración de detalles y Setup de autenticación
---
  ...
  <Tab title="React">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      **Se requiere la configuración de Auth0**: asegúrate de que tu tenant esté configurado con la
      My Organization API. [Ver guía de Setup
...
Estas props de presentación controlan cómo se renderiza el componente sin afectar su comportamiento. Úsalas para ocultar secciones o activar el modo de solo lectura.
...
Los props de acción gestionan las interacciones del usuario más allá del flujo principal de creación. Controlan la navegación y el comportamiento de los pasos del asistente.
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Devolución de llamada para la navegación entre pasos.
      </td>
    </tr>
...
Configura el botón para volver atrás en el encabezado del componente. Úsalo para volver a tu lista de proveedores o a la página anterior.
...
Controla la navegación entre los pasos del asistente. Estas funciones callback se ejecutan cuando el usuario hace clic en Next o Previous. Devuelve `false` para impedir la navegación.

**Casos de uso:**

* Validar los datos del paso antes de continuar
* Registrar analíticas al completar pasos
...
Personaliza todo el texto y sus traducciones. Todos los campos son opcionales; si no se proporcionan, se usarán los valores predeterminados.
...
El componente `SsoProviderCreate` está compuesto por subcomponentes y hooks más pequeños. Puedes importarlos individualmente para crear flujos de trabajo personalizados para crear proveedores de SSO si usas shadcn.

<div id="available-subcomponents">
  ### Subcomponentes disponibles
</div>

Para casos de uso avanzados, puedes importar subcomponentes individuales para crear flujos de trabajo personalizados de creación de proveedores de SSO. Esto resulta útil cuando necesitas integrar un solo paso en una UI diferente o personalizar el flujo del asistente más allá de lo que permiten las props.
...
Estos hooks proporcionan la lógica subyacente sin ninguna UI. Úsalos para crear interfaces totalmente personalizadas aprovechando la integración con la API de Auth0.
