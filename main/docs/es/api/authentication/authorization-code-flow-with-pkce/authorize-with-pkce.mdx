---
title: "Autorizar"
description: "Inicia el flujo de código de autorización con PKCE, la concesión de OAuth 2.0 recomendada para aplicaciones móviles y aplicaciones de una sola página."
---
...
Este es el flujo de OAuth 2.0 que utilizan las aplicaciones móviles para acceder a una API. Antes de comenzar con este flujo, debes generar y almacenar un `code_verifier` y, a partir de él, generar un `code_challenge` que se enviará en la solicitud de autorización.
...
<ParamField query="response_type" type="string" required>
  Indica a Auth0 qué flujo de OAuth 2.0 quieres ejecutar. Usa &#39;code&#39; para el flujo código de autorización Grant (PKCE).
...
<ParamField query="code_challenge_method" type="string" required>
  Método que se usa para generar el challenge. Usa `S256`, ya que Auth0 solo admite este método.
...
<ParamField query="prompt" type="string">
  Para iniciar una solicitud de authentication silenciosa, usa `prompt=none`.
</ParamField>
