---
description: Describe las opciones de configuración de la página de MFA alojada para personalizar las propiedades del tema de las páginas de MFA.
...
`languageDictionary` se puede usar para reemplazar el texto en muchas partes del proceso de <Tooltip tip="Autenticación multifactor (MFA): Proceso de autenticación de usuario que utiliza un factor adicional además de nombre de usuario y contraseña, como un código por SMS." cta="Ver glosario" href="/docs/es/glossary?term=MFA">MFA</Tooltip> en la experiencia de Classic Login. Para ello, usa el siguiente formato:
...
...
  ...
  languageDictionary:{ // Usa la opción de diccionario de idiomas
...
A continuación se muestra una lista de las categorías y opciones disponibles.
