---
description: Aprende a usar Auth0 Management API para gestionar los métodos de autenticación MFA de tus usuarios.
...
Este método se basa en autenticarse con una aplicación confidencial. Para obtener más información sobre las aplicaciones confidenciales y públicas, consulta [Confidential and Public Applications](/docs/es/get-started/applications/confidential-and-public-applications).

<div id="get-all-authentication-methods">
  ## Obtener todos los métodos de autenticación
</div>

Usa el endpoint [Obtiene una lista de métodos de autenticación](https://auth0.com/docs/api/management/v2#!/Users/get_authentication_methods) para obtener una lista de todos los métodos de autenticación que un usuario haya registrado completa o parcialmente.

Este endpoint requiere el scope: `read:authentication_methods`.

### Ejemplos

La siguiente solicitud devuelve una lista de todos los métodos de autenticación de un usuario específico.
...
La siguiente solicitud devuelve un solo método de autenticación de un usuario en función del ID del método de autenticación especificado.
...
Envía a los usuarios un OTP por SMS que deberán introducir antes de poder completar la autenticación.
...
Envía a los usuarios un OTP por correo electrónico, que luego se les pedirá que introduzcan antes de poder completar la autenticación. El factor Email solo se admite cuando un usuario no tiene otros factores disponibles.
...
Permite a los usuarios usar una aplicación de autenticación, como Google Authenticator, en su dispositivo personal para generar un OTP que cambia periódicamente y que se les pedirá introducir antes de completar la autenticación.
...
Permita a los usuarios usar claves de seguridad compatibles con FIDO (por ejemplo, [Yubikey](https://www.yubico.com/) o [Google Titan](https://cloud.google.com/titan-security-key)) para realizar autenticación multifactor.

<div id="examples">
  #### Ejemplos
</div>

La siguiente solicitud crea un método de autenticación WebAuthn con claves de seguridad para un usuario.
...
Usa el [endpoint para actualizar todos los métodos de autenticación reemplazándolos por los indicados](https://auth0.com/docs/api/management/v2#!/Users/put_authentication_methods) para sustituir todos los métodos de autenticación existentes por los que se proporcionen.
...
Usa el endpoint [Actualiza un método de autenticación](https://auth0.com/docs/api/management/v2#!/Users/patch_authentication_methods_by_authentication_method_id) para actualizar un único método de autenticación para un usuario.

Este endpoint requiere el scope: `update:authentication_methods`.

### Ejemplos

La siguiente solicitud actualiza un único método de autenticación de un usuario según el ID del método de autenticación especificado.
...
Para cada request válido, la Management API devolverá una respuesta en formato JSON.
...
Usa el endpoint [Elimina todos los métodos de autenticación del usuario especificado](https://auth0.com/docs/api/management/v2#!/Users/delete_authentication_methods) para eliminar todos los métodos de autenticación de un usuario.
...
Para cada solicitud válida, la Management API devolverá una respuesta con un código de estado `204` y cuerpo vacío.
