...
<Warning>
  Para usar campos personalizados, debes habilitar [Dominios personalizados](/docs/es/customize/custom-domains). Si renderizas un formulario con un campo personalizado fuera de un dominio personalizado, se mostrará un error.
</Warning>
...
Agrega pares clave-valor para usarlos como referencia en el código fuente del campo personalizado. Los pares clave-valor pueden incluir [variables](/docs/es/customize/forms/variables) de campos de formulario.
...
Para gestionar requisitos de validación complejos, puedes usar un [flujo](/docs/es/customize/forms/flows).
