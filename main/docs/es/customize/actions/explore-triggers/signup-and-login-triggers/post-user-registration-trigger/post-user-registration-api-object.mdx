...
disponibles en transacciones posteriores, incluso si aún se encuentran dentro de su vigencia.
...
<ResponseField name="options" type="cachesetoptions" post={["optional"]}>
  ...
  <Expandable title="propiedades de options" defaultOpen>
    <ResponseField name="expires_at" type="number" post={["optional"]}>
      ...
      *Nota*: Este valor no debe proporcionarse si también se ha proporcionado un valor
      para `ttl`. Si se proporcionan ambas opciones, se usará
      la fecha de vencimiento más próxima de las dos.
    </ResponseField>
