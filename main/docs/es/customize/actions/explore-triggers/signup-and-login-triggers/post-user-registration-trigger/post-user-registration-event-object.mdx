...
title: 'Triggers de Actions: post-user-registration - Objeto `event`'
...
<ResponseField name="event.authentication" type="dictionary" post={["optional"]}>
  Detalles sobre señales suplementarias de autenticación obtenidas durante el flujo de registro.
        ...
        <ResponseField name="supplemental" type="dictionary" post={["optional"]}>
          ...
          <Expandable title="propiedades de supplemental">
            <ResponseField name="akamai" type="dictionary" post={["optional"]}>
              &#91;acceso anticipado&#93; Evaluación de riesgo suplementaria. Solo está disponible si Akamai Account Protector está habilitado y Akamai reenvía los headers de la transacción.
                ...
                <ResponseField name="akamaiUserRisk" type="dictionary" post={["optional"]}>
                  ...
                  <Expandable title="propiedades de akamaiUserRisk">
                    ...
                    <ResponseField name="emailDomain" type="string" post={["optional"]}>
                      El dominio de email del usuario.
                    </ResponseField>
...
<ResponseField name="event.security_context" type="object" post={["optional"]}>
  Un objeto que contiene firmas de huellas digitales. Solo estará disponible si el cliente usa cloudflare. La huella digital JA3/JA4 puede ser nula o estar vacía en algunos casos. El caso más habitual se da con las solicitudes HTTP, porque JA3 y JA4 se calculan en TLS. También puede estar vacía porque el Worker envía solicitudes dentro de la misma zona o a una zona que no pasa por proxy (o a un tercero).
...
<ResponseField name="event.transaction" type="dictionary" post={["optional"]}>
  ...
  <Expandable title="propiedades de la transacción" defaultOpen>
    ...
    <ResponseField name="requested_scopes" type="array of strings">
      Los scopes solicitados (si los hubiera) al iniciar este flujo de autenticación.
    </ResponseField>
...
<ResponseField name="event.user" type="dictionary">
  ...
  <Expandable title="propiedades del usuario" defaultOpen>
    ...
    <ResponseField name="user_metadata" type="dictionary">
      Campos personalizados que almacenan información sobre un usuario que no afecta a lo que puede o no puede acceder, como la dirección del trabajo, la dirección del hogar o las preferencias del usuario.
    </ResponseField>
