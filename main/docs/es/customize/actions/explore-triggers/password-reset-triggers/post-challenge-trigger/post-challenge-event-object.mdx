...
#
description: Obtenga información sobre el objeto de evento del trigger de Action password-reset-post-challenge, que proporciona información contextual sobre la ejecución del trigger.
...
<ResponseField name="event.authentication" type="dictionary">
  ...
  <Expandable title="propiedades de autenticación" defaultOpen>
      ...
      <Tabs>
        <Tab title="Primer factor">
          <ResponseField name="name" type="string">
            ...
            * También puede ser una URL que indica un método de autenticación personalizado (como segundo factor o posterior).
          </ResponseField>
    ...
    <ResponseField name="riskAssessment" type="dictionary" post={["optional"]}>
      Evaluación de riesgo suplementaria. Esto solo está disponible si la integración con Akamai está habilitada y Akamai reenvía los encabezados de la transacción.
        ...
        <ResponseField name="supplemental" type="dictionary" post={["optional"]}>
          ...
          <Expandable title="Propiedades de supplemental">
            <ResponseField name="akamai" type="dictionary" post={["optional"]}>
              &#91;acceso anticipado&#93; Evaluación de riesgo suplementaria. Esto solo está disponible si Akamai Account Protector está habilitado y Akamai reenvía los encabezados de la transacción.
...
<ResponseField name="event.prompt" type="dictionary" post={["optional"]}>
  Datos recopilados a partir de los prompts personalizados renderizados.
  ...
  <Expandable title="propiedades del prompt" defaultOpen>
    ...
    <ResponseField name="fields" type="dictionary" post={["optional"]}>
      Datos de los campos y campos ocultos.
    </ResponseField>

    <ResponseField name="vars" type="dictionary" post={["optional"]}>
      Datos de las variables compartidas.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="event.transaction" type="dictionary">
  ...
  <Expandable title="propiedades de la transacción" defaultOpen>
    ...
    <ResponseField name="locale" type="string">
      La configuración regional que se usará para esta transacción se determina al comparar los idiomas solicitados por el navegador con la configuración de idioma del tenant.
    </ResponseField>
...
<ResponseField name="event.user" type="dictionary">
  ...
  <Expandable title="propiedades del usuario" defaultOpen>
    ...
    <ResponseField name="enrolledFactors" type="array of objects" post={["optional"]}>
      Un arreglo de factores de autenticación que el usuario ha registrado. Un arreglo vacío significa que el usuario no tiene factores registrados. Si enrolledFactors es undefined, el sistema no pudo obtener la información; el usuario puede tener o no factores registrados.
    ...
    <ResponseField name="identities" type="array of objects">
      ...
      <Expandable title="propiedades del elemento identities" defaultOpen>
        ...
        <ResponseField name="profileData" type="dictionary" post={["optional"]}>
          Información del usuario asociada con la conexión. Cuando los perfiles están vinculados, se completa con la información de usuario asociada de las cuentas secundarias.
        </ResponseField>
