...
#
description: Obtén información sobre el objeto `event` del trigger Posterior al cambio de contraseña de Actions, que proporciona información contextual sobre la ejecución del trigger.
title: 'Triggers de Actions: Posterior al cambio de contraseña - Objeto `event`'
validatedOn: 2026-05-25
---

El objeto `event` del trigger Posterior al cambio de contraseña de Actions proporciona información contextual sobre la ejecución del trigger.
                ...
                <ResponseField name="akamaiBot" type="object" post={["optional"]}>
                  ...
                  <Expandable title="propiedades de akamaiBot">
                    ...
                    <ResponseField name="botScoreResponseSegment" type="string" post={["optional"]}>
                      El segmento de la respuesta de puntuación de bot de los resultados de Akamai Bot Manager.
                    </ResponseField>
...
<ResponseField name="event.user" type="object">
  ...
  <Expandable title="propiedades del usuario" defaultOpen>
    <ResponseField name="email" type="string" post={["optional"]}>
      (único) Correo electrónico del usuario.
    </ResponseField>
