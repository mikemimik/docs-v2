...
#
description: Conoce el objeto `event` del trigger de Action Posterior al cambio de contraseña, que proporciona información contextual sobre la ejecución del trigger.
...
<ResponseField name="event.authentication" type="dictionary" post={["optional"]}>
  Detalles sobre señales de autenticación complementarias obtenidas durante el flujo de cambio de contraseña.
  ...
  <Expandable title="propiedades de authentication" defaultOpen>
    <ResponseField name="riskAssessment" type="dictionary" post={["optional"]}>
      Detalles sobre la información de evaluaciones de riesgo para diferentes flujos.
        ...
        <ResponseField name="supplemental" type="dictionary" post={["optional"]}>
          ...
          <Expandable title="propiedades de supplemental">
            <ResponseField name="akamai" type="dictionary" post={["optional"]}>
              &#91;acceso anticipado&#93; Evaluación de riesgo complementaria. Está disponible solo si Akamai Account Protector está habilitado y Akamai reenvía los headers de la transacción.
...
<ResponseField name="event.connection" type="dictionary">
  Detalles de la conexión utilizada en la transacción actual.
  ...
  <Expandable title="propiedades de la conexión" defaultOpen>
    ...
    <ResponseField name="name" type="string">
      El nombre de la conexión usada para autenticar al usuario (por ejemplo, `twitter` o `some-g-suite-domain`).
    </ResponseField>
...
<ResponseField name="event.transaction" type="object" post={["optional"]}>
  ...
  <Expandable title="propiedades de la transacción" defaultOpen>
    <ResponseField name="correlation_id" type="string" post={["optional"]}>
      El ID de correlación se puede proporcionar en la solicitud inicial de autenticación cuando la aplicación redirige a Universal Login. Puedes usar este valor para correlacionar los registros y las solicitudes de tu código de Action con el flujo del usuario.
    </ResponseField>
  </Expandable>
</ResponseField>
