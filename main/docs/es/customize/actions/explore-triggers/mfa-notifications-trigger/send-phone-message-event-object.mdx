...
#
description: Conozca el objeto `event` del trigger send-phone-message de Actions, que proporciona información contextual sobre la ejecución del trigger.
title: 'Triggers de Actions: send-phone-message - Objeto `event`'
...
<ResponseField name="event.message_options" type="object">
  ...
  <Expandable title="propiedades de message_options" defaultOpen>
    ...
    <ResponseField name="message_type" type="string">
      Cómo se entregará el mensaje: por &#39;sms&#39; o por &#39;voice&#39;.
...
<ResponseField name="event.security_context" type="object" post={["optional"]}>
  Un objeto que contiene firmas de huella digital. Esto solo estará disponible si el cliente usa Cloudflare. La huella digital JA3/JA4 puede ser null o estar vacía en algunos casos. El caso más común es en las solicitudes HTTP, porque JA3 y JA4 se calculan en TLS. También puede estar vacía porque el Worker envía solicitudes dentro de la misma zona o a una zona que no pasa por proxy (o a un tercero).
