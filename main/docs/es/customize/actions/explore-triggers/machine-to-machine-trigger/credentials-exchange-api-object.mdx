...
#
description: Obtenga información sobre el objeto de API del trigger credentials-exchange de Actions.
...
<ResponseField name="reason" type="string" post={["optional"]}>
  Una explicación en lenguaje comprensible para rechazar la concesión del token de acceso.
</ResponseField>
...
Define un claim personalizado en el token de acceso que se emitirá.

<ResponseField name="key" type="string">
  Nombre del claim (ten en cuenta que puede ser necesaria una URL completa).
</ResponseField>
...
Elimina, si existe, el registro que describe un valor almacenado en caché en la
clave proporcionada.
...
valores `ttl` o `expires_at` especificados. Si no se especifica una vigencia, se usará una
...
[Acceso anticipado] Permite realizar cambios en la transacción.
