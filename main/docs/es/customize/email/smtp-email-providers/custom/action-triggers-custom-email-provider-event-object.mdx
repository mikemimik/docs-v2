...
#
description: Obtenga información sobre el objeto `event` del trigger de Action custom-email-provider, que proporciona información contextual sobre la ejecución del trigger.
...
<ResponseField name="event.notification" type="object">
  <Expandable title="propiedades de la notificación" defaultOpen>
    ...
    <ResponseField name="locale" type="string">
      La configuración regional en la que se renderizó el mensaje, por ejemplo `en_US`, según se define en la especificación BCP-47.
    </ResponseField>
