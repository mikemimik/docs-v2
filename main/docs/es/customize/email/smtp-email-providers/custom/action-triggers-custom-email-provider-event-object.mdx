...
#
description: Conozca el objeto `event` del trigger de Action custom-email-provider, que proporciona información contextual sobre la ejecución del trigger.
...
<ResponseField name="event.notification" type="object">
  <Expandable title="propiedades de la notificación" defaultOpen>
    ...
    <ResponseField name="locale" type="string">
      La locale en la que se renderizó el mensaje, por ejemplo `en_US`, según se define en la especificación BCP-47.
    </ResponseField>
...
<ResponseField name="event.tenant" type="object">
  <Expandable title="propiedades del tenant" defaultOpen>
    ...
    <ResponseField name="support_email" type="string" post={["optional"]}>
      La dirección de correo electrónico del servicio de soporte del tenant, si está definida y según figure en su configuración.
    </ResponseField>
...
<ResponseField name="event.transaction" type="object" post={["optional"]}>
  ...
  <Expandable title="propiedades de la transacción" defaultOpen>
    <ResponseField name="correlation_id" type="string" post={["optional"]}>
      Un identificador único para correlacionar esta solicitud entre varios servicios con fines de trazabilidad distribuida.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="event.user" type="dictionary">
  ...
  <Expandable title="propiedades del usuario" defaultOpen>
    ...
    <ResponseField name="user_metadata" type="dictionary">
      Campos personalizados que almacenan información sobre un usuario que no afecta a aquello a lo que puede o no puede acceder, como la dirección del trabajo, la dirección del hogar o sus preferencias.
    </ResponseField>
