...
#
description: Obtén información sobre el objeto `event` del trigger de Actions custom-phone-provider, que ofrece información contextual sobre la ejecución del trigger.
...
<ResponseField name="event.notification" type="object">
  <Expandable title="propiedades de la notificación" defaultOpen>
    <ResponseField name="as_text" type="string">
      El texto, tal como lo renderizamos, listo para entregarse como mensaje de texto.
    </ResponseField>

    <ResponseField name="as_voice" type="string">
      El texto, tal como lo renderizamos, listo para entregarse como mensaje de voz.
    </ResponseField>
    ...
    <ResponseField name="from" type="string" post={["optional"]}>
      El número de teléfono compatible con E.164 del remitente.
    </ResponseField>

    <ResponseField name="locale" type="string" post={["optional"]}>
      El locale con el que renderizamos el mensaje, por ejemplo `en_US`, tal como se define en la especificación BCP-47.
    </ResponseField>
    ...
    <ResponseField name="recipient" type="string">
      El número de teléfono compatible con E.164 del destinatario.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="event.transaction" type="object" post={["optional"]}>
  ...
  <Expandable title="propiedades de la transacción" defaultOpen>
    <ResponseField name="correlation_id" type="string" post={["optional"]}>
      Un identificador único para correlacionar esta solicitud a través de varios servicios para la trazabilidad distribuida.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="event.user" type="dictionary">
  ...
  <Expandable title="propiedades del usuario" defaultOpen>
    <ResponseField name="app_metadata" type="dictionary">
      Campos personalizados que almacenan información sobre un usuario que influye en el acceso del usuario, como el plan de soporte, los roles de seguridad o los grupos de control de acceso.
    </ResponseField>
