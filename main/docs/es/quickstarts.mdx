...
description: Empieza a usar Auth0. Implementa la autenticación para cualquier tipo de aplicación en cuestión de minutos.
---
...
Quickstarts para frameworks populares:
...
Aplicación web tradicional que funciona en el servidor
...
links: [
  ...
  <SectionCard
    item={{
name: "Flujo de autorización de dispositivos",
subtext: "",
logo: "auth0.svg",
date: "",
badge: "",
...
Una API o un servicio protegidos por Auth0
