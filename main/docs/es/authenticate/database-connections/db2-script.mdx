---
description: Proporciona un script de devolución de llamada personalizado para quienes estén integrando con IBM DB2.
title: Script de inicio de sesión para IBM DB2
---

Si estás integrando Auth0 con [IBM DB2](https://www.ibm.com/analytics/us/en/technology/db2), puedes usar el siguiente script para tu proceso de inicio de sesión.
