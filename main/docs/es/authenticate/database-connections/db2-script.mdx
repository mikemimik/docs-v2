---
description: Proporciona un script personalizado de devolución de llamada para quienes integran Auth0 con IBM DB2.
title: Script de inicio de sesión para IBM DB2
---

Si estás integrando Auth0 con [IBM DB2](https://www.ibm.com/analytics/us/en/technology/db2), puedes usar el siguiente script en tu proceso de inicio de sesión.
