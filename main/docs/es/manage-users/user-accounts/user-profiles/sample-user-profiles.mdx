...
title: Ejemplos de perfiles de usuario
---
...
Este es un ejemplo de perfil de usuario de alguien que inició sesión con **Google**:
...
Este es un ejemplo de perfil de **Microsoft Account**:
...
Este es un perfil de ejemplo de **ADFS (Active Directory Federation Services)**:
