...
Le cycle de vie d’une session Auth0 commence lorsqu’un utilisateur se connecte, demeure actif grâce à l’interaction de l’utilisateur et se termine lorsque la session expire ou est explicitement fermée.
...
* exécuter une [authentification silencieuse](/docs/fr-CA/authenticate/login/configure-silent-authentication)
...
La durée de vie de la session est soumise aux limites suivantes :
...
|                 | Connexion requise après    | Durée maximale de session, peu importe l’activité                                                   | 30 jours                         | 365 jours                     |
