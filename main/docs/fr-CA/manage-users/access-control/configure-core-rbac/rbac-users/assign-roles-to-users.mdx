...
* Les rôles sont sélectionnés parmi des valeurs prédéfinies. Si votre liste de rôles est vide, assurez-vous d’abord de [créer des rôles](/docs/fr-CA/manage-users/access-control/configure-core-rbac/roles/create-roles).

<div id="dashboard">
  ## Dashboard
</div>

Il y a deux façons d’attribuer un rôle à un utilisateur. Vous pouvez sélectionner un utilisateur dans la liste **Users**, puis lui attribuer un rôle, ou accéder à la page **User Details** (profil utilisateur) d’un utilisateur en particulier et choisir un rôle à attribuer dans l’onglet **Roles**.
...
<div id="assign-roles-in-user-list">
  ### Attribuer des rôles depuis la liste des utilisateurs
</div>
...
Effectuez une requête `POST` vers le [endpoint Assign User Roles](https://auth0.com/docs/api/management/v2#!/Users/post_user_roles). Assurez-vous de remplacer les valeurs fictives `USER_ID`, `MGMT_API_ACCESS_TOKEN` et `ROLE_ID` par votre ID d’utilisateur, votre <Tooltip tip="Jeton d’accès : information d’authentification, sous la forme d’une chaîne opaque ou d’un JWT, utilisée pour accéder à une API." cta="Voir le glossaire" href="/docs/fr-CA/glossary?term=access+token">jeton d’accès</Tooltip> de la Management API et le ou les ID de rôle correspondants, respectivement.
...
| `ROLE_ID`               | ID du ou des rôles que vous souhaitez ajouter à l’utilisateur spécifié.                                                                 |

<div id="learn-more">
  ## Pour en savoir plus
</div>

* [Gérer les rôles du contrôle d’accès fondé sur les rôles](/docs/fr-CA/manage-users/access-control/configure-core-rbac/roles)
