---
description: Découvrez comment supprimer des permissions attribuées directement à un utilisateur à l’aide de l’Auth0 Dashboard ou de la Management API.
title: Supprimer des permissions attribuées aux utilisateurs
---
...
Vous pouvez supprimer les permissions attribuées directement à un utilisateur à l’aide du <Tooltip tip="Le principal produit d’Auth0 pour configurer vos services." cta="Voir le glossaire" href="/docs/fr-CA/glossary?term=Auth0+Dashboard">Auth0 Dashboard</Tooltip> ou de la <Tooltip tip="Le principal produit d’Auth0 pour configurer vos services." cta="Voir le glossaire" href="/docs/fr-CA/glossary?term=Management+API">Management API</Tooltip>. Les permissions attribuées sont utilisées avec l’ensemble de fonctionnalités Authorization Core pour les API. Pour en savoir plus, consultez [contrôle d’accès basé sur les rôles](/docs/fr-CA/manage-users/access-control/rbac).
...
Effectuez un appel `DELETE` vers le [point de terminaison Delete User Permissions](https://auth0.com/docs/api/management/v2#!/Users/delete_permissions). Assurez-vous de remplacer les valeurs d’espace réservé `USER_ID`, `MGMT_API_ACCESS_TOKEN`, `API_ID` et `PERMISSION_NAME` par votre ID d’utilisateur, le <Tooltip tip="Jeton d’accès : information d’autorisation, sous la forme d’une chaîne opaque ou d’un JWT, utilisée pour accéder à une API." cta="Voir le glossaire" href="/docs/fr-CA/glossary?term=access+token">jeton d’accès</Tooltip> de la Management API, le ou les ID d’API et le ou les noms de permission, respectivement.
...
| `MGMT_API_ACCESS_TOKEN` | [Jeton d’accès pour la Management API](https://auth0.com/docs/api/management/v2/tokens) avec la permission `update:users`. |
| `API_ID`                | ID de la ou des API associées à la ou aux permissions que vous souhaitez retirer pour l’utilisateur spécifié.              |
| `PERMISSION_NAME`       | Nom de la ou des permissions que vous souhaitez retirer pour l’utilisateur spécifié.                                       |
