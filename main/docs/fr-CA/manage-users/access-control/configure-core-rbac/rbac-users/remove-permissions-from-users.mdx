---
description: Découvrez comment supprimer des autorisations attribuées directement à un utilisateur à l’aide de l’Auth0 Dashboard ou de la Management API.
title: Supprimer des autorisations attribuées aux utilisateurs
---
...
2. Cliquez sur la vue **Autorisations**, puis sur l’icône de corbeille à côté de l’autorisation que vous souhaitez supprimer, puis confirmez.

   <Frame>![Détails de l’utilisateur dans Auth0 Dashboard : liste des autorisations attribuées à cet utilisateur](/docs/images/cdy7uua7fh8z/4vShfxoUcSpCDnM5FnAbsR/de85942623430e3cedc097addbaa2f9d/User_Details_-_Permissions_-_English.png)</Frame>

<div id="use-the-management-api">
  ## Utiliser la Management API
</div>

Effectuez un appel `DELETE` au [point de terminaison Delete User Permissions](https://auth0.com/docs/api/management/v2#!/Users/delete_permissions). Assurez-vous de remplacer les valeurs de l’espace réservé `USER_ID`, `MGMT_API_ACCESS_TOKEN`, `API_ID` et `PERMISSION_NAME` par votre ID utilisateur, le <Tooltip tip="Jeton d’accès : information d’authentification, sous la forme d’une chaîne opaque ou d’un JWT, utilisée pour accéder à une API." cta="Voir le glossaire" href="/docs/fr-CA/glossary?term=access+token">jeton d’accès</Tooltip> de la Management API, les ID d’API et les noms d’autorisation, respectivement.
...
| `API_ID`                | ID de l’API ou des API associées à la ou aux autorisations que vous souhaitez retirer pour l’utilisateur indiqué.        |
| `PERMISSION_NAME`       | Nom de la ou des autorisations que vous souhaitez retirer pour l’utilisateur indiqué.                                    |
...
* [Supprimer des autorisations attribuées aux rôles](/docs/fr-CA/manage-users/access-control/configure-core-rbac/roles/remove-permissions-from-roles)
* [Consulter les autorisations des rôles](/docs/fr-CA/manage-users/access-control/configure-core-rbac/roles/view-role-permissions)
