...
* Les rôles sont sélectionnés parmi des valeurs prédéfinies. Si votre liste de rôles est vide, vous devez [créer un rôle](/docs/fr-CA/manage-users/access-control/configure-core-rbac/roles/create-roles).
...
| Valeur                  | Description                                                                                                                                                                  |
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ROLE_ID`               | L’ID du rôle auquel vous souhaitez ajouter des permissions.                                                                                                                  |
