---
description: Découvrez comment supprimer des permissions ajoutées à un rôle à l’aide de l’Auth0 Dashboard ou de la Management API.
title: Supprimer des permissions de rôles
---
...
Vous pouvez supprimer les [permissions](/docs/fr-CA/manage-users/access-control/rbac) attribuées à un rôle à l’aide de <Tooltip tip="Auth0 Dashboard : le produit principal d’Auth0 pour configurer vos services." cta="Voir le glossaire" href="/docs/fr-CA/glossary?term=Auth0+Dashboard">Auth0 Dashboard</Tooltip> ou de la <Tooltip tip="Auth0 Dashboard : le produit principal d’Auth0 pour configurer vos services." cta="Voir le glossaire" href="/docs/fr-CA/glossary?term=Management+API">Management API</Tooltip>. Les permissions et les rôles attribués sont utilisés dans le cadre de l’ensemble de fonctionnalités Authorization Core de l’API.
...
1. Accédez à [Dashboard &gt; User Management &gt; Roles](https://manage.auth0.com/#/roles), puis cliquez sur le nom du rôle que vous souhaitez afficher.
...
| Valeur                  | Description                                                                                                            |
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| `ROLE_ID`               | L’ID du rôle dont vous voulez supprimer des permissions.                                                               |
...
| `API_ID`                | ID de l’API ou des API associées aux permissions que vous souhaitez supprimer pour le rôle spécifié.                   |
| `PERMISSION_NAME`       | Nom des permissions que vous souhaitez supprimer pour le rôle spécifié.                                                |

<div id="learn-more">
  ## En savoir plus
</div>

* [Voir les permissions du rôle](/docs/fr-CA/manage-users/access-control/configure-core-rbac/roles/view-role-permissions)
...
* [Cas d’utilisation types : contrôle d’accès basé sur les rôles](/docs/fr-CA/manage-users/access-control/sample-use-cases-role-based-access-control)