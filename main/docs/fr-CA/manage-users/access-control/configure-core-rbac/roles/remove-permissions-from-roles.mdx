---
description: Découvrez comment supprimer des permissions associées à un rôle à l’aide de l’Auth0 Dashboard ou de la Management API.
title: Supprimer des permissions associées à des rôles
---
...
| Valeur                  | Description                                                                                                            |
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| `ROLE_ID`               | L’ID du rôle auquel vous voulez retirer des permissions.                                                               |
...
| `API_ID`                | ID de la ou des API associées à la ou aux permissions que vous souhaitez retirer pour le rôle indiqué.                 |
| `PERMISSION_NAME`       | Nom de la ou des permissions que vous souhaitez retirer pour le rôle indiqué.                                          |

<div id="learn-more">
  ## En savoir plus
</div>

* [Afficher les permissions du rôle](/docs/fr-CA/manage-users/access-control/configure-core-rbac/roles/view-role-permissions)
