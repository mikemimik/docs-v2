...
Voici un exemple de profil d’utilisateur pour un utilisateur qui s’est connecté avec **Google** :
...
<div id="microsoft-account-user-profile">
  ## Profil d’utilisateur Microsoft Account
</div>

Voici un exemple de profil **Microsoft Account** :
...
<div id="office-365-user-profile">
  ## Profil d’utilisateur Office 365
</div>
...
<div id="adfs-user-profile">
  ## Profil d’utilisateur ADFS
</div>

Voici un exemple de profil issu d’**ADFS (Active Directory Federation Services)** :
