---
description: Exemples de profils utilisateur.
title: Exemples de profils utilisateur
---
...
Voici un exemple de profil utilisateur pour quelqu’un qui s’est connecté avec **Google** :
...
<div id="microsoft-account-user-profile">
  ## Profil utilisateur de Microsoft Account
</div>

Voici un exemple de profil de **Microsoft Account** :
...
Voici un exemple de profil tiré de **Office 365 (Microsoft Azure Active Directory)** :
...
Voici un exemple de profil tiré d’**ADFS (Active Directory Federation Services)** :
