  ...
  <Step title="Installer et configurer le SDK Auth0" stepNumber={2}>
    ...
    **Initialisez le SDK Auth0 dans votre Activity :**
    ...
    <Note>
      ...
      Si vous comptez prendre en charge Web Authentication, consultez [Authentification via Universal Login](/docs/fr-CA/libraries/auth0-android#authentication-via-universal-login).
    </Note>
  </Step>
