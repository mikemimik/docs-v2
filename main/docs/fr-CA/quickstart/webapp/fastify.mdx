...
Ce guide de démarrage rapide montre comment ajouter l’authentification Auth0 à une application Fastify. Vous créerez une appli web sécurisée avec des fonctionnalités de login, de logout et de profil utilisateur à l’aide de l’Auth0 Fastify SDK.
    ...
    <Tabs>
      ...
      <Tab title="CLI">
        ...
        <Note>
          ...
          1. Vérifier si vous êtes déjà authentifié (et demander une connexion au besoin)
      ...
      <div class="container">
        ...
        <div class="profile-card">
          ...
          <div class="profile-info">
            ...
            <p><strong>Courriel :</strong> <%= user.email || 'N/A' %></p>
          </div>
        </div>
...
<Accordion title="Appeler des API protégées avec des jetons d’accès">
  ...
  Récupérez ensuite le jeton d’accès et utilisez-le :
...
<Accordion title="Utilisation de TypeScript">
  Convertissez votre projet en TypeScript pour un typage plus sûr :
...
<AccordionGroup>
  <Accordion title="Problèmes courants et solutions">
    ...
    **Problème :** Il y a une incohérence entre le paramètre state de la requête d’authentification et celui du callback.

    **Solutions :**

    1. Assurez-vous que les cookies sont bien définis (et non bloqués par le navigateur)
    ...
    **Problème :** Erreur « URL de rappel mismatch » provenant d’Auth0.
    ...
    **Solution :**
    ...
    ```javascript
    // Débogage : consigner les valeurs de config (à retirer en production !)
...
* **[Authentification de l’API Fastify](/docs/fr-CA/quickstart/backend/fastify)** - Protégez les points de terminaison de votre API grâce à la validation JWT
...
* **[Mettre en place MFA](https://auth0.com/docs/secure/multi-factor-authentication)** - Ajoutez l’authentification multifacteur
