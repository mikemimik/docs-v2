...
export const sections = [
  ...
  { id: "checkout-nginx-openid-connect-template-repository", title: "Récupérer le dépôt de modèle nginx-openid-connect" },
  ...
  { id: "configure-accept-encoding-header-for-token-and-jwks-endpoints", title: "Configurer l’en-tête Accept-Encoding pour les endpoints de jeton et JWKS" },
...
<Recipe isSingleColumn>
  <Content>
    ...
    <Section id={sections[0].id} title={sections[0].title} stepNumber="1" isSingleColumn>
      Ce tutoriel et le projet de démarrage ont été testés avec les éléments suivants :
    ...
    <Section id={sections[3].id} title={sections[3].title} stepNumber="4" isSingleColumn>
      Exécutez le script configure.sh dans le dossier nginx-openid-connect pour renseigner la configuration du modèle de votre application Auth0 :
      ...
      Ensuite, ajoutez l’[URL de déconnexion de votre tenant](https://auth0.com/docs/api/authentication#auth0-logout) dans votre fichier
    ...
    <Section id={sections[4].id} title={sections[4].title} stepNumber="5" isSingleColumn>
      Ajoutez l’en-tête `Accept-Encoding` et attribuez-lui la valeur `gzip` dans votre
    ...
    <Section id={sections[7].id} title={sections[7].title} stepNumber="8" isSingleColumn>
      Ajoutez des en-têtes supplémentaires tirés du jeton ID (JWT) à la cible en amont dans votre
