...
export const sections = [
  { id: "system-requirements", title: "Exigences système" },
...
<Recipe isSingleColumn>
  <Content>
    ...
    <Section id={sections[1].id} title={sections[1].title} stepNumber="2" isSingleColumn>
      ...
      Suivez le guide d’installation des modules dynamiques pour installer les paquets dans votre système d’exploitation hôte.
    ...
    <Section id={sections[3].id} title={sections[3].title} stepNumber="4" isSingleColumn>
      Exécutez le script configure.sh dans le dossier nginx-openid-connect pour remplir la configuration du modèle de
