---
title: Ajouter la connexion à votre application Nuxt.js
...
<Accordion title="Utiliser l’IA pour intégrer Auth0" icon="microchip-ai" iconType="solid" defaultOpen>
  ...
  **Ensuite, demandez à votre assistant IA :**
  ...
  Votre assistant IA créera automatiquement votre application Auth0, récupérera les informations d’identification, installera `@auth0/auth0-nuxt`, configurera le module et mettra en place vos routes. [Documentation complète sur Agent Skills →](/docs/fr-CA/quickstart/agent-skills)
</Accordion>
...
<Note>
  ...
  **Compatibilité des versions de Nuxt :** Ce quickstart fonctionne avec **Nuxt 3.x** sans configuration supplémentaire. Pour **Nuxt 4.x**, assurez-vous d’utiliser Nuxt 4.2+.
</Note>
...
Ce Quickstart montre comment ajouter l’authentification Auth0 à une application Nuxt.js. Vous créerez une application monopage sécurisée avec des fonctionnalités de login, de logout et de profil utilisateur à l’aide du SDK Auth0 pour Nuxt.
