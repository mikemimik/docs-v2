...
<Note>
  ...
  * **[jq](https://jqlang.org/)** - Requis pour la configuration de l’Auth0 CLI

  **Compatibilité des versions de Nuxt :** Ce quickstart fonctionne avec **Nuxt 3.x** d’emblée. Pour **Nuxt 4.x**, assurez-vous d’utiliser Nuxt 4.2+.
</Note>
...
Ce Quickstart montre comment ajouter l’authentification Auth0 à une application Nuxt.js. Vous créerez une application monopage sécurisée avec des fonctionnalités de connexion, de logout et de profil utilisateur à l’aide du SDK Auth0 pour Nuxt.
...
<Steps>
  ...
  <Step title="Configurez votre Auth0 App" stepNumber={3}>
    ...
    <Tabs>
      ...
      <Tab title="Dashboard">
        ...
        5. Remplacez les valeurs du fichier `.env` par les valeurs **Domain**, **Client ID** et **Client Secret** du Dashboard
        ...
        **Origines Web autorisées :**
        ...
        <Info>
          ...
          **Allowed Logout URLs** sont essentielles pour offrir une expérience utilisateur fluide au moment de la déconnexion. Sans URL correspondante, les utilisateurs ne seront pas redirigés vers votre application après la déconnexion et se retrouveront plutôt sur une page générique d’Auth0.
  ...
  <Step title="Configurer le module Auth0 de Nuxt" stepNumber={4}>
