---
mode: wide
description: Ce Quickstart montre comment ajouter l’authentification Auth0 à une application de servlet Java. Vous créerez une application web sécurisée avec des fonctionnalités de connexion, de logout et de profil utilisateur à l’aide du SDK Auth0 Java MVC Commons.
sidebarTitle: Java
title: Ajouter la connexion à votre application de servlet Java
---
...
<Accordion title="Utiliser l’IA pour intégrer Auth0" icon="microchip-ai" iconType="solid" defaultOpen>
  ...
  **Ensuite, demandez à votre assistant IA :**
  ...
  Votre assistant IA créera automatiquement votre application Auth0, récupérera les informations d’identification, ajoutera la dépendance du SDK Auth0 Java MVC Commons, configurera votre fichier web.xml et mettra en œuvre les flux de connexion et de déconnexion avec des filtres de servlet. [Documentation complète sur Agent Skills →](/docs/fr-CA/quickstart/agent-skills)
</Accordion>
...
Ce Quickstart montre comment ajouter l’authentification Auth0 à une application servlet Java. Vous créerez une application Web sécurisée avec des fonctionnalités de login, de logout et de profil utilisateur à l’aide du SDK Auth0 Java MVC Commons.
...
<Steps>
  ...
  <Step title="Installez le SDK Java MVC Commons d’Auth0" stepNumber={2}>
  ...
  <Step title="Configurer votre application Auth0" stepNumber={3}>
    ...
    3. Dans le popup, entrez un nom pour votre application, sélectionnez **Regular Web Application** comme type d’application, puis cliquez sur **Create**
    ...
    **Origines Web autorisées :**
    ...
    <Note>
      * **Allowed Callback URLs** constituent une mesure de sécurité essentielle pour garantir que les utilisateurs sont redirigés de façon sécuritaire vers votre application après l’authentification. Sans URL correspondante, le processus de connexion échouera et les utilisateurs seront redirigés vers une page d’erreur Auth0 au lieu d’accéder à votre application.
  ...
  <Step title="Configurer le SDK d’Auth0" stepNumber={4}>
    ...
    **Important** : Remplacez `YOUR_AUTH0_DOMAIN`, `YOUR_AUTH0_CLIENT_ID` et `YOUR_AUTH0_CLIENT_SECRET` par les valeurs exactes indiquées dans les paramètres de votre application Auth0.
  </Step>
  ...
  <Step title="Pages d’interface « Créer un utilisateur »" stepNumber={6}>
    ...
    <AuthCodeGroup>
      ...
      <body>
          <div class="profile-container">
              ...
              <p>Votre authentification avec Auth0 a réussi.</p>
  ...
  <Step title="Compilez et exécutez votre application" stepNumber={7}>
...
<Check>
  **Vérification**
  ...
  Vous devriez maintenant avoir une application servlet intégrée à Auth0 entièrement fonctionnelle, en cours d’exécution à l’adresse [http://localhost:8080/](http://localhost:8080/)

  **Testez votre mise en œuvre :**

  1. Accédez à l’URL de votre application
  2. Cliquez sur « Login with Auth0 »
  3. Terminez le processus de connexion avec Auth0
  4. Vous devriez être redirigé vers votre page de profil, où s’affichent les jetons
  5. Cliquez sur « Logout » pour mettre fin à la session
</Check>
...
<Accordion title="Améliorez votre application">
  ...
  * **Accès basé sur les rôles** : Implémentez l’autorisation à l’aide des rôles et permissions d’Auth0
  * **Single Sign-On** : Configurez le SSO entre plusieurs applications
</Accordion>
...
<Accordion title="Ressources supplémentaires">
  * [Documentation d’Auth0 Java MVC Commons
    ...
    d’Auth0](https://manage.auth0.com/) - Gérez vos applications Auth0 -
...
<Accordion title="Dépannage">
  ...
  * Vérifiez que votre configuration `web.xml` contient les bonnes valeurs de votre application Auth0
  ...
  * Vérifiez que toutes les dépendances requises sont dans votre classpath
  * Vérifiez que votre conteneur de servlets prend en charge Servlet API 3.0+
  * Consultez les logs du serveur pour repérer les messages d’erreur précis
