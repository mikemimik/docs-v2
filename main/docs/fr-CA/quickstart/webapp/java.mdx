---
mode: wide
description: Ce guide de démarrage rapide montre comment ajouter l’authentification Auth0 à une application Java servlet. Vous créerez une application Web sécurisée avec des fonctionnalités de connexion, de déconnexion et de profil utilisateur à l’aide du SDK Auth0 Java MVC Commons.
sidebarTitle: Java
title: Ajouter connexion à votre application Java servlet
---
...
<Note>
  ...
  * **Serveur d’application** : [Apache Tomcat](https://tomcat.apache.org/download-90.cgi) 9.0+ ou tout conteneur de servlets
...
Ce Quickstart montre comment ajouter l’authentification Auth0 à une application Java servlet. Vous créerez une application web sécurisée avec des fonctionnalités de connexion, de déconnexion et de profil utilisateur à l’aide du SDK Auth0 Java MVC Commons.
...
<Steps>
  ...
  <Step title="Installez le SDK Auth0 Java MVC Commons" stepNumber={2}>
    Ajoutez la dépendance Auth0 au fichier de génération de votre projet.
  ...
  <Step title="Configurez votre application Auth0" stepNumber={3}>
    ...
    6. Enfin, dans l’onglet **Settings** de la page Application Details, configurez les URL suivantes :
  ...
  <Step title="Configurer le SDK Auth0" stepNumber={4}>
    Configurez votre application servlet pour utiliser le SDK Auth0 en configurant le fichier `web.xml` avec les identifiants Auth0 générés ci-dessus.

    Créez ou mettez à jour `src/main/webapp/WEB-INF/web.xml`, puis remplacez les valeurs de remplacement par les paramètres réels de votre application Auth0 :
    ...
    **Important** : Remplacez `YOUR_AUTH0_DOMAIN`, `YOUR_AUTH0_CLIENT_ID` et `YOUR_AUTH0_CLIENT_SECRET` par les valeurs réelles des paramètres de votre application Auth0.
  </Step>
    ...
    <AuthCodeGroup>
      ...
      public class ProfileServlet extends HttpServlet {
          ...
          protected void doGet(HttpServletRequest req, HttpServletResponse res)
              ...
              // Rediriger vers le JSP du profil
  ...
  <Step title="Pages de l’interface Create User" stepNumber={6}>
        ...
        <body>
          <div class="container">
            ...
            <p>
              ...
              application servlet Java à l’aide du SDK Auth0 Java MVC Commons.
            </p>
            <p>
              Cliquez sur le bouton ci-dessous pour vous authentifier avec Auth0 et
  ...
  <Step title="Créez et exécutez votre application" stepNumber={7}>
...
<Check>
  **Vérification**
  ...
  Vous devriez maintenant avoir une application servlet entièrement fonctionnelle intégrée à Auth0, en cours d’exécution à l’adresse [http://localhost:8080/](http://localhost:8080/)

  **Testez votre mise en œuvre :**

  1. Accédez à l’URL de votre application
  2. Cliquez sur &quot;Login with Auth0&quot;
  3. Terminez le processus de connexion Auth0
  4. Vous devriez être redirigé vers votre page de profil, où les jetons s’affichent
  5. Cliquez sur &quot;Déconnexion&quot; pour mettre fin à la session
</Check>
...
<Accordion title="Améliorez votre application">
  ...
  * **Renseignement du profil utilisateur** : Décodez le ID token pour afficher les renseignements de l’utilisateur
  * **Appels API** : Utilisez le jeton d’accès pour appeler la Management API d’Auth0 ou vos propres API
...
<Accordion title="Ressources supplémentaires">
  * [Documentation d’Auth0 Java MVC Commons
    ](https://github.com/auth0/auth0-java-mvc-common) - [Dashboard
    Auth0](https://manage.auth0.com/) - Gérez vos applications Auth0 -
    [Repository de l’exemple de servlet Auth0
    ](https://github.com/auth0-samples/auth0-servlet-sample) - Exemples
    complets - [Documentation du SDK Java Auth0
...
<Accordion title="Dépannage">
  ...
  * Vérifiez que la callback URL dans les paramètres de votre application Auth0 correspond exactement à : `http://localhost:8080/callback`
  ...
  * Vérifiez que votre conteneur de servlet prend en charge Servlet API 3.0+
  * Consultez les logs du serveur pour repérer des messages d’erreur précis

  **La session n’est pas enregistrée**

  * Assurez-vous que votre conteneur de servlet est configuré pour la gestion des sessions
  * Vérifiez que les cookie sont activés dans votre navigateur
  * Vérifiez que HTTPS est utilisé dans les environnements de production

  Pour obtenir du soutien supplémentaire, visitez la [Auth0 Community](https://community.auth0.com/).
</Accordion>