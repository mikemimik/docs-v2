...
sidebarTitle: Apache
title: Ajouter une fonctionnalité de connexion à votre application Apache
---
...
<Accordion title="Utilisez l’IA pour intégrer Auth0" icon="microchip-ai" iconType="solid" defaultOpen>
  ...
  **Demandez ensuite à votre assistant IA :**
  ...
  Votre assistant IA créera automatiquement votre application Auth0, récupérera les informations d’identification nécessaires et configurera mod&#95;auth&#95;openidc. [Documentation complète sur Agent Skills →](/docs/fr-CA/quickstart/agent-skills)
</Accordion>
...
Ce tutoriel explique comment configurer Apache pour ajouter l’authentification and autorisation à votre web app. Nous vous recommandons d’ouvrir une session pour suivre ce Quickstart avec des exemples configurés pour votre compte.
...
<Check>
  **Checkpoint**
  ...
  Excellent travail ! Si vous vous êtes rendu jusque-là, le login, le logout et les renseignements du profil utilisateur devraient maintenant fonctionner dans votre application.
</Check>
...
Ceci conclut notre tutoriel Quickstart, mais il reste encore beaucoup à explorer. Pour en savoir plus sur ce que vous pouvez faire avec Auth0, consultez :
