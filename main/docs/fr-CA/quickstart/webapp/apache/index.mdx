---
mode: wide
description: Ce tutoriel montre comment configurer Apache afin d’ajouter l’authentification et l’autorisation à votre application web.
sidebarTitle: Apache
title: Ajouter la connexion à votre application Apache
---
...
Ce tutoriel montre comment configurer Apache pour ajouter l’authentification et l’autorisation à votre application web. Nous vous recommandons de vous connecter pour suivre ce guide de démarrage rapide avec des exemples configurés pour votre compte.
...
<Check>
  **Point de contrôle**
  ...
  Excellent travail ! Si vous vous êtes rendu jusque-là, la connexion, le logout et les renseignement du profil utilisateur devraient maintenant fonctionner dans votre application.
</Check>
...
Ceci conclut notre tutoriel guide de démarrage rapide, mais il y a encore beaucoup à explorer. Pour en savoir plus sur ce que vous pouvez faire avec Auth0, consultez :
