...
sidebarTitle: React
description: Ce guide montre comment intégrer Auth0, ajouter l’authentification et afficher les renseignements du profil utilisateur dans une application monopage (SPA) qui utilise React, à l’aide de l’Auth0 React SDK.
mode: wide
---
...
Ce Quickstart montre comment ajouter l’authentification Auth0 à une application React. Vous créerez une application monopage sécurisée avec des fonctionnalités de login, de logout et de profil utilisateur à l’aide du Auth0 React SDK.
...
<Steps>
  ...
  <Step title="Installez le SDK Auth0 React" stepNumber={2}>
    ```shellscript
    ...
    <Tabs>
      ...
      <Tab title="CLI">
        ...
        <Note>
          ...
          1. vérifier si vous êtes authentifié·e (et vous demander de vous connecter au besoin);
      ...
      <Tab title="Dashboard">
        ...
        **Allowed Web Origins :**
        ...
        <Info>
          **Allowed Callback URLs** constituent une mesure de sécurité essentielle pour garantir que les utilisateurs sont redirigés en toute sécurité vers votre application après l’authentication. Sans URL correspondante, le login process échouera et les utilisateurs verront une page d’erreur Auth0 au lieu d’accéder à votre application.

          **Allowed Logout URLs** sont essentielles pour offrir une user experience fluide lors de la déconnexion. Sans URL correspondante, les utilisateurs ne seront pas redirigés vers votre application après le logout et resteront plutôt sur une page Auth0 générique.
...
<Accordion title="Appel aux API protégées">
  ...
  Ensuite, faites des appels authentifiés à l’API :
