...
sidebarTitle: Vue
description: Ce guide explique comment intégrer Auth0, ajouter l’authentification et afficher les renseignements du profil utilisateur dans toute application Vue à l’aide du SDK Auth0 Vue.
mode: wide
---
...
<Note>
  ...
  **Compatibilité des versions de Vue :** Ce Quickstart fonctionne avec **Vue 3.x** et les versions ultérieures.
</Note>
...
Ce Quickstart montre comment intégrer l’authentification Auth0 à une application Vue.js 3. Vous créerez une application monopage adaptative avec une authentification utilisateur sécurisée à l’aide de l’API Composition de Vue et du SDK Auth0 Vue.
      ...
      <Tab title="Dashboard">
        ...
        **Allowed Web Origins:**
        ...
        <Info>
          ...
          **Allowed Web Origins** est essentiel pour l’authentification silencieuse. Sans cette configuration, les utilisateurs seront déconnectés lorsqu’ils actualiseront la page ou reviendront plus tard dans votre application.
        </Info>
      </Tab>
    </Tabs>
...
<Accordion title="Appeler des API protégées">
  Configurez votre plugin Auth0 pour inclure l’audience d’une API et effectuer des requêtes authentifiées :
  ...
  Effectuez ensuite des appels API authentifiés dans vos composants :
...
<Accordion title="Utiliser des composables pour la logique d’authentification">
  Créez des composables réutilisables pour les scénarios d’authentification courants :
