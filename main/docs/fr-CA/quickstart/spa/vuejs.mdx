...
sidebarTitle: Vue
description: Ce guide explique comment intégrer Auth0, ajouter l’authentification et afficher les renseignements du profil utilisateur dans n’importe quelle application Vue à l’aide de l’Auth0 Vue SDK.
mode: wide
---
...
<Note>
  ...
  **Compatibilité des versions de Vue :** Ce guide de démarrage rapide fonctionne avec **Vue 3.x** et les versions plus récentes.
</Note>
