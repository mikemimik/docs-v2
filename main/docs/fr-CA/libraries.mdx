...
Les bibliothèques SDK Auth0 permettent aux développeurs d’intégrer facilement Auth0 et d’interagir avec ses services. Découvrez une bibliothèque sur GitHub, téléchargez un exemple d’application ou utilisez un Quickstart pour obtenir de l’aide personnalisée.

<div id="single-page-application-spa-sdk-libraries">
  ## Bibliothèques SDK pour les applications monopages (SPA)
</div>

Vous devez protéger une application JavaScript qui fonctionne entièrement dans un navigateur? Choisissez votre technologie ci-dessous.
...
<div id="backend-service-and-api-sdk-libraries">
  ## Bibliothèques SDK pour les services backend et les API
</div>

Votre API ou votre service a-t-il besoin d’authentification ? Auth0 propose des SDK pour les outils courants de développement d’API et de services.
...
<div id="advanced-customization-for-universal-login-acul">
  ## Personnalisation avancée de Universal Login
</div>

Étendez les capacités de [Universal Login](/docs/fr-CA/authenticate/login/auth0-universal-login/universal-login-vs-classic-login/universal-experience#universal-login-experience) pour prendre en charge le multimarque, des configurations de sécurité complexes et l’intégration de nombreuses plateformes d’analyse.
