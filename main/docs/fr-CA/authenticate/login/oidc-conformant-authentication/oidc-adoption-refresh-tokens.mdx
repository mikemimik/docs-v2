...
* Ne seront plus renvoyés lors de l’utilisation de l’[octroi implicite](/docs/fr-CA/get-started/authentication-and-authorization-flow/implicit-flow-with-form-post) pour l’authentification.
...
De plus, la structure du jeton d’actualisation présente certaines différences. Pour en savoir plus, consultez [Refresh Tokens](/docs/fr-CA/secure/tokens/refresh-tokens).
...
<Warning>
  Les jetons d’actualisation doivent demeurer confidentiels pendant leur transmission et leur stockage, et ne doivent être partagés qu’entre le serveur d’autorisation et le client auquel ils ont été émis.
</Warning>
...
* [Flux d’identification du client avec OIDC](/docs/fr-CA/authenticate/login/oidc-conformant-authentication/oidc-adoption-client-credentials-flow)
