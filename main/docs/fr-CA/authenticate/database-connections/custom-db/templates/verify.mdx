---
description: Décrit les modèles de scripts d’action de base de données personnalisée pour la vérification de l’adresse courriel de l’utilisateur.
...
La fonction `verify` prend deux paramètres et renvoie une fonction `callback` :
...
Voici un exemple en pseudo-JavaScript montrant comment vous pourriez implémenter la fonction `login`. Pour des exemples de scripts propres au langage, consultez [exemple de script par langage](/docs/fr-CA/authenticate/database-connections/custom-db/templates/verify#language-specific-script-examples).
...
Si le statut de vérification de l&#39;utilisateur a été mis à jour avec succès dans la base de données externe, passez la valeur `null` pour le paramètre `error` et la valeur `true` pour le paramètre `verified`.
...
* [Modèle de script pour Login](/docs/fr-CA/authenticate/database-connections/custom-db/templates/login)
* [Modèle de script pour Get User](/docs/fr-CA/authenticate/database-connections/custom-db/templates/get-user)
* [Modèle de script pour Create](/docs/fr-CA/authenticate/database-connections/custom-db/templates/create)
* [Modèle de script pour Delete](/docs/fr-CA/authenticate/database-connections/custom-db/templates/delete)
* [Modèle de script pour Change Password](/docs/fr-CA/authenticate/database-connections/custom-db/templates/change-password)
