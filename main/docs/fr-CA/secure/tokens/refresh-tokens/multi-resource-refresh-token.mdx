...
* Une réduction du risque de [limite de débit](/docs/fr-CA/troubleshoot/customer-support/operational-policies/rate-limit-policy) causé par des flux complets de code d’autorisation répétés.
...
Découvrez comment [configurer et mettre en œuvre un jeton d’actualisation multiresource](/docs/fr-CA/secure/tokens/refresh-tokens/multi-resource-refresh-token/configure-and-implement-multi-resource-refresh-token).
