...
1. [Configurer compte connecté pour Token Vault](/docs/fr-CA/secure/tokens/token-vault/configure-token-vault#configure-connected-accounts-for-token-vault) pour une connexion sociale ou d’entreprise prise en charge.
