...
Cette méthode repose sur l&#39;authentification au moyen d&#39;une application confidentielle. Pour en savoir plus sur les applications confidentielles et les applications publiques, consultez [Confidential and Public Applications](/docs/fr-CA/get-started/applications/confidential-and-public-applications).
...
Pour chaque requête valide, la <Tooltip tip="Management API : Un produit qui permet aux clients d’effectuer des tâches administratives." cta="Voir le glossaire" href="/docs/fr-CA/glossary?term=Management+API">Management API</Tooltip> renvoie une réponse au format JSON.
