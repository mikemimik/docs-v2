...
<div id="mfa-prompt-details">
  ## Détails de l’écran MFA
</div>

Lorsque Adaptive MFA est activé, les utilisateurs seront invités à s’inscrire à la MFA lors de leur première tentative de connexion présentant un faible score de confiance. Un écran **mfa** peut apparaître dans les détails de l’événement de connexion. Par exemple :
