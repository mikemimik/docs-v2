---
description: Décrit comment configurer Cisco Duo Security pour l’AMF.
...
L’application demandera à l’utilisateur de fournir le deuxième facteur avec Duo et affichera les options que vous avez activées dans votre compte Duo.
