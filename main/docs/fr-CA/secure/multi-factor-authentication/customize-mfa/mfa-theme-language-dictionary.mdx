---
description: Décrit les options de configuration des pages MFA hébergées permettant de personnaliser les propriétés du thème de ces pages.
...
errorMessages: {
  ...
  // tenant_not_found | Le tenant associé est introuvable. Cela ne devrait normalement pas arriver, à moins que vous ne supprimiez le tenant.
...
* [Personnaliser l’authentification MFA pour Classic Login](/docs/fr-CA/secure/multi-factor-authentication/customize-mfa/customize-mfa-classic-login)