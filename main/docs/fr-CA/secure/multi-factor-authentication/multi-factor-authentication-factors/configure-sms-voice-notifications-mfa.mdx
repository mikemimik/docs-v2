...
2. Cliquez sur **Phone Message** et activez le commutateur en haut.
...
3. Configurez la connexion. Accédez à [Dashboard &gt; Sécurité - Multi-factor Auth](https://manage.auth0.com/#/security/mfa) et choisissez **Phone Message**.
...
Auth0 limite chaque utilisateur à l’envoi d’un maximum de 10 messages SMS ou vocaux par heure, et les flux OTP par courriel ou au moyen d’authenticators sont limités à cinq requêtes toutes les cinq minutes. (Le taux de rafale est de 10, mais seulement 1 message vocal par heure sera envoyé pour les nouvelles requêtes.) Pour mieux protéger votre compte, envisagez ce qui suit :
