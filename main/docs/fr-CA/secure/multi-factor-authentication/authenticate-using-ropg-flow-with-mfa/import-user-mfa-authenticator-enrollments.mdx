...
Tout échec apparaîtra dans les journaux de votre tenant sous forme d’échec de connexion, et pourra être distingué des autres échecs par sa description : `Unable to import MFA factors`. Par exemple :
