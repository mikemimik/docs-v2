...
Vous pouvez obtenir des configurations d’authentification multifacteur plus granulaires (par application, par utilisateur, etc.) en utilisant Auth0 Actions. Pour en savoir plus, consultez [Auth0 Actions](/docs/fr-CA/customize/actions).
