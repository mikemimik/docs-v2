...
L’utilisation de `requestToken` ou de `ticket` dépend de la méthode d’authentification. Le ticket correspond à un [ticket d’enrôlement généré précédemment](/docs/fr-CA/secure/multi-factor-authentication/multi-factor-authentication-developer-resources/create-custom-enrollment-tickets).
