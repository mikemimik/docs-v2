...
Le composant `SsoProviderEdit` fournit une interface unifiée pour modifier les fournisseurs [d’authentification unique](/docs/fr-CA/authenticate/enterprise-connections/self-service-enterprise-configuration).
...
<Tabs>
  <Tab title="React">
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>
            Active le provisionnement SCIM.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Désactive le provisionnement SCIM.
          </td>
        </tr>
    ...
    ***
    ...
    La propriété `domains` configure les actions de l&#39;onglet des domaines. Cet onglet gère les domaines associés au fournisseur pour le routage automatique des utilisateurs.
    ...
    **schema**
    ...
    <Accordion title="Champs du schéma disponibles">
      Tous les champs du schema prennent en charge : `regex`, `errorMessage`, `minLength`, `maxLength`, `required`
    ...
    **customMessages**
    ...
    <Accordion title="Messages disponibles">
      ...
      * `title`, `description`
      * `fields.*` - Libellés des champs de formulaire selon la stratégie
    ...
    **mise en forme**
    ...
    Personnalisez l&#39;apparence avec des variables CSS et des surcharges de classes. Prend en charge la mise en forme selon le thème.
  ...
  <Tab title="Next.js">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      L’exécution des commandes npm ou pnpm installe la dépendance @auth0/universal-components-core, qui fournit des utilitaires partagés et l’intégration à Auth0.
    </Callout>
    ...
    * `onAfter(provider, result)` - S’exécute une fois que le provider a été mis à jour avec succès. Utilisez cette option pour afficher une notification ou consigner l’événement.
    ...
    **customMessages**
    ...
    <Accordion title="Messages disponibles">
      ...
      **provisioning&#95;tab** - Onglet de Provisioning
    ...
    ***
    ...
    Ces hooks fournissent la logique sous-jacente sans aucune interface utilisateur. Utilisez-les pour créer des interfaces entièrement personnalisées tout en tirant parti de l&#39;intégration de l&#39;Auth0 API.
  ...
  <Tab title="shadcn">
    ...
    * `disabled` - Désactive le bouton Enregistrer
    * `onBefore(provider)` - S’exécute avant la mise à jour. Retournez `false` pour empêcher l’enregistrement (p. ex., pour afficher une boîte de dialogue de confirmation).
    * `onAfter(provider, result)` - S’exécute une fois le Provider mis à jour avec succès. Utilisez-le pour afficher une notification ou faire le suivi de l’événement.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Associer le domaine à un fournisseur.
          </td>
        </tr>
    ...
    ***
    ...
    Le composant `SsoProviderEdit` est composé de sous-composants et de hooks plus petits. Vous pouvez les importer individuellement pour créer des workflows personnalisés de gestion de fournisseur SSO si vous utilisez shadcn.

    ### Sous-composants disponibles

    Pour des cas d&#39;utilisation avancés, vous pouvez importer des composants d&#39;onglets individuels pour créer des interfaces d&#39;édition de Custom Provider.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Onglet de Provisioning SCIM</td>
        </tr>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>État des onglets et gestionnaires d’action</td>
        </tr>
      </tbody>
    </table>
  </Tab>
