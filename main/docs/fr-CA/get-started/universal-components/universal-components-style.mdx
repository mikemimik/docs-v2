...
Auth0 Universal Components repose sur un système de design flexible qui utilise [Tailwind CSS](https://tailwindcss.com/docs/installation/using-vite) et les [primitives Radix UI](https://www.radix-ui.com/primitives/docs/overview/introduction). La personnalisation visuelle est gérée par [`Auth0ComponentProvider`](/docs/fr-CA/get-started/universal-components/auth0-component-provider), ce qui vous permet de choisir entre des préréglages généraux ou des surcharges précises de variables CSS.
