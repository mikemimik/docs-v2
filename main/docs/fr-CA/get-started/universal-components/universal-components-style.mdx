...
Auth0 Universal Components repose sur un système de design souple qui utilise [Tailwind CSS](https://tailwindcss.com/docs/installation/using-vite) et les [primitives de Radix UI](https://www.radix-ui.com/primitives/docs/overview/introduction). Le style est géré par [`Auth0ComponentProvider`](/docs/fr-CA/get-started/universal-components/auth0-component-provider), ce qui vous permet de choisir entre des préréglages généraux et des substitutions précises de variables CSS.

Cette architecture permet à vos flows d’identité de s’intégrer naturellement à votre application.
...
<Tabs>
  <Tab title="React">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      **Si vous utilisez Tailwind v4 :** ajoutez `@import "@auth0/universal-components-react/tailwind"` à votre fichier CSS.
    </Callout>
    ...
    * `variables` - redéfinitions de propriétés CSS personnalisées limitées au composant
  ...
  <Tab title="Next.js">
    ...
    * `classes` - classes Tailwind ou personnalisées appliquées à certaines parties du composant
    ...
    <Accordion title="Classes disponibles par composant">
  ...
  <Tab title="shadcn">
    ...
    1. Aucune importation de feuille de style n’est nécessaire.
    ...
    * `classes` - classes Tailwind ou personnalisées appliquées à des parties précises du composant
    ...
    <Accordion title="Classes cibles disponibles par composant">
      Chaque composant expose des classes cibles pour ses sections principales :
