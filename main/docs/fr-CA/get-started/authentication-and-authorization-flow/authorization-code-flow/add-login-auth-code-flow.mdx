...
Enregistrez votre application dans Auth0. Pour en savoir plus, consultez [Enregistrer des applications Web traditionnelles](/docs/fr-CA/get-started/auth0-overview/create-applications/regular-web-apps).
...
* Assurez-vous que les **types d’autorisation** de votre application incluent **Code d’autorisation**. Pour en savoir plus, consultez [Mettre à jour les types d’autorisation](/docs/fr-CA/get-started/applications/update-grant-types).
...
* [Mettre à jour les type d’autorisations](/docs/fr-CA/get-started/applications/update-grant-types)