...
<Tabs>
  ...
  <Tab title="Management API">
    ...
    Vous pouvez aussi utiliser le SDK Go de notre Management API. Pour en savoir plus, consultez [SDKs](/docs/fr-CA/libraries) :
...
Pour l’application Auth0 Guardian comme pour une application personnalisée, vous devez [inscrire l’utilisateur autorisant à l’AMF à l’aide des notifications push](/docs/fr-CA/secure/multi-factor-authentication/auth0-guardian#enroll-in-push-notifications).
