...
description: "Décrit tous les hooks et méthodes offerts pour personnaliser l’écran `mfa-enroll-result` de l’expérience Universal Login."
---
...
Hooks associés à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-enroll-result`. Importez-les depuis `@auth0/auth0-acul-react/mfa-enroll-result`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations de Branding, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `mfa-enroll-result`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organization de l’utilisateur si le flux d’AMF est associé à une Organization. Renvoie `null` lorsqu’aucun contexte d’Organization n’est présent.
