...
description: "Décrit tous les hooks et toutes les méthodes offerts pour personnaliser l’écran `mfa-webauthn-change-key-nickname` dans Universal Login."
---
...
Des hooks associés à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-webauthn-change-key-nickname`. Importez-les depuis `@auth0/auth0-acul-react/mfa-webauthn-change-key-nickname`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les configurations d’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `mfa-webauthn-change-key-nickname`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit les configurations liées au client, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-webauthn-change-key-nickname`.
...
<ParamField body="useMfaWebAuthnChangeKeyNickname" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaWebAuthnChangeKeyNicknameMembers">MfaWebAuthnChangeKeyNicknameMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles à l’écran `mfa-webauthn-change-key-nickname`.
</ParamField>
...
<ParamField body="continueWithNewNickname" type="Promise<void>">
  Cette méthode envoie le nouveau surnom de la clé de sécurité WebAuthn déjà enregistrée.
