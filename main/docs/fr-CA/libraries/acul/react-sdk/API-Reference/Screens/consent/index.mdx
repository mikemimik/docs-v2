...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/6cK6DkpOJYTjubOGu2vpID/80c03b32275a2c332fe3216df0eca5c7/Consent.png" alt="Consentement ACUL" />
</Frame>
...
Des hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte d’Auth0 dans l’écran `consent`. Importez-les depuis `@auth0/auth0-acul-react/consent`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations d’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `consent`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organization de l’utilisateur si la demande de consentement est limitée à une Organization. Il retourne `null` lorsqu’aucun contexte d’Organization n’est présent.
...
<ParamField body="useConsent" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ConsentMembers">ConsentMembers</a>}>
  Ce hook renvoie toutes les méthodes et le contexte disponibles sur l’écran `consent`.
</ParamField>
...
<ParamField body="accept" type="Promise<void>">
  Cette méthode envoie le consentement de l’utilisateur et accorde à l’application les permissions demandées.
...
<ParamField body="deny" type="Promise<void>">
  Cette méthode refuse la demande de consentement et retire à l’application les permissions demandées.
