...
L’écran `mfa-recovery-code-challenge` demande à l’utilisateur de saisir son code de récupération pour vérifier son identité lorsque les autres méthodes AMF ne sont pas disponibles.
...
Hooks limités à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-recovery-code-challenge`. Importez-les depuis `@auth0/auth0-acul-react/mfa-recovery-code-challenge`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’organisation de l’utilisateur si le flux d’AMF est limité à l’organisation. Retourne `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `mfa-recovery-code-challenge`, comme l’état actuel du flux d’AMF.
...
<ParamField body="continueMethod" type="Promise<void>">
  Cette méthode soumet le code de récupération de l’utilisateur pour terminer l’étape de vérification AMF.
