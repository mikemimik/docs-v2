...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `mfa-sms-challenge` de l’expérience Universal Login."
---
...
* L’importation à la racine vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est pratique si vous voulez qu’une build unifiée prenne en charge tous les écrans possibles.
...
Hooks à portée d’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-sms-challenge`. Importez-les depuis `@auth0/auth0-acul-react/mfa-sms-challenge`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit de l’information sur l’organisation de l’utilisateur si le flux AMF est associé à une organisation. Renvoie `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useUser" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/UserMembers">UserMembers</a></span>}>
  Ce hook fournit les détails sur l’utilisateur actif, y compris le `username`, l’`email` et les méthodes d’authentification disponibles.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="code" type="string" required>
      Le code à usage unique envoyé au téléphone de l’utilisateur par SMS.
    </ParamField>

    <ParamField body="rememberDevice" type="boolean">
      Indique s’il faut mémoriser l’appareil et ignorer l’AMF lors des connexions futures.
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="pickSms" type="Promise<void>">
  Cette méthode vous dirige vers l’écran de sélection du numéro de téléphone pour les SMS.
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  Cette méthode vous dirige vers l’écran de sélection de la méthode d’AMF afin que l’utilisateur puisse choisir un autre facteur d’authentification.
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useResend">useResend</a>} type="Hooks">
  Ce hook gère l’état et la logique du délai d’attente avant un nouveau renvoi pour les écrans qui permettent de renvoyer un code.
</ParamField>
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useCurrentScreen">useCurrentScreen</a>} type="Hooks">
  Ce hook récupère le contexte de l’écran et l’état de l’écran actuel.
</ParamField>
