...
* L’utilisation de l’importation racine vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous souhaitez qu’un build unifié prenne en charge tous les écrans possibles.
...
Hooks associés à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-webauthn-platform-challenge`. Importez-les à partir de `@auth0/auth0-acul-react/mfa-webauthn-platform-challenge`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les configurations d’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `mfa-webauthn-platform-challenge`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit les configurations liées au client, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-webauthn-platform-challenge`.
...
<ParamField body="useMfaWebAuthnPlatformChallenge" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaWebAuthnPlatformChallengeMembers">MfaWebAuthnPlatformChallengeMembers</a>}>
  Ce hook renvoie toutes les méthodes et le contexte disponibles à l’écran `mfa-webauthn-platform-challenge`.
</ParamField>
...
<ParamField body="reportBrowserError" type="Promise<void>">
  Cette méthode signale une erreur WebAuthn au niveau du navigateur survenue pendant la demande de vérification avec l’authentificateur de plateforme.
...
<ParamField body="verify" type="Promise<void>">
  Cette méthode lance la vérification avec l’authentificateur de plateforme pour terminer la demande de vérification AMF.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="rememberDevice" type="boolean">
      Facultatif. Si la valeur est true, tente de mémoriser le navigateur pour les prochaines demandes de vérification AMF.
