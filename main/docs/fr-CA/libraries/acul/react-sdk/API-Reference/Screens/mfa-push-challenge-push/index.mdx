...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `mfa-push-challenge-push` de Universal Login."
---
...
* L’utilisation de **partial import** vous permet d’inclure uniquement le code nécessaire à votre cas d’usage.
* L’utilisation de **root import** vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous souhaitez qu’une version unifiée prenne en charge tous les écrans possibles.
...
Des hooks associés à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-push-challenge-push`. Importez-les depuis `@auth0/auth0-acul-react/mfa-push-challenge-push`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les configurations de Branding, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `mfa-push-challenge-push`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organization de l’utilisateur si le flux d’AMF est associé à une Organization. Il renvoie `null` lorsqu’aucun contexte d’Organization n’est présent.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnMfaPushChallengePush">ScreenMembersOnMfaPushChallengePush</a></span>}>
  Ce hook contient des détails propres à l’écran `mfa-push-challenge-push`, notamment sa configuration et son contexte.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `mfa-push-challenge-push`, comme l’état actuel du flux d’AMF.
...
<ParamField body="useMfaPushChallengePush" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaPushChallengePushMembers">MfaPushChallengePushMembers</a>}>
  Ce hook renvoie toutes les méthodes et le contexte disponibles dans l’écran `mfa-push-challenge-push`.
</ParamField>
...
<ParamField body="continueMethod" type="Promise<void>">
  Cette méthode termine le challenge push une fois que l’utilisateur a approuvé la notification sur son appareil mobile.
