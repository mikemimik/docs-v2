...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `mfa-push-challenge-push` dans Universal Login."
---

L’écran `mfa-push-challenge-push` invite l’utilisateur à approuver une notification MFA push envoyée à son appareil mobile.
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-push-challenge-push`. Importez-les depuis `@auth0/auth0-acul-react/mfa-push-challenge-push`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des paramètres d’image de marque, comme le logo, les couleurs et les réglages du thème affichés sur l’écran `mfa-push-challenge-push`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit des paramètres liés au client, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-push-challenge-push`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organization de l’utilisateur si le flux AMF est limité à l’Organization. Renvoie `null` lorsqu’aucun contexte d’Organization n’est présent.
...
<ParamField body="useMfaPushChallengePush" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaPushChallengePushMembers">MfaPushChallengePushMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles sur l’écran `mfa-push-challenge-push`.
</ParamField>
...
<ParamField body="enterCodeManually" type="Promise<void>">
  Cette méthode mène à l’écran de saisie manuelle du code pour que l’utilisateur puisse entrer un code OTP au lieu d’utiliser la notification push.
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  Cette méthode mène à l’écran de sélection de la méthode d’AMF pour que l’utilisateur puisse choisir un autre facteur d’authentification.
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useMfaPolling">useMfaPolling</a>} type="Hooks">
  Ce hook gère l’état de vérification périodique pour les écrans qui attendent une réponse asynchrone à une notification push.
</ParamField>
