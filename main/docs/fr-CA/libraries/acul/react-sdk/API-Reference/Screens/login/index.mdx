---
title: "Login"
description: "Décrit tous les hooks et toutes les méthodes offerts pour personnaliser l’écran `login` de Universal Login."
---

L’écran `login` recueille l’identifiant et le mot de passe de l’utilisateur. Selon votre tenant, cet identifiant peut être une adresse courriel, un numéro de téléphone ou un nom d’utilisateur. Il prend aussi en charge l’authentification par l’intermédiaire de fournisseurs d’identité fédérés.
...
Hooks associés à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `login`. Importez-les depuis `@auth0/auth0-acul-react/login`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’organisation de l’utilisateur si le login est associé à une organisation. Renvoie `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembersOnLogin">TransactionMembersOnLogin</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `login`, comme les connections actives, les méthodes de login disponibles et l’état actuel du flux.
...
<ParamField body="useLogin" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/LoginMembers">LoginMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles dans l’écran `login`.
</ParamField>
...
<ParamField body="login" type="Promise<void>">
  Cette méthode transmet les informations d’identification de l’utilisateur pour terminer l’authentification sur l’écran `login`.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="username" type="string" required>
      Le nom d’utilisateur ou adresse courriel à utiliser pour l’authentification.
    </ParamField>
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useErrors">useErrors</a>} type="Hooks">
  Ce hook lit et gère les erreurs serveur, client et de développement affichées à l’écran.
</ParamField>
