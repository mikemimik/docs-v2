...
description: "Décrit tous les hooks et toutes les méthodes offertes pour personnaliser l’écran `email-identifier-challenge` de l’expérience Universal Login."
---

L’écran `email-identifier-challenge` s’affiche lorsqu’un utilisateur doit vérifier son identité en saisissant un code envoyé à son adresse courriel. Il permet à l’utilisateur de soumettre le code, de demander qu’il soit renvoyé ou de revenir à l’étape précédente.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/ACUL/Screenshot_2026-04-22_at_18.14.17.png" alt="ACUL Vérification de l’identifiant par courriel" />
</Frame>
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `email-identifier-challenge`. Importez-les depuis `@auth0/auth0-acul-react/email-identifier-challenge`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations de Branding, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `email-identifier-challenge`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organization de l’utilisateur si le défi par courriel est limité à l’Organization. Retourne `null` lorsqu’aucun contexte d’Organization n’est présent.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `email-identifier-challenge`, comme les connections actives et l’état actuel du flow.
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Ce hook permet d’obtenir les options du thème actuel avec une configuration aplatie issue du contexte de branding.
</ParamField>
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useResend">useResend</a>} type="Hooks">
  Ce hook gère l’état de renvoi et la logique de temporisation du code de vérification par courriel.
</ParamField>