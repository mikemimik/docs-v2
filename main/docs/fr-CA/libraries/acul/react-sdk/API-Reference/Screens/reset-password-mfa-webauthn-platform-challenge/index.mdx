...
description: "Décrit tous les hooks et méthodes disponibles pour personnaliser l’écran `reset-password-mfa-webauthn-platform-challenge` dans Universal Login."
---

L’écran `reset-password-mfa-webauthn-platform-challenge` s’affiche pendant le flux de réinitialisation du mot de passe lorsqu’une authentification multifacteur au moyen d’une clé d’accès de plateforme est requise. Il invite l’utilisateur à s’authentifier à l’aide de la clé d’accès enregistrée sur son appareil pour poursuivre la réinitialisation.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les configurations d’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `reset-password-mfa-webauthn-platform-challenge`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organization de l’utilisateur si la réinitialisation du mot de passe est limitée à une Organization. Renvoie `null` lorsqu’aucun contexte d’Organization n’est disponible.
...
<ParamField body="reportBrowserError" type="Promise<void>">
  Cette méthode signale à Auth0 une erreur du navigateur liée à WebAuthn lorsque la vérification par clé d’accès échoue sur l’appareil de l’utilisateur.
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  Cette méthode amène l’utilisateur à choisir une autre méthode d’AMF.
