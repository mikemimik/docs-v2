...
description: "Décrit tous les hooks et méthodes offerts pour personnaliser l’écran `logout-complete` dans Universal Login."
---

L’écran `logout-complete` s’affiche une fois que l’utilisateur a terminé le processus de logout avec succès.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/5bso8fSMLDlnt4RHURVAYm/c583500e939a6aed729a04bd9da6a1f6/Screenshot_2025-05-15_at_19.20.19.png" alt="Logout terminé" />
</Frame>
...
Des hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `logout-complete`. Importez-les depuis `@auth0/auth0-acul-react/logout-complete`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations d’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `logout-complete`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’organisation de l’utilisateur si la session est limitée à l’organisation. Retourne `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `logout-complete`, comme les connections actives et l’état actuel du flux.
