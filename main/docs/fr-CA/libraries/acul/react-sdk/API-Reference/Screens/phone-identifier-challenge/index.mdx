...
description: "Décrit tous les hooks et toutes les méthodes offerts pour personnaliser l’écran `phone-identifier-challenge` de Universal Login."
---

L’écran `phone-identifier-challenge` s’affiche lorsqu’un utilisateur doit vérifier son numéro de téléphone en saisissant un code à usage unique. Il permet à l’utilisateur de soumettre le code, d’en demander le renvoi, de basculer entre l’envoi par SMS et par appel vocal, ou de revenir à l’étape précédente.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/3Cog5ZVlHphrRltcyZkq2d/c959fd72052731922ba251516403d0ac/Screenshot_2025-02-06_at_20.11.38.png" alt="ACUL Défi de vérification par téléphone" />
</Frame>
...
Des hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte d’Auth0 sur l’écran `phone-identifier-challenge`. Importez-les depuis `@auth0/auth0-acul-react/phone-identifier-challenge`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration de l’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `phone-identifier-challenge`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit les configurations liées au client, comme `id`, `name` et `logoUrl`, pour l’écran `phone-identifier-challenge`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organization de l’utilisateur si le challenge téléphonique est associé à une Organization. Il retourne `null` lorsqu’aucun contexte d’Organization n’est présent.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Ce hook gère les données non fiables transmises à l’écran, comme des paramètres préremplis provenant de la query string de l’URL.
...
<ParamField body="switchToText" type="Promise<void>">
  Cette méthode change le mode de livraison de la vérification par téléphone pour un SMS.
...
<ParamField body="switchToVoice" type="Promise<void>">
  Cette méthode change le mode de livraison de la vérification par téléphone pour un appel vocal.
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useResend">useResend</a>} type="Hooks">
  Ce hook gère l’état du délai d’attente avant le renvoi ainsi que la minuterie associée pour la méthode `resendCode`.
</ParamField>