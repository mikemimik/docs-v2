...
L’écran `mfa-otp-enrollment-code` invite l’utilisateur à saisir un code de vérification pour finaliser l’inscription OTP de son application d’authentification.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations d’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `mfa-otp-enrollment-code`.
...
<ParamField body="useMfaOtpEnrollmentCode" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaOtpEnrollmentCodeMembers">MfaOtpEnrollmentCodeMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles sur l’écran `mfa-otp-enrollment-code`.
</ParamField>
...
<ParamField body="toggleView" type="Promise<void>">
  Cette méthode bascule la vue sur l’écran `mfa-otp-enrollment-code`, par exemple pour passer de la vue du code QR à la vue de saisie manuelle.
