...
description: "Décrit tous les hooks et méthodes disponibles pour personnaliser l’écran Universal Login `reset-password-mfa-phone-challenge`."
---

L’écran `reset-password-mfa-phone-challenge` s’affiche pendant le processus de réinitialisation du mot de passe lorsqu’une authentification multifacteur par téléphone est requise. Il invite l’utilisateur à choisir un mode d’envoi (SMS ou appel vocal) pour recevoir un code de vérification et poursuivre la réinitialisation.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/5nxfRZqcpBBwzZGlJ7wm8y/a8b3a66ec4ffc07dd934b734e021c306/Screenshot_2025-04-24_at_09.53.31.png" alt="ACUL Réinitialisation du mot de passe – défi MFA par téléphone" />
</Frame>
...
Des hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `reset-password-mfa-phone-challenge`. Importez-les depuis `@auth0/auth0-acul-react/reset-password-mfa-phone-challenge`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations d’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `reset-password-mfa-phone-challenge`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des informations sur l’Organization de l’utilisateur si la réinitialisation du mot de passe est limitée à l’Organization. Renvoie `null` lorsqu’aucun contexte d’Organization n’est présent.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnResetPasswordMfaPhoneChallenge">ScreenMembersOnResetPasswordMfaPhoneChallenge</a></span>}>
  Ce hook contient des renseignements propres à l’écran `reset-password-mfa-phone-challenge`, y compris sa configuration et son contexte.
...
<ParamField body="continueMethod" type="Promise<void>">
  Cette méthode transmet le mode d’envoi choisi par l’utilisateur pour faire parvenir le code de vérification et passer à l’étape d’AMF du processus de réinitialisation du mot de passe.
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  Cette méthode redirige l’utilisateur afin qu’il choisisse une autre méthode d’AMF.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="type" type="&#x22;sms&#x22; | &#x22;voice&#x22;">
      Le mode d’envoi qui a été présenté ou sélectionné initialement sur l’écran actuel.
      Ce champ est requis par le point de terminaison d’API pour traiter correctement l’action &#39;pick-authenticator&#39;.

      * `sms` : Indique que l’écran actuel concernait la vérification par SMS.
      * `voice` : Indique que l’écran actuel concernait la vérification par appel vocal.
    </ParamField>
  </Expandable>
</ParamField>
