...
L’écran `login-password` sert à saisir le mot de passe de l’utilisateur à la deuxième étape d’un flux d’authentification de type identifiant d’abord. Il permet aussi de basculer vers un fournisseur d’identité fédéré ou une autre connexion.
...
Hooks associés à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `login-password`. Importez-les à partir de `@auth0/auth0-acul-react/login-password`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration de l’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `login-password`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’organisation de l’utilisateur si la connexion est associée à une organisation. Il renvoie `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Ce hook gère les données non fiables transmises à l’écran, comme un identifiant prérempli provenant des paramètres d’URL.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="captcha?" type="string">
      Valeur captcha requise lorsque la fonction Bot Detection est activée sur le tenant.
    </ParamField>
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useCurrentScreen">useCurrentScreen</a>} type="Hooks">
  Ce hook récupère le contexte du screen et l’état de l’écran actuel.
</ParamField>
