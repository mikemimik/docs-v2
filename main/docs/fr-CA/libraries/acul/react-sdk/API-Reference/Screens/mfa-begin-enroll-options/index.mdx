...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `mfa-begin-enroll-options` d’Universal Login."
---

L’écran `mfa-begin-enroll-options` présente à l’utilisateur les options d’inscription à l’authentification multifacteur disponibles et lui permet de sélectionner le facteur à inscrire.
...
* L’importation racine vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous voulez une version unifiée pour gérer tous les écrans possibles.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les paramètres d’image de marque, comme le logo, les couleurs et les paramètres de thème affichés dans l’écran `mfa-begin-enroll-options`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit des paramètres liés au client, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-begin-enroll-options`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organization de l’utilisateur si l’inscription à l’AMF est limitée à l’Organization. Il retourne `null` lorsqu’aucun contexte d’Organization n’est présent.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Ce hook contient des détails propres à l’écran `mfa-begin-enroll-options`, notamment sa configuration et son contexte.
...
<ParamField body="enroll" type="Promise<void>">
  Cette méthode lance l’inscription du facteur AMF sélectionné et fait passer le flux à l’écran d’inscription correspondant.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="action" type="string" required>
      L’action qui indique le facteur à inscrire. Une des valeurs suivantes : &quot;push-notification&quot;, &quot;otp&quot;, &quot;sms&quot;, &quot;phone&quot;, &quot;voice&quot; ou &quot;webauthn-roaming&quot;.
    </ParamField>
  </Expandable>
</ParamField>
