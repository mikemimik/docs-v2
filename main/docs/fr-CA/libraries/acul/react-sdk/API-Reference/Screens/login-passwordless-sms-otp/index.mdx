...
description: "Décrit tous les hooks et méthodes offerts pour personnaliser l’écran `login-passwordless-sms-otp` de Universal Login."
---

L’écran `login-passwordless-sms-otp` demande à l’utilisateur de saisir un code à usage unique envoyé à son numéro de téléphone afin de terminer l’authentification SMS sans mot de passe.
...
Des hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte d’Auth0 sur l’écran `login-passwordless-sms-otp`. Importez-les depuis `@auth0/auth0-acul-react/login-passwordless-sms-otp`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des paramètres d’image de marque, comme le logo, les couleurs et les réglages de thème affichés sur l’écran `login-passwordless-sms-otp`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit des paramètres liés au client, comme `id`, `name` et `logoUrl`, pour l’écran `login-passwordless-sms-otp`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organization de l’utilisateur si le login est associé à une Organization. Renvoie `null` lorsqu’aucun organization context n’est présent.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="connection" type="string" required>
      Le nom de la connexion à utiliser. Utilisez &#39;email&#39; ou &#39;sms&#39; pour l’authentification sans mot de passe, ou le nom d’une connexion de base de données pour l’authentification par mot de passe.
    </ParamField>
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useResend">useResend</a>} type="Hooks">
  Ce hook gère la période d’attente du renvoi et la disponibilité des actions de renvoi de code.
</ParamField>