...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `mfa-push-welcome` de Universal Login."
---

L’écran `mfa-push-welcome` présente à l’utilisateur l’authentification AMF par notification push et l’invite à inscrire un autre authentificateur ou à en choisir un différent.
...
Des hooks associés à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 dans l’écran `mfa-push-welcome`. Importez-les depuis `@auth0/auth0-acul-react/mfa-push-welcome`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations de branding, comme le logo, les couleurs et les paramètres du thème affichés dans l’écran `mfa-push-welcome`.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `mfa-push-welcome`, comme l’état actuel du flux d’AMF.
...
<ParamField body="enroll" type="Promise<void>">
  Cette méthode lance le flux d’inscription aux notifications push pour l’utilisateur.
...
<ParamField body="pickAuthenticator" type="Promise<void>">
  Cette méthode accède à l’écran de sélection de l’authentificateur afin que l’utilisateur puisse choisir une autre méthode d’AMF.
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Ce hook récupère les options du thème actuel à partir du contexte de branding, avec une configuration à plat.
</ParamField>
