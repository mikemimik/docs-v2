...
description: "Décrit tous les hooks et méthodes disponibles pour personnaliser l’écran `mfa-recovery-code-challenge-new-code` d’Universal Login."
---

L’écran `mfa-recovery-code-challenge-new-code` affiche un nouveau code de récupération à l’utilisateur après une authentification réussie et l’invite à l’enregistrer en lieu sûr.
...
* L’importation à la racine vous permet de charger tous les écrans à partir d’un seul lot, ce qui est utile si vous souhaitez qu’une compilation unifiée prenne en charge tous les écrans possibles.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration de l’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `mfa-recovery-code-challenge-new-code`.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `mfa-recovery-code-challenge-new-code`, comme l’état actuel du flux AMF.
...
<ParamField body="useUser" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/UserMembers">UserMembers</a></span>}>
  Ce hook fournit les renseignements sur l’utilisateur courant, notamment `username`, `email` et les méthodes d’authentification disponibles.
...
<ParamField body="useMfaRecoveryCodeChallengeNewCode" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaRecoveryCodeChallengeNewCodeMembers">MfaRecoveryCodeChallengeNewCodeMembers</a>}>
  Ce hook renvoie toutes les méthodes et le contexte accessibles sur l’écran `mfa-recovery-code-challenge-new-code`.
</ParamField>
...
<ParamField body="continueMethod" type="Promise<void>">
  Cette méthode confirme que l’utilisateur a enregistré son nouveau code de récupération et permet de poursuivre le flux d’authentification.
