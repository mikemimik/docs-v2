...
description: "Décrit tous les hooks et méthodes offerts pour personnaliser l’écran `login-email-verification` d’Universal Login."
---

L’écran `login-email-verification` invite l’utilisateur à saisir un code de vérification envoyé à son adresse courriel pour confirmer son identité durant le processus de connexion.
...
Des hooks à portée d’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `login-email-verification`. Importez-les depuis `@auth0/auth0-acul-react/login-email-verification`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations de branding, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `login-email-verification`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’organisation de l’utilisateur si la connexion est limitée à une organisation. Il retourne `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Ce hook gère les données non fiables transmises à l’écran, comme les paramètres provenant des chaînes de requête d’URL.
...
<ParamField body="useLoginEmailVerification" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/LoginEmailVerificationMembers">LoginEmailVerificationMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles dans le écran `login-email-verification`.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="[`key`: `string`]" type="&#x22;string&#x22; | &#x22;number&#x22; | &#x22;boolean&#x22; | &#x22;undefined&#x22;">
      Autres champs personnalisés précédés du préfixe `ulp-` (par exemple, `'ulp-custom-field'`).
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Ce hook récupère les options du thème actuel avec la configuration aplatie issue du contexte de Branding.
</ParamField>
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useResend">useResend</a>} type="Hooks">
  Ce hook gère l’état du délai d’attente avant un nouveau renvoi et la disponibilité des actions de renvoi du code.
</ParamField>