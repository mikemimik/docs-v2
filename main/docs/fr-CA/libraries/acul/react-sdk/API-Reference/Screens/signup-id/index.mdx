---
title: "SignupId"
description: "Décrit tous les hooks et méthodes offerts pour personnaliser l’écran `signup-id` dans Universal Login."
---

L’écran `signup-id` recueille l’identifiant de l’utilisateur — par exemple son adresse courriel, son nom d’utilisateur ou son numéro de téléphone — comme première étape d’un flux d’inscription en plusieurs étapes. Il prend aussi en charge l’inscription fédérée au moyen de connexions sociales ou d’entreprise.
...
Des hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 dans l’écran `signup-id`. Importez-les depuis `@auth0/auth0-acul-react/signup-id`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les configurations de l’image de marque, comme le logo, les couleurs et les paramètres de thème affichés dans l’écran `signup-id`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organization de l’utilisateur si l’inscription est limitée à une Organization. Il retourne `null` lorsqu’aucun organization context n’est présent.
...
<ParamField body="usePrompt" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/PromptMembers">PromptMembers</a></span>}>
  Ce hook contient des données sur le prompt actuel dans le processus d’authentication.
...
<ParamField body="useSignupId" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/SignupIdMembers">SignupIdMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles à l’écran `signup-id`.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="connection" type="string" required>
      Le nom de la connexion sociale ou de la connexion d’entreprise à utiliser (p. ex. `google-oauth2`, `github`).
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useSignupIdentifiers">useSignupIdentifiers</a>} type="Hooks">
  Ce hook renvoie les identifier types d’inscription disponibles (email, username, phone) configurés pour la connexion.
</ParamField>
