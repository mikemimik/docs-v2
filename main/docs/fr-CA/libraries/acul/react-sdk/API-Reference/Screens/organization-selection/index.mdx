...
description: "Décrit tous les hooks et méthodes disponibles pour personnaliser l’écran `organization-selection` de Universal Login."
---

L’écran `organization-selection` s’affiche lorsqu’un utilisateur doit saisir un nom d’organisation pour poursuivre le flux d’authentification. Il lui permet de saisir le nom de son organisation et de continuer.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/3okogBPGS1KmSlhUSk9xhk/07bc19ad8b58772d3de872a49b8f6ca5/Screenshot_2025-03-25_at_20.27.41.png" alt="Sélection de l’organisation ACUL" />
</Frame>
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 dans l’écran `organization-selection`. Importez-les depuis `@auth0/auth0-acul-react/organization-selection`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration de l’image de marque, comme le logo, les couleurs et les paramètres du thème affichés dans l’écran `organization-selection`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’organisation de l’utilisateur si la sélection est propre à l’organisation. Il retourne `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useOrganizationSelection" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationSelectionMembers">OrganizationSelectionMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles dans l’écran `organization-selection`.
</ParamField>
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Ce hook récupère les options du thème actuel avec une configuration aplanie provenant du contexte d’image de marque.
</ParamField>
