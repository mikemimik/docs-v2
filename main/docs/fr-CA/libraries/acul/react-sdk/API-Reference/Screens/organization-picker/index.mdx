...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `organization-picker` de l’expérience Universal Login."
---

L’écran `organization-picker` s’affiche lorsqu’un utilisateur doit sélectionner une organisation pour se connecter. Il permet de choisir une organisation ou d’ignorer cette étape.
...
* L’**importation depuis la racine** vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous souhaitez qu’une build unifiée prenne en charge tous les écrans possibles.
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 dans l’écran `organization-picker`. Importez-les à partir de `@auth0/auth0-acul-react/organization-picker`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations d’image de marque, comme le logo, les couleurs et les paramètres du thème affichés dans l’écran `organization-picker`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur le contexte d’organisation de l’utilisateur dans l’écran `organization-picker`. Il renvoie `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useOrganizationPicker" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationPickerMembers">OrganizationPickerMembers</a>}>
  Ce hook renvoie toutes les méthodes et le contexte disponibles dans l’écran `organization-picker`.
</ParamField>
...
<ParamField body="selectOrganization" type="Promise<void>">
  Cette méthode soumet la sélection d’organisation de l’utilisateur et poursuit le flux d’authentification.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="state" type="string" required>
      La valeur actuelle de state pour l’authentification.
    </ParamField>
  </Expandable>
</ParamField>
