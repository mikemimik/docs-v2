...
L’écran `organization-picker` s’affiche lorsqu’un utilisateur doit choisir une organisation pour se connecter. Il lui permet de choisir une organisation ou d’ignorer cette étape.
...
Hooks associés à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `organization-picker`. Importez-les depuis `@auth0/auth0-acul-react/organization-picker`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration d’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `organization-picker`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit la configuration liée au client, comme `id`, `name` et `logoUrl`, pour l’écran `organization-picker`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur le contexte d’organisation de l’utilisateur sur l’écran `organization-picker`. Il renvoie `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Ce hook contient des détails propres à l’écran `organization-picker`, notamment sa configuration et son contexte.
...
<ParamField body="useOrganizationPicker" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationPickerMembers">OrganizationPickerMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles sur l’écran `organization-picker`.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="state" type="string" required>
      La valeur state actuelle du flux d’authentification.
    </ParamField>
  </Expandable>
</ParamField>

<ParamField body="skipOrganizationSelection" type="Promise<void>">
  Cette méthode permet à l’utilisateur d’ignorer l’étape de sélection de l’organisation et de poursuivre le flux d’authentification sans en sélectionner une.
