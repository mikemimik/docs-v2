...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/7kuQwDVmt0NkHCbQObLj8d/b690fd899f7c8525532d6d640298f2cd/PhoneIdentifierEnrollment.png" alt="ACUL Enregistrement de l’identifiant téléphonique" />
</Frame>
...
Des hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `phone-identifier-enrollment`. Importez-les depuis `@auth0/auth0-acul-react/phone-identifier-enrollment`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration de l’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `phone-identifier-enrollment`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organization de l’utilisateur si l’inscription par téléphone est limitée à cette Organization. Retourne `null` lorsqu’aucun contexte d’Organization n’est présent.
...
<ParamField body="usePhoneIdentifierEnrollment" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/PhoneIdentifierEnrollmentMembers">PhoneIdentifierEnrollmentMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles à l’écran `phone-identifier-enrollment`.
</ParamField>
...
<ParamField body="continuePhoneEnrollment" type="Promise<void>">
  Cette méthode soumet le mode de vérification téléphonique privilégié de l’utilisateur et poursuit le processus d’inscription.
