...
description: "Décrit tous les hooks et les méthodes disponibles pour personnaliser l’écran `reset-password-mfa-push-challenge-push` d’Universal Login."
---
...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/5ANIhgOJURo2z0YXmWKp7M/5f266f0a935c047d6159874cbfc2001a/Screenshot_2025-03-26_at_09.15.46.png" alt="ACUL Réinitialiser le mot de passe MFA Push Challenge Push" />
</Frame>
...
* L’importation racine vous permet de charger tous les écrans à partir d’un seul module, ce qui est utile si vous souhaitez une compilation unifiée capable de gérer tous les écrans possibles.
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 dans l’écran `reset-password-mfa-push-challenge-push`. Importez-les depuis `@auth0/auth0-acul-react/reset-password-mfa-push-challenge-push`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration de l’image de marque, comme le logo, les couleurs et les paramètres du thème affichés dans l’écran `reset-password-mfa-push-challenge-push`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit la configuration liée au client, comme `id`, `name` et `logoUrl`, pour l’écran `reset-password-mfa-push-challenge-push`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit de l’information sur l’organisation de l’utilisateur si la réinitialisation du mot de passe est limitée à l’organisation. Renvoie `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useResetPasswordMfaPushChallengePush" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ResetPasswordMfaPushChallengePushMembers">ResetPasswordMfaPushChallengePushMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles dans l’écran `reset-password-mfa-push-challenge-push`.
</ParamField>
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useMfaPolling">useMfaPolling</a>} type="Hooks">
  Ce hook gère le polling des notifications push d’AMF en vérifiant de façon répétée l’endpoint du push challenge jusqu’à ce que l’utilisateur approuve ou refuse la request.
</ParamField>
