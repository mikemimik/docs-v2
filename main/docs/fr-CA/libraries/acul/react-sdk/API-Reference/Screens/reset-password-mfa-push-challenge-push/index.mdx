...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran Universal Login `reset-password-mfa-push-challenge-push`."
---

L’écran `reset-password-mfa-push-challenge-push` s’affiche pendant le processus de réinitialisation du mot de passe lorsqu’une authentification multifacteur par notification push est requise. Il invite l’utilisateur à approuver la demande sur son appareil mobile enregistré afin de poursuivre la réinitialisation.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/5ANIhgOJURo2z0YXmWKp7M/5f266f0a935c047d6159874cbfc2001a/Screenshot_2025-03-26_at_09.15.46.png" alt="ACUL Réinitialisation du mot de passe MFA Push Challenge Push" />
</Frame>
...
Hooks à portée d’écran qui fournissent un accès en lecture seule aux données de contexte d’Auth0 sur l’écran `reset-password-mfa-push-challenge-push`. Importez-les depuis `@auth0/auth0-acul-react/reset-password-mfa-push-challenge-push`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les configurations de branding, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `reset-password-mfa-push-challenge-push`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’organisation de l’utilisateur si la réinitialisation du mot de passe est limitée à une organisation. Il retourne `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useResetPasswordMfaPushChallengePush" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ResetPasswordMfaPushChallengePushMembers">ResetPasswordMfaPushChallengePushMembers</a>}>
  Ce hook renvoie toutes les méthodes et le contexte disponibles pour l’écran `reset-password-mfa-push-challenge-push`.
</ParamField>
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useMfaPolling">useMfaPolling</a>} type="Hooks">
  Ce hook gère le polling des push notifications MFA en vérifiant de façon répétée l’endpoint du push challenge jusqu’à ce que l’utilisateur approuve ou refuse la requête.
</ParamField>
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Ce hook récupère les options de thème actuelles avec une configuration aplatie à partir du contexte de branding.
</ParamField>
