...
L’écran `mfa-phone-enrollment` permet à l’utilisateur d’inscrire un numéro de téléphone pour l’AMF par SMS ou appel vocal en saisissant son numéro et en sélectionnant un mode d’envoi.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit les configurations liées au client, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-phone-enrollment`.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Ce hook contient les détails propres à l’écran `mfa-phone-enrollment`, y compris sa configuration et son contexte.
...
<ParamField body="continueEnrollment" type="Promise<void>">
  Cette méthode envoie le numéro de téléphone de l’utilisateur et le mode d’envoi sélectionné pour inscrire ce numéro à l’AMF.
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Ce hook récupère les options du thème avec une configuration aplatie à partir du contexte de l’image de marque.
</ParamField>
