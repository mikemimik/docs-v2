...
Hooks associés à l’écran qui offrent un accès en lecture seule aux données de contexte Auth0 dans l’écran `login-passwordless-email-code`. Importez-les depuis `@auth0/auth0-acul-react/login-passwordless-email-code`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des paramètres d’image de marque, comme le logo, les couleurs et les réglages du thème affichés sur l’écran `login-passwordless-email-code`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit des renseignements liés au client, comme `id`, `name` et `logoUrl`, pour l’écran `login-passwordless-email-code`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’organisation de l’utilisateur si la connexion est associée à une organisation. Retourne `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnLoginPasswordlessEmailCode">ScreenMembersOnLoginPasswordlessEmailCode</a></span>}>
  Ce hook contient des détails propres à l’écran `login-passwordless-email-code`, notamment sa configuration et son contexte.
...
<ParamField body="submitCode" type="Promise<void>">
  Cette méthode soumet le code à usage unique pour finaliser l’authentification sans mot de passe par courriel.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="captcha?" type="string">
      Valeur captcha requise lorsque la détection de robots est activée sur le tenant.
    </ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="connection" type="string" required>
      Le nom de la connexion à utiliser. Utilisez &#39;email&#39; ou &#39;sms&#39; pour le mode sans mot de passe, ou le nom d’une connexion de base de données pour l’authentification par mot de passe.
    </ParamField>
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useErrors">useErrors</a>} type="Hooks">
  Ce hook permet de consulter et de gérer les erreurs côté serveur, côté client et développeur à l’écran.
</ParamField>
