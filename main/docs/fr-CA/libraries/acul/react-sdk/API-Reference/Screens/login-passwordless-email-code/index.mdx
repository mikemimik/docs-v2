...
L’écran `login-passwordless-email-code` invite l’utilisateur à saisir un code à usage unique envoyé à son adresse courriel afin de compléter l’authentification sans mot de passe.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/4DKgjU2dGw0mpLJKGfGhp0/470b29266da87f9bfc3e7eef55069620/Login_Passwordless_Email_Code.png" alt="Code par courriel pour connexion sans mot de passe" />
</Frame>
...
* L’utilisation de l’importation racine vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous voulez une build unifiée pour prendre en charge tous les écrans possibles.
...
Des hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 dans l’écran `login-passwordless-email-code`. Importez-les depuis `@auth0/auth0-acul-react/login-passwordless-email-code`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les configurations d’image de marque, comme le logo, les couleurs et les paramètres de thème affichés dans l’écran `login-passwordless-email-code`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit les configurations liées au client, comme `id`, `name` et `logoUrl`, pour l’écran `login-passwordless-email-code`.
...
<ParamField body="useUser" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/UserMembers">UserMembers</a></span>}>
  Ce hook fournit des informations sur l’utilisateur actif, notamment le `username`, l’`email` et les méthodes d’authentification disponibles.
...
<ParamField body="useLoginPasswordlessEmailCode" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/LoginPasswordlessEmailCodeMembers">LoginPasswordlessEmailCodeMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles sur l’écran `login-passwordless-email-code`.
</ParamField>
...
<ParamField body="submitCode" type="Promise<void>">
  Cette méthode soumet le code à usage unique pour compléter l’authentification par courriel sans mot de passe.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="connection" type="string" required>
      Le nom de la connexion vers laquelle passer. Utilisez &#39;email&#39; ou &#39;sms&#39; pour le mode sans mot de passe, ou le nom d’une connexion BD pour l’authentification par mot de passe.
    </ParamField>
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Ce hook récupère les options du thème actuel à partir d’une configuration à plat issue du contexte d’image de marque.
</ParamField>
