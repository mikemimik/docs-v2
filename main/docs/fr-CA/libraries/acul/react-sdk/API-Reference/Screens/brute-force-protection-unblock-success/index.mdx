...
L’écran `brute-force-protection-unblock-success` s’affiche lorsqu’un utilisateur a débloqué son compte avec succès après un verrouillage par la protection contre les attaques par force brute.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations d’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `brute-force-protection-unblock-success`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organization de l’utilisateur si le flux de déblocage est délimité à l’Organization. Il renvoie `null` lorsqu’aucun contexte d’Organization n’est présent.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Ce hook gère les données non fiables transmises à l’écran, comme un username prérempli à partir des URL parameters.
...
<ParamField body="useBruteForceProtectionUnblockSuccess" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BruteForceProtectionUnblockSuccessMembers">BruteForceProtectionUnblockSuccessMembers</a>}>
  Ce hook renvoie toutes les méthodes et le contexte disponibles dans l’écran `brute-force-protection-unblock-success`.
</ParamField>
