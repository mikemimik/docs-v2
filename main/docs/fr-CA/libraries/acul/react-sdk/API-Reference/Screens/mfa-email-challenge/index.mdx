...
Hooks à portée d’écran qui fournissent un accès en lecture seule aux données de contexte d’Auth0 sur l’écran `mfa-email-challenge`. Importez-les depuis `@auth0/auth0-acul-react/mfa-email-challenge`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration de l’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `mfa-email-challenge`.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnMfaEmailChallenge">ScreenMembersOnMfaEmailChallenge</a></span>}>
  Ce hook contient des renseignements propres à l’écran `mfa-email-challenge`, y compris sa configuration et son contexte.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `mfa-email-challenge`, comme l’état actuel du flux d’AMF.
...
<ParamField body="continueMethod" type="Promise<void>">
  Cette méthode soumet le code à usage unique saisi par l’utilisateur pour terminer le défi d’AMF par courriel.
...
<ParamField body="pickEmail" type="Promise<void>">
  Cette méthode mène à l’écran de sélection du courriel si plusieurs adresses courriel sont disponibles pour le défi.
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useResend">useResend</a>} type="Hooks">
  Ce hook gère l’état et la logique du délai d’attente avant un nouveau renvoi pour les écrans dotés d’une fonction de renvoi de code.
</ParamField>
