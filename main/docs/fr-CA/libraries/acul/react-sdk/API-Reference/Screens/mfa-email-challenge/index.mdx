...
L’écran `mfa-email-challenge` invite l’utilisateur à saisir un code à usage unique envoyé à son adresse courriel pour terminer la vérification MFA.
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-email-challenge`. Importez-les à partir de `@auth0/auth0-acul-react/mfa-email-challenge`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration de l’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `mfa-email-challenge`.
...
<ParamField body="useMfaEmailChallenge" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaEmailChallengeMembers">MfaEmailChallengeMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles sur l’écran `mfa-email-challenge`.
</ParamField>
...
<ParamField body="pickEmail" type="Promise<void>">
  Cette méthode affiche l’écran de sélection du courriel si plusieurs adresses courriel sont disponibles pour la vérification.
...
<ParamField body={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Hooks/useResend">useResend</a>} type="Hooks">
  Ce hook gère l’état et la logique du délai d’attente avant un nouveau renvoi pour les écrans offrant une fonctionnalité de renvoi de code.
</ParamField>
