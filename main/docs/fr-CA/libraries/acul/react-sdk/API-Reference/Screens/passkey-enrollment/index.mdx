...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `passkey-enrollment` de l’expérience Universal Login."
---

L’écran `passkey-enrollment` s’affiche lorsqu’un utilisateur est invité à enregistrer une clé d’accès comme méthode d’authentification. Il permet à l’utilisateur de poursuivre l’enregistrement de la clé d’accès ou d’annuler l’opération.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/7haU4kXN2y0zikB9kanO8J/f32a48edc265d906aa063de96e9f3b89/Passkey_Enrollment.png" alt="Écran d’enregistrement de clé d’accès ACUL" />
</Frame>
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration de l’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `passkey-enrollment`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’organisation de l’utilisateur si l’inscription de clé d’accès est limitée à l’organisation. Retourne `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="continuePasskeyEnrollment" type="Promise<void>">
  Cette méthode lance le processus d’inscription d’une clé d’accès et poursuit le flux d’authentification.
...
<ParamField body="abortPasskeyEnrollment" type="Promise<void>">
  Cette méthode annule le processus d’inscription d’une clé d’accès et poursuit le flux d’authentification sans inscrire de clé d’accès.
...
<ParamField body="doNotShowAgain" type="Promise<void>">
  Cette méthode ignore l’inscription de la clé d’accès et enregistre la préférence de l’utilisateur pour qu’on ne lui propose plus de l’inscrire.
