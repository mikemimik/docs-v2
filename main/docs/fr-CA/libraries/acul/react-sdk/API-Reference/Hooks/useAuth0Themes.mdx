...
<ParamField body="useAuth0Themes()" type={<span><a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/FlattenedTheme">FlattenedTheme</a></span>}>
  Hook React permettant d’obtenir les options du thème actuel avec une configuration à plat à partir du contexte de branding.

  ## Renvoie

  [`FlattenedTheme`](/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/FlattenedTheme) | `null`

  Objet `FlattenedTheme` contenant les couleurs, les polices, les bordures, `pageBackground` et les configurations du widget, ou `null` si aucun branding n’est disponible
