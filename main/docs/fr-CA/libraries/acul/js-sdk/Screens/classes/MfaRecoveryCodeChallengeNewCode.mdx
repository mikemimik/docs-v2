...
La classe MfaRecoveryCodeChallengeNewCode implémente la fonctionnalité de l’écran `mfa-recovery-code-challenge-new-code`. Cet écran affiche le code de récupération multifacteur afin qu’il puisse être conservé en lieu sûr.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/2z7O3hMDh95LddseNVAuqt/79dec7a52df2d4d4328cf23f9dfade90/Screenshot_2025-05-15_at_19.41.42.png" alt="ACUL code de récupération multifacteur nouveau code" />
</Frame>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme la saisie de l’utilisateur pendant la vérification par code de récupération multifacteur.
</ParamField>
