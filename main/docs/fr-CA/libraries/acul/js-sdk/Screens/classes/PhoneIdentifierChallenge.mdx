...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `phone-identifier-challenge` de l’Universal Login."
---

La classe PhoneIdentifierChallenge implémente les fonctionnalités de l’écran `phone-identifier-challenge`. Cet écran invite l’utilisateur à saisir un code de vérification envoyé à son numéro de téléphone pour confirmer son identité.
...
<ParamField body="switchToText" type="Promise<void>">
  Cette méthode remplace le mode d’envoi du code de vérification par un message texte (SMS).
...
<ParamField body="switchToVoice" type="Promise<void>">
  Cette méthode remplace le mode d’envoi du code de vérification par un appel vocal.
