---
title: "LogoutAborted"
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `logout-aborted` d’Universal Login."
---

La classe LogoutAborted implémente le fonctionnement de l’écran `logout-aborted`. Cet écran s’affiche lorsqu’un utilisateur abandonne le processus de logout.
...
<ParamField body="screen" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Contient des détails propres à l’écran `logout-aborted`, notamment sa configuration et son contexte.
</ParamField>
...
<ParamField body="getErrors" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a>[]</span>}>
  Cette méthode récupère dans le contexte le tableau des erreurs de transaction, ou un tableau vide s’il n’y en a aucune. Un tableau d’objets d’erreur issus du contexte de transaction.
</ParamField>