...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `brute-force-protection-unblock` de Universal Login."
---

La classe BruteForceProtectionUnblock implémente la fonctionnalité de l’écran `brute-force-protection-unblock`. Cet écran s’affiche lorsqu’un compte utilisateur a été bloqué à la suite de multiples tentatives de connexion infructueuses et que l’utilisateur doit soumettre une demande de déblocage.
...
<ParamField body="unblockAccount" type="Promise<void>">
  Cette méthode envoie la demande de déblocage du compte.
