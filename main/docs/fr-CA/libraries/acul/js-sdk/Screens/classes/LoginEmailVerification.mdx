  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="language" type="string" required>
      Le code de langue du paramètre régional souhaité (par exemple, `'en'`, `'fr'`, `'es'`).
    </ParamField>
...
<ParamField body="getErrors" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a>[]</span>}>
  Cette méthode récupère dans le contexte le tableau des erreurs de transaction, ou un tableau vide s’il n’y en a aucune. Il s’agit d’un tableau d’objets d’erreur provenant du contexte de transaction.
</ParamField>
