...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `device-code-activation-allowed` d’Universal Login."
---

La classe DeviceCodeActivationAllowed implémente la fonctionnalité de l’écran `device-code-activation-allowed`. Cet écran s’affiche lorsque l’activation du code d’appareil a été autorisée avec succès.
