...
description: "Décrit l’ensemble des propriétés et des méthodes permettant de personnaliser l’écran `mfa-phone-challenge` d’Universal Login."
---
...
Créez une instance du gestionnaire d’écran AMF Phone Challenge :
...
<ParamField body="branding" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Fournit la configuration liée à l’image de marque, comme le thème et les paramètres de l’image de marque.
</ParamField>
...
<ParamField body="client" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit la configuration liée au client, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-phone-challenge`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Prend en charge les données non fiables transmises au SDK, comme la saisie de l’utilisateur pendant la vérification téléphonique d’AMF.
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  Cette méthode envoie le choix de l’utilisateur de recevoir le code AMF par SMS ou par appel vocal.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="type" type="&#x22;sms&#x22; | &#x22;voice&#x22;" required>
      Le mode de livraison du code AMF.
    </ParamField>
  </Expandable>
</ParamField>
