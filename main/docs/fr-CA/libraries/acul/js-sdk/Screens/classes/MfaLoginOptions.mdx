...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `mfa-login-options` de Universal Login."
---
...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/4TnKlKLKFyAdX6dcOvVlXw/ebd248e8aabf78d20ba1ffec746b4404/Screenshot_2025-02-20_at_17.25.02.png" alt="ACUL Options de connexion MFA" />
</Frame>
...
<ParamField body="branding" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Fournit des configurations liées à l’image de marque, comme le thème et les paramètres de personnalisation.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Contient des données non fiables transmises au SDK, comme les saisies de l’utilisateur lors de la sélection d’une option de connexion AMF.
</ParamField>
...
<ParamField body="enroll" type="Promise<void>">
  Cette méthode poursuit le processus de login avec le facteur MFA sélectionné.
