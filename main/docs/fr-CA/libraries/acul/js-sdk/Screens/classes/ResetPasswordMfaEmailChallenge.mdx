...
<ParamField body="continue" type="Promise<void>">
  Cette méthode soumet le code de vérification par courriel afin de poursuivre le défi MFA pendant le flux de réinitialisation du mot de passe.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="rememberDevice?" type="boolean">
      Indique s’il faut mémoriser l’appareil pour les futurs défis MFA.
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="resendManager" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ResendControl">ResendControl</a></span>}>
  Cette méthode fournit une fonctionnalité de renvoi avec gestion du délai d’expiration pour l’écran `reset-password-mfa-email-challenge`.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="onTimeout?" type="void">
      Fonction de rappel déclenchée lorsque le délai d’expiration est atteint et que le bouton de renvoi devient accessible.
    </ParamField>
  </Expandable>
</ParamField>

<ParamField body="tryAnotherMethod" type="Promise<void>">
  Cette méthode permet à l’utilisateur de sélectionner une autre méthode de MFA pour compléter le défi.
