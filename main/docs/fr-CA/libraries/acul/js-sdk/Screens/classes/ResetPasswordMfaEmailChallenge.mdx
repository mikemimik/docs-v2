...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `reset-password-mfa-email-challenge` de Universal Login."
---

La classe ResetPasswordMfaEmailChallenge implémente la fonctionnalité de l’écran `reset-password-mfa-email-challenge`. Cet écran invite l’utilisateur à saisir le code de vérification envoyé à son adresse courriel dans le cadre de l’étape d’AMF du processus de réinitialisation du mot de passe.
