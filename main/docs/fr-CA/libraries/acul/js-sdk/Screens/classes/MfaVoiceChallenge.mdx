...
Créez une instance du gestionnaire d’écran de défi vocal MFA :
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembersOnMfaVoiceChallenge">UntrustedDataMembersOnMfaVoiceChallenge</a></span>}>
  Gère les données non fiables transmises au SDK, comme les entrées de l’utilisateur pendant le défi vocal MFA.
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  Cette méthode soumet le code de vérification reçu par appel vocal pour valider l’épreuve MFA.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="rememberDevice?" type="boolean">
      Lorsque `true`, le navigateur est mémorisé pour les prochaines épreuves MFA. S’applique uniquement si `screen.showRememberDevice` est `true`.
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="resendManager" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ResendControl">ResendControl</a></span>}>
  Cette méthode fournit une fonctionnalité de renvoi avec gestion configurable du délai d’expiration et de l’état.
