...
La classe MfaSmsEnrollment prend en charge les fonctionnalités de l’écran `mfa-sms-enrollment`. Cet écran s’affiche lorsque l’utilisateur doit enregistrer un numéro de téléphone pour l’authentification MFA par SMS.
...
Créez une instance du gestionnaire de l’écran d’inscription par SMS pour la MFA :
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant l’inscription MFA par SMS.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="captcha?" type="string">
      Le code CAPTCHA ou la réponse du CAPTCHA provider. Obligatoire si Bot Detection est activé dans votre Auth0 tenant.
    </ParamField>
