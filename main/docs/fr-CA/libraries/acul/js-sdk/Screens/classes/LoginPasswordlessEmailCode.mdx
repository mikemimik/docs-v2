...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `login-passwordless-email-code` d’Universal Login."
---

La classe LoginPasswordlessEmailCode implémente la fonctionnalité de l’écran `login-passwordless-email-code`. Cet écran recueille l’adresse courriel et le code de l’utilisateur.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/4DKgjU2dGw0mpLJKGfGhp0/470b29266da87f9bfc3e7eef55069620/Login_Passwordless_Email_Code.png" alt="Connexion par code envoyé par courriel sans mot de passe" />
</Frame>
...
<ParamField body="client" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des configurations relatives au client, comme `id`, `name` et `logoUrl`, pour l’écran `login-passwordless-email-code`.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="onStatusChange?" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/type-aliases/OnStatusChangeCallback">OnStatusChangeCallback</a></span>}>
      Fonction de rappel invoquée chaque fois que le statut du renvoi change; elle retourne le nombre de secondes restantes ainsi qu’un indicateur précisant si la fonctionnalité de renvoi est actuellement désactivée.
    </ParamField>
...
<ParamField body="switchConnection" type="Promise<void>">
  Cette méthode permet de passer d’une connexion de base de données (mot de passe) à une connexion sans mot de passe (OTP par courriel/SMS), et inversement.
