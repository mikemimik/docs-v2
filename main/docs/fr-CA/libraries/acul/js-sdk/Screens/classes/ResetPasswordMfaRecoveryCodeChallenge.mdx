...
La classe ResetPasswordMfaRecoveryCodeChallenge implémente les fonctionnalités de l’écran `reset-password-mfa-recovery-code-challenge`. Cet écran invite l’utilisateur à saisir un code de récupération dans le cadre de l’AMF pendant le processus de réinitialisation du mot de passe.
...
<ParamField body="client" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des paramètres relatifs au client, comme `id`, `name` et `logoUrl`, pour l’écran `reset-password-mfa-recovery-code-challenge`.
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  Cette méthode soumet le code de récupération pour poursuivre la vérification AMF pendant le processus de réinitialisation du mot de passe.
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  Cette méthode permet à l’utilisateur de sélectionner une autre méthode AMF pour terminer la vérification.
