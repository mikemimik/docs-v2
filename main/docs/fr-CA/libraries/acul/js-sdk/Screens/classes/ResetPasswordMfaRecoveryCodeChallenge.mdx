...
La classe ResetPasswordMfaRecoveryCodeChallenge implémente la fonctionnalité de l’écran `reset-password-mfa-recovery-code-challenge`. Cet écran invite l’utilisateur à saisir un code de récupération dans le cadre de l’étape AMF d’un flux de réinitialisation du mot de passe.
...
<ParamField body="continue" type="Promise<void>">
  Cette méthode soumet le code de récupération pour poursuivre la vérification AMF pendant le flux de réinitialisation du mot de passe.
