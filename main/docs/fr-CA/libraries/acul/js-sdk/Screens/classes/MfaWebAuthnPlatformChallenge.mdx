...
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `mfa-webauthn-platform-challenge` de Universal Login."
---
...
Créez une instance du gestionnaire d’écran du défi de plateforme WebAuthn AMF :
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="error" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/WebAuthnErrorDetails">WebAuthnErrorDetails</a></span>} required>
      L’error object de l’API WebAuthn (`navigator.credentials.get()`) à signaler.
