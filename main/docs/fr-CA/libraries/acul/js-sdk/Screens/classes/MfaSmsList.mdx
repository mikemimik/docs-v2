---
title: "MfaSmsList"
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `mfa-sms-list` de l’Universal Login."
---
...
Créez une instance du gestionnaire d’écran de liste des SMS MFA :
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Traite les données non fiables transmises au SDK, comme les saisies de l’utilisateur lors de la sélection dans la liste SMS de MFA.
</ParamField>
