...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `login-passwordless-sms-otp` dans Universal Login."
---
...
<ParamField body="user" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UserMembers">UserMembers</a></span>}>
  Détails sur l’utilisateur actif, notamment `username`, `email` et `roles`.
</ParamField>
...
<ParamField body="submitOTP" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="[`key`: `string`]" type="&#x22;string&#x22; | &#x22;number&#x22; | &#x22;boolean&#x22; | &#x22;undefined&#x22;">
      Des champs personnalisés supplémentaires précédés du préfixe `ulp-` (par exemple, `'ulp-custom-field'`).
    </ParamField>
  </Expandable>
</ParamField>
