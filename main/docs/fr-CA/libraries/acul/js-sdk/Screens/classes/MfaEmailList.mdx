...
La classe MfaEmailList implémente les fonctionnalités de l’écran `mfa-email-list`. Cet écran permet aux utilisateurs de sélectionner une adresse courriel déjà inscrite pour l’AMF.
...
Créez une instance du gestionnaire de l’écran AMF Email List :
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur lors de la sélection dans la liste des courriels AMF.
</ParamField>
...
<ParamField body="selectMfaEmail" type="Promise<void>">
  Cette méthode sélectionne une adresse courriel inscrite dans la liste.
