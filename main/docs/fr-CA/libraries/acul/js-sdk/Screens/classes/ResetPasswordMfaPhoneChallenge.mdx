...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `reset-password-mfa-phone-challenge` de Universal Login."
---

La classe ResetPasswordMfaPhoneChallenge implémente la fonctionnalité de l’écran `reset-password-mfa-phone-challenge`. Cet écran permet à l’utilisateur de demander un code de vérification par SMS ou appel vocal dans le cadre de l’étape AMF du flux de réinitialisation du mot de passe.
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Traite les données non fiables transmises au SDK, comme la saisie de l’utilisateur pendant le flux de vérification AMF.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="persist?" type="&#x22;session&#x22;">
      Lorsque cette valeur est définie sur `'session'`, la langue sélectionnée est enregistrée pendant toute la durée de la session.
    </ParamField>
  </Expandable>
</ParamField>

<ParamField body="continue" type="Promise<void>">
  Cette méthode envoie un code de vérification au téléphone de l’utilisateur selon le mode de livraison sélectionné afin de poursuivre la vérification AMF pendant le flux de réinitialisation du mot de passe.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="type" type="&#x22;sms&#x22; | &#x22;voice&#x22;" required>
      Le mode de livraison du code de vérification. Utilisez `sms` pour l’envoyer par message texte ou `voice` pour l’envoyer par appel vocal.
    </ParamField>
  </Expandable>
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="type?" type="&#x22;sms&#x22; | &#x22;voice&#x22;">
      Le mode de livraison présenté à l’écran actuel. Obligatoire pour que l’API traite correctement le changement de méthode.
    </ParamField>
  </Expandable>
</ParamField>