...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `mfa-webauthn-not-available-error` de l’expérience Universal Login."
---

La classe MfaWebAuthnNotAvailableError implémente le fonctionnement de l’écran `mfa-webauthn-not-available-error`. Cet écran s’affiche lorsque WebAuthn n’est pas disponible ou n’est pas pris en charge sur l’appareil ou dans le navigateur actuel de l’utilisateur.
...
Créez une instance du gestionnaire de l’écran d’erreur AMF WebAuthn indisponible :
...
<ParamField body="client" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des éléments de configuration liés au client, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-webauthn-not-available-error`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant la gestion de l’erreur MFA WebAuthn non disponible.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="persist?" type="&#x22;session&#x22;">
      Lorsque cette valeur est définie à `'session'`, la langue sélectionnée est enregistrée pour la durée de la session.
    </ParamField>
  </Expandable>
</ParamField>
