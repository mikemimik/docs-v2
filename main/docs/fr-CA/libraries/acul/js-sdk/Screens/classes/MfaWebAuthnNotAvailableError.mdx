...
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `mfa-webauthn-not-available-error` d’Universal Login."
---

La classe MfaWebAuthnNotAvailableError implémente la fonctionnalité de l’écran `mfa-webauthn-not-available-error`. Cet écran s’affiche lorsque WebAuthn n’est pas disponible ou n’est pas pris en charge sur l’appareil ou dans le navigateur actuels de l’utilisateur.
...
Créez une instance du gestionnaire d’écran AMF WebAuthn Not Available Error :
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme la saisie de l’utilisateur lors du traitement de l’erreur d’indisponibilité de WebAuthn pour l’AMF.
</ParamField>
