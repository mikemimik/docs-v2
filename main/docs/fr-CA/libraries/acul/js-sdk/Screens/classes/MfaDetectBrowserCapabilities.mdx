...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `mfa-detect-browser-capabilities` d’Universal Login."
---

La classe MfaDetectBrowserCapabilities implémente les fonctionnalités de l’écran `mfa-detect-browser-capabilities`. Cet écran détecte les capacités du navigateur pour les méthodes d’authentification AMF.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/7AKxEfmSBMoZw5JkKBmijz/475f620f97b3c6e22547301dffc7a41f/Screenshot_2025-02-20_at_11.20.35.png" alt="ACUL Détection des capacités du navigateur pour la AMF" />
</Frame>
...
Créez une instance du gestionnaire d’écran MFA Detect Browser Capabilities :
...
<ParamField body="detectCapabilities" type="Promise<void>">
  Cette méthode sélectionne un authenticator selon les capacités du navigateur.
