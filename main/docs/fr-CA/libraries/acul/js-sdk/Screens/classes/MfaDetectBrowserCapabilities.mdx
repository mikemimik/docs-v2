...
La classe MfaDetectBrowserCapabilities implémente la fonctionnalité de l’écran `mfa-detect-browser-capabilities`. Cet écran détecte les capacités du navigateur pour les méthodes d’authentification MFA.
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant la détection des capacités du navigateur pour la MFA.
</ParamField>
