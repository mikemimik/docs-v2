...
La classe InterstitialCaptcha implémente les fonctionnalités de l’écran `interstitial-captcha`. Cet écran invite l’utilisateur à effectuer une vérification CAPTCHA pendant le flux d’authentification.
...
Créez une instance du gestionnaire d’écran InterstitialCaptcha :
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant le flux de vérification CAPTCHA.
</ParamField>
...
<ParamField body="submitCaptcha" type="Promise<void>">
  Cette méthode envoie la réponse CAPTCHA pour poursuivre le flux d’authentification.
