---
title: "MfaPushList"
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `mfa-push-list` d’Universal Login."
---
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur dans la liste de push AMF.
</ParamField>
...
<ParamField body="selectMfaPushDevice" type="Promise<void>">
  Cette méthode sélectionne un appareil enregistré dans la liste afin d’initier un MFA push.
