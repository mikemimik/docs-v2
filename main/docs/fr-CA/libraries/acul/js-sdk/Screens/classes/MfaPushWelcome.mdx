...
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `mfa-push-welcome` d’Universal Login."
---

La classe MfaPushWelcome implémente la fonctionnalité de l’écran `mfa-push-welcome`.
...
Créez une instance du gestionnaire d’écran de bienvenue MFA Push :
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur sur l’écran d’accueil MFA push.
</ParamField>
...
<ParamField body="enroll" type="Promise<void>">
  Cette méthode redirige vers l’écran d’enrôlement.
...
<ParamField body="pickAuthenticator" type="Promise<void>">
  Cette méthode redirige vers l’écran de sélection de l’authentificateur.
