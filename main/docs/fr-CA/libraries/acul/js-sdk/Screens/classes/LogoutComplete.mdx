...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `logout-complete` d’Universal Login."
---

La classe LogoutComplete implémente la fonctionnalité de l’écran `logout-complete`. Cet écran s’affiche lorsqu’un utilisateur termine le processus de logout.
