...
La classe EmailOTPChallenge implémente la fonctionnalité de l’écran `email-otp-challenge`. Cet écran invite l’utilisateur à saisir un code d’accès à usage unique envoyé à son adresse courriel.
...
<ParamField body="client" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des paramètres liés au client, comme `id`, `name` et `logoUrl`, pour l’écran `email-otp-challenge`.
</ParamField>
...
<ParamField body="organization" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Fournit des renseignements sur l’Organization de l’utilisateur, notamment `id` et `name`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Contient les données non fiables transmises au SDK, comme les entrées utilisateur pendant le flux de challenge Email OTP.
</ParamField>
