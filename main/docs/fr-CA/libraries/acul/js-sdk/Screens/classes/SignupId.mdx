...
La classe SignupId implémente la fonctionnalité de l’écran `signup-id`. Cet écran recueille l’identifiant de l’utilisateur.
...
<ParamField body="screen" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnSignupId">ScreenMembersOnSignupId</a></span>}>
  Contient des renseignements propres à l’écran `signup-id`, y compris sa configuration et son contexte.
</ParamField>
...
<ParamField body="federatedSignup" type="Promise<void>">
  Cette méthode gère l’inscription à l’aide de différents identifiants sociaux, par exemple Google, Facebook, etc.
...
<ParamField body="getSignupIdentifiers" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/Identifier">Identifier</a>[] | null</span>}>
  Cette méthode renvoie la liste des identifiants activés pour le formulaire `signup-id`, en indiquant pour chacun s’il est obligatoire ou facultatif selon la configuration de la transaction. Elle renvoie un tableau d’objets identifiants (par exemple : courriel, téléphone, nom d’utilisateur).
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="captcha?" type="string">
      Le code CAPTCHA ou la réponse provenant du fournisseur CAPTCHA. Cette propriété est obligatoire si votre tenant Auth0 a [Bot Detection](/docs/fr-CA/secure/attack-protection/bot-detection) activé.
    </ParamField>
...
<ParamField body="validateUsername" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UsernameValidationResult">UsernameValidationResult</a></span>}>
  Cette méthode valide un nom d’utilisateur donné selon la politique de nom d’utilisateur actuelle définie dans le contexte de la transaction. Elle renvoie un objet indiquant si le nom d’utilisateur est valide et pour quelle raison.
