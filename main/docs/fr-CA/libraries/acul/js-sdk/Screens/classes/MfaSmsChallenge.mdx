...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembersOnMfaSmsChallenge">UntrustedDataMembersOnMfaSmsChallenge</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant le défi AMF par SMS.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="persist?" type="&#x22;session&#x22;">
      Si la valeur est `'session'`, la langue sélectionnée reste enregistrée pendant toute la session.
    </ParamField>
  </Expandable>
</ParamField>

<ParamField body="continueMfaSmsChallenge" type="Promise<void>">
  Cette méthode soumet le défi AMF par SMS avec le code fourni.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="rememberDevice?" type="boolean">
      Si la valeur est `true`, cet appareil est enregistré comme fiable afin que l’utilisateur ne soit pas invité à utiliser l’AMF lors de ses prochaines connexions à partir du même appareil.
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="resendManager" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ResendControl">ResendControl</a></span>}>
  Cette méthode offre une fonctionnalité de renvoi avec délai d’expiration configurable et gestion du statut.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="onStatusChange?" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/type-aliases/OnStatusChangeCallback">OnStatusChangeCallback</a></span>}>
      Fonction de rappel invoquée chaque fois que le statut du renvoi change; elle reçoit le nombre de secondes restantes ainsi que l’indication précisant si le renvoi est actuellement désactivé.
    </ParamField>
    ...
    <ParamField body="timeoutSeconds?" type="number">
      Le nombre de secondes avant que l’option de renvoi redevienne disponible.
    </ParamField>
  </Expandable>
</ParamField>
