...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `mfa-begin-enroll-options` d’Universal Login."
---

La classe MfaBeginEnrollOptions implémente la fonctionnalité de l’écran `mfa-begin-enroll-options`. Cet écran gère la sélection et l’enrôlement des facteurs MFA.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/62OEPAxQZojISBMcfMSSDl/7e72c9355ec129e03113121e308672a8/Screenshot_2025-02-18_at_13.40.51.png" alt="ACUL MFA - options de début d’enrôlement" />
</Frame>
...
Créez une instance du gestionnaire d’écran MFA Begin Enroll Options :
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant l’enrôlement à l’authentification multifacteur (MFA).
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="action" type="&#x22;push-notification&#x22; | &#x22;otp&#x22; | &#x22;sms&#x22; | &#x22;phone&#x22; | &#x22;voice&#x22; | &#x22;webauthn-roaming&#x22;" required>
      La valeur qui indique quel facteur inscrire. L’une des valeurs suivantes : &quot;push-notification&quot;, &quot;otp&quot;, &quot;sms&quot;, &quot;phone&quot;, &quot;voice&quot; ou &quot;webauthn-roaming&quot;.
    </ParamField>
  </Expandable>
</ParamField>
