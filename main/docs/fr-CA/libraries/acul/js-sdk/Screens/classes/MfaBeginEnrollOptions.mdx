...
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `mfa-begin-enroll-options` de Universal Login."
---

La classe MfaBeginEnrollOptions implémente la fonctionnalité de l’écran `mfa-begin-enroll-options`. Cet écran gère la sélection et l’inscription des facteurs MFA.
...
<ParamField body="client" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des paramètres liés au client, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-begin-enroll-options`.
</ParamField>
