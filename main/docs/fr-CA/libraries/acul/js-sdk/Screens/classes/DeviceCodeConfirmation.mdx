...
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `device-code-confirmation` de Universal Login."
---
...
<ParamField body="branding" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Fournit des paramètres liés à l’image de marque, comme le thème et les réglages de personnalisation.
</ParamField>
...
<ParamField body="client" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des paramètres liés au client, comme `id`, `name` et `logoUrl`, pour l’écran `device-code-confirmation`.
</ParamField>
...
<ParamField body="cancel" type="Promise<void>">
  Cette méthode annule le processus d’activation du code de l’appareil.
