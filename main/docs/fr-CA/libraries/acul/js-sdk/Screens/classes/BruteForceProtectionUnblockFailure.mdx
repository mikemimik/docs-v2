...
La classe BruteForceProtectionUnblockFailure implémente la fonctionnalité de l’écran `brute-force-protection-unblock-failure`. Cet écran s’affiche après une tentative échouée de débloquer un compte bloqué en raison de Brute Force Protection.
