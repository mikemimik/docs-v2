...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `email-identifier-challenge` de l’expérience Universal Login."
---

La classe EmailIdentifierChallenge implémente les fonctionnalités de l’écran `email-identifier-challenge`. Cet écran invite l’utilisateur à saisir un code de vérification envoyé à son adresse courriel afin de confirmer son identité.
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Traite les données non fiables transmises au SDK, comme les entrées utilisateur pendant le flux de vérification par courriel.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="onStatusChange?" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/type-aliases/OnStatusChangeCallback">OnStatusChangeCallback</a></span>}>
      Callback invoqué chaque fois que le status du renvoi change; il retourne le nombre de secondes restantes et indique si la fonctionnalité de renvoi est actuellement désactivée.
    </ParamField>
