...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `mfa-country-codes` d’Universal Login."
---

La classe MfaCountryCodes implémente les fonctionnalités de l’écran `mfa-country-codes`. Cet écran permet aux utilisateurs de sélectionner un indicatif de pays pour la vérification MFA du numéro de téléphone.
...
Créez une instance du gestionnaire de l’écran MFA Country Codes :
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur lors de la sélection de l’indicatif de pays MFA.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="persist?" type="&#x22;session&#x22;">
      Lorsque cette valeur est définie à `'session'`, la langue sélectionnée est enregistrée pour toute la durée de la session.
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="selectCountryCode" type="Promise<void>">
  Cette méthode sélectionne un code de pays parmi les options offertes.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="phone_prefix" type="string" required>
      Le préfixe téléphonique (par exemple, `'+1'`, `'+44'`).
    </ParamField>
  </Expandable>
</ParamField>