...
La classe MfaCountryCodes implémente la fonctionnalité de l’écran `mfa-country-codes`. Cet écran permet aux utilisateurs de sélectionner un indicatif de pays pour la vérification MFA par téléphone.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/7hp8LeL9cbS3nbxw8wTuqK/3c862b1c47ae18fb43f22f55ea4d695a/Screenshot_2025-02-19_at_13.23.44.png" alt="ACUL Codes de pays MFA" />
</Frame>
...
Créez une instance du gestionnaire d’écran MFA Country Codes :
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les entrées de l’utilisateur pendant la sélection de l’indicatif de pays pour la MFA.
</ParamField>
