...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `mfa-recovery-code-enrollment` d’Universal Login."
---

La classe MfaRecoveryCodeEnrollment implémente la fonctionnalité de l’écran `mfa-recovery-code-enrollment`. Cet écran s’affiche lorsque l’utilisateur doit enregistrer un code de récupération pour la MFA.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/2uWvPBVRFNE3pRVctzxyOP/986cc0aa6e64db27944bbcc3c5b4ea04/Screenshot_2025-04-23_at_19.05.21.png" alt="ACUL Inscription au code de récupération MFA" />
</Frame>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant l’enrôlement d’un code de récupération MFA.
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  Cette méthode indique que l’utilisateur a sauvegardé le code de récupération et poursuit le processus d’enrôlement.
