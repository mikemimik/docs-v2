...
La classe MfaWebAuthnRoamingEnrollment implémente les fonctionnalités de l’écran `mfa-webauthn-roaming-enrollment`. Cet écran s’affiche lorsqu’un utilisateur doit enrôler un authentificateur WebAuthn itinérant, par exemple : une clé de sécurité.
...
Créez une instance du gestionnaire de l’écran d’inscription AMF WebAuthn itinérante :
...
<ParamField body="branding" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Fournit des configurations liées au branding, comme le thème visuel et les paramètres.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies utilisateur pendant l’inscription WebAuthn itinérante pour l’AMF.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="persist?" type="&#x22;session&#x22;">
      Lorsque cette valeur est définie à `'session'`, la langue sélectionnée est enregistrée pendant toute la durée de la session.
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="showError" type="Promise<void>">
  Cette méthode envoie au serveur des détails sur une erreur de navigateur WebAuthn.
