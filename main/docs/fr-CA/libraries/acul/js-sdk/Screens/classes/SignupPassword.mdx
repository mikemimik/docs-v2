...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `signup-password` de Universal Login."
---

La classe SignupPassword implémente les fonctionnalités de l’écran `signup-password`. Cet écran sert à recueillir le mot de passe de l’utilisateur.
...
<ParamField body="screen" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnSignupPassword">ScreenMembersOnSignupPassword</a></span>}>
  Contient des détails propres à l’écran `signup-password`, notamment sa configuration et son contexte.
</ParamField>
...
<ParamField body="federatedSignup" type="Promise<void>">
  Cette méthode permet l’inscription au moyen de différentes identités sociales, par exemple Google ou Facebook.
...
<ParamField body="signup" type="Promise<void>">
  Cette méthode traite l’envoi du formulaire d’inscription par mot de passe.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="captcha?" type="string">
      Le code captcha ou la réponse du fournisseur de CAPTCHA. Cette propriété est requise si la fonctionnalité [Bot Detection](/docs/fr-CA/secure/attack-protection/bot-detection) est activée dans votre tenant Auth0.
    </ParamField>
...
<ParamField body="validatePassword" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/PasswordValidationResult">PasswordValidationResult</a></span>}>
  Cette méthode valide un mot de passe selon la politique de mot de passe de la transaction en cours. Elle renvoie un objet indiquant si le mot de passe est valide et pourquoi.
