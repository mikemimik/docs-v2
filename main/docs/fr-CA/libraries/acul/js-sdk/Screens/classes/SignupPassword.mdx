...
La classe SignupPassword implémente la fonctionnalité de l’écran `signup-password`. Cet écran recueille le mot de passe de l’utilisateur.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/5h85r3sVhe8mVw7rDkDwTD/02c3521d9d6c4d490c1a64ae37ecca72/Signup_Password_with_Flexible_IDs.png" alt="Mot de passe d’inscription avec IDs flexibles" />
</Frame>
...
<ParamField body="federatedSignup" type="Promise<void>">
  Cette méthode permet de s’inscrire au moyen de différentes identités sociales, par exemple Google, Facebook, etc.
...
<ParamField body="signup" type="Promise<void>">
  Cette méthode gère la soumission du formulaire d’inscription par mot de passe.
...
<ParamField body="switchConnection" type="Promise<void>">
  Cette méthode change la connexion d’authentification pendant le flux signup-password.
