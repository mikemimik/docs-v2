...
La classe ResetPasswordError implémente la fonctionnalité de l’écran `reset-password-error`. Cet écran s’affiche lorsqu’une erreur survient pendant le flux de réinitialisation du mot de passe, par exemple si le lien de réinitialisation est expiré ou non valide.
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Traite les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant le flux de réinitialisation du mot de passe.
</ParamField>
