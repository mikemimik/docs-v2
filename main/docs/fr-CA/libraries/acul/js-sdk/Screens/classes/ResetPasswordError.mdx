...
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `reset-password-error` d’Universal Login."
---

La classe ResetPasswordError implémente les fonctionnalités de l’écran `reset-password-error`. Cet écran s’affiche lorsqu’une erreur survient pendant le processus de réinitialisation du mot de passe, par exemple si le lien de réinitialisation est expiré ou invalide.
