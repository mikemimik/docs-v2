...
La classe MfaOtpChallenge implémente les fonctionnalités de l’écran `mfa-otp-challenge`. Cet écran s’affiche lorsqu’un utilisateur doit saisir un code OTP dans le cadre de l’authentification AMF.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/4EcKVu4uEjsNEpVcI5bW0b/e6fb47c9addc1c07f1f39516aafa5e0e/Screenshot_2025-03-26_at_00.01.07.png" alt="ACUL Défi OTP AMF" />
</Frame>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembersOnMfaOtpChallenge">UntrustedDataMembersOnMfaOtpChallenge</a></span>}>
  Gère les données non fiables transmises au SDK, comme la saisie de l’utilisateur pendant le défi OTP d’AMF.
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  Cette méthode permet de poursuivre le défi OTP à l’aide du code fourni.
