...
La classe OrganizationSelection implémente la fonctionnalité de l’écran `organization-selection`. Cet écran permet aux utilisateurs de sélectionner une organisation pour poursuivre.
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les entrées utilisateur pendant le flux de sélection d’organisation.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="organizationName" type="string" required>
      Le nom de l’organisation à utiliser pour poursuivre.
    </ParamField>
  </Expandable>
</ParamField>
