...
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `accept-invitation` de Universal Login."
---

La classe AcceptInvitation implémente la fonctionnalité de l’écran `accept-invitation`. Cet écran s’affiche lorsqu’un utilisateur doit accepter une invitation à se joindre à une organisation.
...
<ParamField body="client" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des paramètres liés au client, comme `id`, `name` et `logoUrl`, pour l’écran `accept-invitation`.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="persist?" type="&#x22;session&#x22;">
      Lorsqu’il est défini à `'session'`, le choix de langue est conservé pendant toute la session.
    </ParamField>
  </Expandable>
</ParamField>
