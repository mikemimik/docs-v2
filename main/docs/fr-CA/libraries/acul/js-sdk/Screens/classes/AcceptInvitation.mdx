...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `accept-invitation` de Universal Login."
---

La classe AcceptInvitation implémente la fonctionnalité de l’écran `accept-invitation`. Cet écran s’affiche lorsqu’un utilisateur doit accepter une invitation pour rejoindre une organisation.
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Contient les données non fiables transmises au SDK, comme la saisie de l’utilisateur pendant le flux d’acceptation de l’invitation.
</ParamField>
