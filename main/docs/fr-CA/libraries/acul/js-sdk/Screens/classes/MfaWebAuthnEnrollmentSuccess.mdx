...
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `mfa-webauthn-enrollment-success` de Universal Login."
---

La classe MfaWebAuthnEnrollmentSuccess implémente la fonctionnalité de l’écran `mfa-webauthn-enrollment-success`. Cet écran s’affiche lorsque l’utilisateur a réussi à inscrire une clé de sécurité WebAuthn.
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Traite les données non fiables transmises au SDK, comme les données saisies par l’utilisateur lors de la réussite de l’inscription WebAuthn en AMF.
</ParamField>
