...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `brute-force-protection-unblock-success` de Universal Login."
---

La classe BruteForceProtectionUnblockSuccess implémente la fonctionnalité de l’écran `brute-force-protection-unblock-success`. Cet écran s’affiche après le succès d’une requête de déblocage de compte soumise par l’entremise de Brute Force Protection.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="persist?" type="&#x22;session&#x22;">
      Lorsque ce paramètre est défini à `'session'`, la langue sélectionnée est enregistrée pour toute la durée de la session.
    </ParamField>
  </Expandable>
</ParamField>
