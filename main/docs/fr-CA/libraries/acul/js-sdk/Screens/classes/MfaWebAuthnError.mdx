...
La classe MfaWebAuthnError implémente la fonctionnalité de l’écran `mfa-webauthn-error`. Cet écran s’affiche lorsqu’une erreur se produit pendant une opération WebAuthn.
...
Créez une instance du gestionnaire d’écran AMF WebAuthn Error :
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur lors du traitement des erreurs WebAuthn de l’AMF.
</ParamField>
...
<ParamField body="usePassword" type="Promise<void>">
  Cette méthode permet à l’utilisateur de s’authentifier à l’aide de son mot de passe au lieu de WebAuthn.
