...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `reset-password-success` d’Universal Login."
---
...
<ParamField body="getErrors" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a>[]</span>}>
  Cette méthode récupère le array d’erreurs de transaction dans le contexte, ou un array vide s’il n’y en a aucune.
</ParamField>