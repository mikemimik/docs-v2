...
description: "Décrit toutes les propriétés et les méthodes disponibles pour personnaliser l’écran `reset-password-success` d’Universal Login."
---

La classe ResetPasswordSuccess implémente les fonctionnalités de l’écran `reset-password-success`. Cet écran confirme à l’utilisateur que son mot de passe a bien été réinitialisé.
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Contient les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant le flux de réinitialisation du mot de passe.
</ParamField>

<ParamField body="user" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UserMembers">UserMembers</a></span>}>
  Détails de l’utilisateur actif, y compris le `username`, l’`email` et les `roles`.
</ParamField>
