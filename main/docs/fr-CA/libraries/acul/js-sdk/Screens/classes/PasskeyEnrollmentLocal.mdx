...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `passkey-enrollment-local` d’Universal Login."
---
...
Créez une instance du gestionnaire d’écran PasskeyEnrollmentLocal :
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="doNotShowAgain?" type="boolean">
      Lorsque cette option est définie à `true`, l’invite d’inscription de la clé d’accès est masquée pour les sessions futures.
    </ParamField>
  </Expandable>
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="language" type="string" required>
      Le code de langue (`locale`) correspondant à la langue souhaitée (par exemple, `'en'`, `'fr'`, `'es'`).
    </ParamField>
...
<ParamField body="getErrors" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a>[]</span>}>
  Cette méthode récupère le tableau des erreurs de la transaction à partir du contexte, ou un tableau vide s’il n’en existe aucune.
</ParamField>