...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `passkey-enrollment-local` de Universal Login."
---
...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/7FZiX1waboFh7cd7HmKSwX/df095b993e61cb453b3e8db8dec81ce3/Passkey_Enrollment_Local.png" alt="Inscription d’une clé d’accès locale" />
</Frame>
...
<ParamField body="branding" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Fournit des configurations liées au branding, comme le thème et les paramètres de marque.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant le processus d’inscription de la clé d’accès.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="doNotShowAgain?" type="boolean">
      Lorsqu’elle est définie à `true`, cette option masque l’invite d’inscription de la clé d’accès pour les prochaines sessions.
    </ParamField>
  </Expandable>
</ParamField>
