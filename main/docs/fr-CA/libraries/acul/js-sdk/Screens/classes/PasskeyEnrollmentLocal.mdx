...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `passkey-enrollment-local` de Universal Login."
---

La classe PasskeyEnrollmentLocal implémente la fonctionnalité de l’écran `passkey-enrollment-local`. Cet écran permet aux utilisateurs d’enregistrer une clé d’accès stockée localement sur leur appareil comme méthode d’authentification.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/7FZiX1waboFh7cd7HmKSwX/df095b993e61cb453b3e8db8dec81ce3/Passkey_Enrollment_Local.png" alt="Inscription locale de la clé d’accès" />
</Frame>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant le flux d’inscription de la clé d’accès.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="doNotShowAgain?" type="boolean">
      Lorsqu’elle est définie sur `true`, cette option masque le prompt d’inscription de la clé d’accès pour les prochaines sessions.
    </ParamField>
  </Expandable>
</ParamField>
