...
description: "Décrit toutes les propriétés et les méthodes disponibles pour personnaliser l’écran `phone-identifier-enrollment` de Universal Login."
---
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant le flux d’inscription du téléphone.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="persist?" type="&#x22;session&#x22;">
      Lorsqu’il est défini sur `'session'`, la langue sélectionnée est enregistrée pendant toute la durée de la session.
    </ParamField>
  </Expandable>
</ParamField>

<ParamField body="continuePhoneEnrollment" type="Promise<void>">
  Cette méthode poursuit le processus d’inscription du téléphone avec le mode de livraison sélectionné.
