...
La classe PhoneIdentifierEnrollment implémente la fonctionnalité de l’écran `phone-identifier-enrollment`. Cet écran permet aux utilisateurs d’enregistrer un numéro de téléphone comme identifiant en sélectionnant leur mode d’envoi de la vérification préféré.
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les entrées de l’utilisateur pendant le flux d’inscription du numéro de téléphone.
</ParamField>
...
<ParamField body="continuePhoneEnrollment" type="Promise<void>">
  Cette méthode poursuit le processus d’enregistrement du numéro de téléphone avec le mode d’envoi sélectionné.
