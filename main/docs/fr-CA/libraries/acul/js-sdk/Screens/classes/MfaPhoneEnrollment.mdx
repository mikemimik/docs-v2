...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `mfa-phone-enrollment` de Universal Login."
---

La classe MfaPhoneEnrollment implémente la fonctionnalité de l’écran `mfa-phone-enrollment`. Cet écran permet aux utilisateurs d’enrôler un numéro de téléphone pour MFA.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/ja-jp/cdy7uua7fh8z/3o4ohXUXfkVaaZy0992sgL/a84b54fa31fcbf2b0695c9ff08357887/Screenshot_2025-04-23_at_17.36.28.png" alt="ACUL Enrôlement MFA par téléphone" />
</Frame>
...
Créez une instance du gestionnaire de l’écran d’enrôlement téléphonique MFA :
...
<ParamField body="screen" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Contient des renseignements propres à l’écran `mfa-phone-enrollment`, y compris sa configuration et son contexte.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme la saisie de l’utilisateur pendant l’enrôlement du téléphone pour l’AMF.
</ParamField>
