...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `mfa-phone-enrollment` de Universal Login."
---

La classe MfaPhoneEnrollment implémente la fonctionnalité de l’écran `mfa-phone-enrollment`. Cet écran permet aux utilisateurs d’enregistrer un numéro de téléphone pour l’AMF.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/ja-jp/cdy7uua7fh8z/3o4ohXUXfkVaaZy0992sgL/a84b54fa31fcbf2b0695c9ff08357887/Screenshot_2025-04-23_at_17.36.28.png" alt="Inscription téléphonique AMF ACUL" />
</Frame>
...
Créez une instance du gestionnaire de l’écran d’inscription AMF par téléphone :
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Traite les données non fiables transmises au SDK, comme les entrées utilisateur pendant l’inscription du téléphone à l’AMF.
</ParamField>
...
<ParamField body="pickCountryCode" type="Promise<void>">
  Cette méthode mène à l’écran de sélection de l’indicatif de pays.
