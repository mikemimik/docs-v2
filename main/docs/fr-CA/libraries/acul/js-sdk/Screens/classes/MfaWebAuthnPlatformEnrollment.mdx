...
La classe MfaWebAuthnPlatformEnrollment implémente la fonctionnalité de l’écran `mfa-webauthn-platform-enrollment`. Cet écran s’affiche lorsque l’utilisateur doit inscrire un authenticator de plateforme, comme Touch ID ou Face ID.
...
<ParamField body="branding" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Fournit des configurations liées à l’image de marque, notamment le thème et les paramètres de l’image de marque.
</ParamField>
...
<ParamField body="client" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des configurations relatives au client, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-webauthn-platform-enrollment`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Contient les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant l’inscription WebAuthn de plateforme AMF.
</ParamField>
...
<ParamField body="refuseEnrollmentOnThisDevice" type="Promise<void>">
  Cette méthode permet à l’utilisateur de refuser l’inscription WebAuthn de plateforme sur l’appareil actuel.
...
<ParamField body="snoozeEnrollment" type="Promise<void>">
  Cette méthode permet à l’utilisateur de reporter l’inscription WebAuthn de plateforme.
...
<ParamField body="submitPasskeyCredential" type="Promise<void>">
  Cette méthode lance la création des informations d’identification WebAuthn de plateforme et transmet les informations d’identification obtenues au serveur.
