...
description: "Décrit l’ensemble des propriétés et des méthodes disponibles pour personnaliser l’écran `mfa-webauthn-platform-enrollment` de Universal Login."
---

La classe MfaWebAuthnPlatformEnrollment implémente les fonctionnalités de l’écran `mfa-webauthn-platform-enrollment`. Cet écran s’affiche lorsque l’utilisateur doit enregistrer un authentificateur de plateforme, comme Touch ID ou Face ID.
...
<ParamField body="screen" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnMfaWebAuthnPlatformEnrollment">ScreenMembersOnMfaWebAuthnPlatformEnrollment</a></span>}>
  Contient des détails propres à l’écran `mfa-webauthn-platform-enrollment`, notamment sa configuration et son contexte.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant l’inscription à WebAuthn de plateforme pour l’AMF.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="persist?" type="&#x22;session&#x22;">
      Lorsque défini sur `'session'`, la langue sélectionnée est enregistrée pour toute la durée de la session.
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="refuseEnrollmentOnThisDevice" type="Promise<void>">
  Cette méthode permet à l’utilisateur de refuser l’inscription à WebAuthn de plateforme sur l’appareil actuel.
...
<ParamField body="submitPasskeyCredential" type="Promise<void>">
  Cette méthode lance la création du passkey de plateforme WebAuthn et envoie le credential obtenu au serveur.
