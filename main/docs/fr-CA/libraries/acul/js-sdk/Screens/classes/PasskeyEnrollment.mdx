...
description: "Décrit toutes les propriétés et les méthodes disponibles pour personnaliser l’écran `passkey-enrollment` d’Universal Login."
---

La classe PasskeyEnrollment met en œuvre les fonctionnalités de l’écran `passkey-enrollment`. Cet écran permet aux utilisateurs d’enregistrer une clé d’accès comme méthode d’authentification.
...
<ParamField body="branding" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Fournit des configurations liées à l’image de marque, comme le thème de marque et les paramètres associés.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Traite les données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant le flux d’enregistrement de clé d’accès.
</ParamField>
...
<ParamField body="abortPasskeyEnrollment" type="Promise<void>">
  Cette méthode interrompt le processus d’enregistrement de clé d’accès.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="doNotShowAgain?" type="boolean">
      Lorsqu’elle est définie sur `true`, masque l’écran d’enregistrement de clé d’accès pour les prochaines sessions.
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="continuePasskeyEnrollment" type="Promise<void>">
  Cette méthode poursuit le processus d’enregistrement de clé d’accès.
