...
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `reset-password-request` de l’expérience Universal Login."
---
...
<ParamField body="resetPassword" type="Promise<void>">
  Cette méthode soumet l’identifiant de l’utilisateur pour amorcer le flux de réinitialisation du mot de passe.
