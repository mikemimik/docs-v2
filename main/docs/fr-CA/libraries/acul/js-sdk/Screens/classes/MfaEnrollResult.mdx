...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `mfa-enroll-result` d’Universal Login."
---

La classe MfaEnrollResult implémente la fonctionnalité de l’écran `mfa-enroll-result`. Cet écran affiche le résultat de l’inscription d’un facteur MFA.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/lfXmpkRzf0XoXV12vYMe9/a426e0cce6d405a0314a59e79cb4f918/Screenshot_2025-02-20_at_17.10.00.png" alt="Résultat d’inscription MFA ACUL" />
</Frame>
...
Créez une instance du gestionnaire de l’écran de résultat de l’inscription MFA :
...
<ParamField body="screen" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnMfaEnrollResult">ScreenMembersOnMfaEnrollResult</a></span>}>
  Contient des détails propres à l’écran `mfa-enroll-result`, notamment sa configuration et son contexte.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les entrées de l’utilisateur pendant l’inscription à l’AMF.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="language" type="string" required>
      Le code de langue (locale) pour la langue souhaitée (par exemple, `'en'`, `'fr'`, `'es'`).
    </ParamField>
