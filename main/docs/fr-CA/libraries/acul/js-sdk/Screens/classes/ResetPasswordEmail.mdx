...
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `reset-password-email` dans Universal Login."
---

La classe ResetPasswordEmail implémente la fonctionnalité associée à l’écran `reset-password-email`. Cet écran informe l’utilisateur qu’un courriel de réinitialisation du mot de passe a été envoyé et lui permet de le renvoyer au besoin.
