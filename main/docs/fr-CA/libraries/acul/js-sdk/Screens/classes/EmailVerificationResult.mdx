...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `email-verification-result` d’Universal Login."
---
...
<ParamField body="client" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des renseignements sur le client, comme `id`, `name` et `logoUrl`, pour l’écran `email-verification-result`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Contient les données non fiables transmises au SDK, comme les entrées utilisateur pendant le flux de vérification du courriel.
</ParamField>
