...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `mfa-otp-enrollment-qr` de Universal Login."
---

La classe MfaOtpEnrollmentQr implémente les fonctionnalités de l’écran `mfa-otp-enrollment-qr`. Cet écran affiche un code QR que l’utilisateur doit numériser avec son application d’authentification lors de l’enrôlement MFA.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/xgACud9b5L3UQ6OKH5rf8/8c3cce8d90c0b9d2162e2441df85bb01/Screenshot_2025-03-26_at_00.00.27.png" alt="ACUL QR d’enrôlement MFA OTP" />
</Frame>
...
Créez une instance du gestionnaire de l’écran de code QR d’enrôlement MFA OTP :
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant l’enrôlement à l’AMF par OTP.
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  Cette méthode soumet le code OTP pour poursuivre le processus d’enrôlement.
...
<ParamField body="toggleView" type="Promise<void>">
  Cette méthode permet de passer de la vue du code QR à la saisie manuelle, et inversement.
