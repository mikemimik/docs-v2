...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `device-code-activation` de Universal Login."
---
...
<ParamField body="continue" type="Promise<void>">
  Cette méthode soumet le code d’appareil saisi par l’utilisateur pour terminer l’activation.
