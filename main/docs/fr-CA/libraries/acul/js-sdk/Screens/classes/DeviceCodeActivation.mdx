...
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `device-code-activation` de Universal Login."
---
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les entrées utilisateur pendant le flux d’activation du code d’appareil.
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  Cette méthode soumet le device code saisi par l’utilisateur pour terminer l’activation.
