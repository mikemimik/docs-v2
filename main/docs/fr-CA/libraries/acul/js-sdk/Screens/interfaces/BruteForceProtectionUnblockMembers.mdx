...
Interface définissant les méthodes et propriétés disponibles pour l’écran `brute-force-protection-unblock`.
...
<ParamField body="unblockAccount" type="Promise<void>">
  Débloque le compte de l’utilisateur une fois que protection contre la force brute a été déclenchée.
