...
Interface définissant les méthodes et propriétés disponibles pour l’écran organization-picker
...
<ParamField body="skipOrganizationSelection" type="Promise<void>">
  Passe la sélection d’organisation et poursuit avec le compte personnel de l’utilisateur.
