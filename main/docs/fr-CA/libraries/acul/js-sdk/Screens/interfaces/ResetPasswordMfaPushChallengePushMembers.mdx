...
export interface ResetPasswordMfaPushChallengePushMembers extends BaseMembers {
  ...
  /**
   * Permet le polling pour vérifier si le défi par notification push a été approuvé.
...
<ParamField body="pollingManager" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/MfaPushPollingControl">MfaPushPollingControl</a></span>}>
  Permet d’effectuer un polling jusqu’à ce que le défi par notification push soit approuvé.
