...
<ParamField body="continue" type="Promise<void>">
  ...
  Promise qui est résolue lorsque l’inscription se poursuit.
...
<ParamField body="selectPhoneCountryCode" type="Promise<void>">
  ...
  Promise qui est résolue lorsque l’indicatif de pays est sélectionné.
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  ...
  Promise qui est résolue lorsque l’utilisateur change de méthode.
