...
Interface qui définit les méthodes et propriétés disponibles pour l’écran mfa-email-challenge
...
<ParamField body="pickEmail" type="Promise<void>">
  Soumet l’action permettant de choisir une autre configuration de courriel, si offerte
