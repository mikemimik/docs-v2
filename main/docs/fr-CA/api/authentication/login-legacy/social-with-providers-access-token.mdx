...
<Note>
  ...
  Cette fonctionnalité est désactivée par défaut pour les nouveaux tenants depuis le 8 juin 2017. Veuillez consulter [Types d’autorisation des applications](/applications/concepts/application-grant-types) pour en savoir plus.
</Note>
