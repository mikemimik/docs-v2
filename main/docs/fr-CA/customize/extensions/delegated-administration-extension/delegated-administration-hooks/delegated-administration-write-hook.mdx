...
Le Write Hook, qui s’exécute chaque fois que vous créez ou mettez à jour un utilisateur, vous permet notamment de faire ce qui suit :

* Modifier le mot de passe de l’utilisateur
* Modifier l’adresse courriel de l’utilisateur
* Mettre à jour le profil de l’utilisateur

Vous pouvez aussi utiliser le Write Hook pour définir automatiquement des valeurs par défaut pour les utilisateurs nouvellement créés. Par exemple, vous pourriez attribuer automatiquement à un utilisateur le même groupe, département ou fournisseur que ceux qui vous ont été attribués.
...
* **ctx** : Objet de contexte.
  ...
  * **request.originalUser** : Valeurs actuelles de l’utilisateur, où le **payload** correspond au nouvel ensemble de champs. Accessible uniquement lorsque la méthode est **update**.
  ...
  * **method** : Soit **create**, soit **update**, selon qu’il s’agit d’un appel déclenché par une création ou une mise à jour.
