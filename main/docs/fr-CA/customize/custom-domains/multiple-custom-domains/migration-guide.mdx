...
Ajoutez vos nouveaux domaines personnalisés dans l’[Auth0 Dashboard](/docs/fr-CA/customize/custom-domains/multiple-custom-domains#configure-multiple-custom-domains) ou au moyen de la [Management API](https://auth0.com/docs/api/management/v2).
...
Si vous voulez qu’un domaine soit utilisé par défaut pour les courriels et les appels d’API, [définissez-le comme domaine par défaut](/docs/fr-CA/customize/custom-domains/multiple-custom-domains/default-domain) :
