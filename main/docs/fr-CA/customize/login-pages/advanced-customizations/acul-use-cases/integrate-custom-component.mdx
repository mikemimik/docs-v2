---
description: Découvrez comment intégrer une bibliothèque de composants personnalisés à ACUL
...
2. Lancez le serveur de développement local ACUL pour modifier et prévisualiser les mises à jour de votre écran.
...
6. Intégrez le composant :
   a. Rendez-vous dans `src/screens/login-passwordless-email-code/components/IdentifierForm.tsx` et ouvrez le fichier.
   b. Importez les composants InputOTP et remplacez le champ de saisie existant. Vous devez également gérer l’état du code OTP et utiliser le hook approprié du SDK.
...
9. Suivez les étapes pour générer vos assets locaux, démarrer le serveur de développement local et mettre à jour la configuration ACUL dans votre tenant.

10. Testez le flux d’authentification passwordless :
