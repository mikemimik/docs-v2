...
Créez une application [Machine-to-Machine](/docs/fr-CA/get-started/auth0-overview/create-applications/machine-to-machine-apps) pour accorder les autorisations au flux de travail GitHub afin de mettre à jour les paramètres de votre tenant.
