---
description: Découvrez comment personnaliser une page de réinitialisation de mot de passe de Classic Login.
title: Personnaliser la page de réinitialisation de mot de passe de Classic Login
---
...
<Card title="Vous réinitialisez un mot de passe?">
  Cette page explique comment personnaliser une page de réinitialisation de mot de passe de Classic Login.
...
Si vous utilisez Classic Login, la page de réinitialisation de mot de passe permet à vos utilisateurs de modifier leur mot de passe s’ils ne peuvent pas se connecter. Dans la page de réinitialisation de mot de passe, Auth0 prend en charge toutes les fonctionnalités requises, notamment :
