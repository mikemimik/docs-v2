...
<Warning>
  Pour utiliser des champs personnalisés, vous devez activer [Custom Domains](/docs/fr-CA/customize/custom-domains). Si vous affichez un formulaire avec un champ personnalisé en dehors d’un domaine personnalisé, une erreur s’affichera.
</Warning>
