...
1. Pour associer un rôle AWS à un utilisateur, créez une [règle](/docs/fr-CA/customize/rules) :
...
Pour prolonger le délai avant l’expiration de la session AWS (3600 secondes), utilisez une [règle personnalisée](/docs/fr-CA/customize/rules). Votre règle définit l’[attribut **SessionDuration**](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_providers_create_saml_assertions.html), ce qui modifie la durée de la session.
