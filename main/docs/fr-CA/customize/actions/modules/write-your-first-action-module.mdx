---
mode: wide
description: Décrit comment utiliser les modules d’Actions Auth0
  ...
  <Step title="Ajouter l’Action Module à une Action" titleSize="h3" stepNumber={6}>
    ...
    <Tabs>
      ...
      <Tab title="Dashboard">
        ...
        <Frame><Frame>![Actions - Ajouter un module d'action](/docs/images/customize/actions/modules/actions-modules-add-module.png)</Frame></Frame>
      </Tab>
