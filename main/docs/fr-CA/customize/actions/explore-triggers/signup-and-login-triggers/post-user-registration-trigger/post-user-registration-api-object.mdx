...
Supprime l’enregistrement d’une valeur en cache associée à la
...
Récupère, s’il existe, un enregistrement décrivant la valeur mise en cache correspondant à la clé fournie.
