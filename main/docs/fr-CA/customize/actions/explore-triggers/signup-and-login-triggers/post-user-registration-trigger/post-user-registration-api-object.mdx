...
#
description: Découvrez l’objet API du déclencheur post-user-registration des Actions.
title: 'Déclencheurs des Actions : post-user-registration - Objet API'
validatedOn: 2026-05-22
---

L’objet API du déclencheur post-user-registration des Actions comprend :
  ...
  <Expandable title="propriétés des options" defaultOpen>
    <ResponseField name="expires_at" type="number" post={["optional"]}>
      ...
      *Remarque* : Cette valeur ne doit pas être fournie si une valeur a aussi été
      ...
      plus proche des deux expirations sera utilisée.
    </ResponseField>
