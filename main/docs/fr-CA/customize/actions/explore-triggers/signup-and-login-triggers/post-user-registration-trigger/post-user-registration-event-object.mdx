...
#
description: Découvrez l’objet Event du déclencheur post-user-registration d’Actions, qui fournit des informations contextuelles sur l’exécution du déclencheur.
title: 'Déclencheurs Actions : post-user-registration - objet Event'
validatedOn: 2026-05-25
---

L’objet `event` du déclencheur post-user-registration d’Actions fournit des informations contextuelles sur l’exécution du déclencheur.
        ...
        <ResponseField name="supplemental" type="dictionary" post={["optional"]}>
          ...
          <Expandable title="propriétés de supplemental">
            <ResponseField name="akamai" type="dictionary" post={["optional"]}>
              &#91;Early Access&#93; Évaluation supplémentaire du risque. Cette fonctionnalité est disponible uniquement si Akamai Account Protector est activé et qu’Akamai transfère les en-têtes de la transaction.

              <Expandable title="propriétés de akamai">
                <ResponseField name="akamaiBot" type="object" post={["optional"]}>
                  Les résultats de la détection de bots tels que transférés par Akamai Bot Manager.
                ...
                <ResponseField name="akamaiUserRisk" type="dictionary" post={["optional"]}>
                  Les résultats de détection du risque utilisateur tels que transférés par Akamai Account Protector.
...
<ResponseField name="event.connection" type="dictionary">
  Détails sur la connexion ayant servi à inscrire l’utilisateur.
...
<ResponseField name="event.request" type="dictionary" post={["optional"]}>
  ...
  <Expandable title="propriétés de la requête" defaultOpen>
    ...
    <ResponseField name="user_agent" type="string" post={["optional"]}>
      La valeur de l’en-tête `User-Agent` reçue lors du lancement de la transaction.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="event.transaction" type="dictionary" post={["optional"]}>
  ...
  <Expandable title="propriétés de transaction" defaultOpen>
    ...
    <ResponseField name="ui_locales" type="array of strings">
      Les `ui_locales` fournies dans la requête d’authentification d’origine.
    </ResponseField>
  </Expandable>
</ResponseField>
