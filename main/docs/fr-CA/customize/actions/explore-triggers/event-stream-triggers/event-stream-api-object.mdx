...
Supprime, s’il existe, l’enregistrement correspondant à une valeur mise en cache pour la
clé fournie.
...
disponibles dans des transactions ultérieures, même si leur durée de vie indiquée n’est pas encore écoulée.
