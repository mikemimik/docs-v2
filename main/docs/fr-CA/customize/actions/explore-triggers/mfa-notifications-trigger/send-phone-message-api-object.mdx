...
#
description: Découvrez l’objet API du déclencheur send-phone-message des Actions.
title: 'Déclencheurs des Actions : send-phone-message - objet API'
validatedOn: 2026-05-22
---

L’objet API du déclencheur send-phone-message des Actions comprend :
...
Supprime l’enregistrement correspondant à une valeur mise en cache
pour la clé fournie, s’il existe.
...
disponibles dans des transactions ultérieures même si leur durée de vie indiquée n’est pas écoulée.
