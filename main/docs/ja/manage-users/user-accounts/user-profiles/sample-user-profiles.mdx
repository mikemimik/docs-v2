...
これは、**Google** でログインしたユーザーのサンプルユーザープロファイルです。
...
以下は、**Microsoft Account**のサンプルプロファイルです:
...
<div id="office-365-user-profile">
  ## Office 365 ユーザープロファイル
</div>

以下は、**Office 365 (Microsoft Azure Active Directory)** のユーザープロファイルのサンプルです。
...
これは **ADFS (Active Directory Federation Services)&#x20;**&#x20;のサンプルプロファイルです。
