...
* [/authorize](/docs/ja/api/authentication/authorization-code-flow/authorize-application) エンドポイントを呼び出す
* [サイレント認証](/docs/ja/authenticate/login/configure-silent-authentication)を実行する
* [シングルサインオン](/docs/ja/authenticate/single-sign-on)を使用して新しいアプリケーションにログインする
...
[セッションの有効期間を設定する](/docs/ja/manage-users/sessions/configure-session-lifetime)方法をご覧ください。
...
* Actions を使用してセッションのライフサイクルを設定する方法について詳しくは、[Actions でのセッション](/docs/ja/manage-users/sessions/manage-sessions-actions)を参照してください。

* Auth0 Management API のセッション管理エンドポイントについて詳しくは、[Management API でのセッション](/docs/ja/manage-users/sessions/manage-user-sessions-with-auth0-management-api)を参照してください。