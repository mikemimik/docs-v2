...
* [Actions](/docs/ja/customize/actions)
* [ルール](/docs/ja/customize/rules)
* [フック](/docs/ja/customize/hooks)
* [カスタムデータベースアクションスクリプト](/docs/ja/authenticate/database-connections/custom-db/templates)
* [Log Streams](/docs/ja/customize/log-streams)
* [外部 SMTP メールプロバイダー](/docs/ja/customize/email/smtp-email-providers)
...
| `regions`         | object              | [Auth0 テナントリージョン](/docs/ja/get-started/auth0-overview/create-tenants#region-locality-and-sub-locality)のコレクション。各テナントリージョンオブジェクトには、次のプロパティが含まれます。 * `ipv4_cidrs`: 文字列の配列。指定したリージョンの IPv4 CIDR 範囲の一覧。                                            |
