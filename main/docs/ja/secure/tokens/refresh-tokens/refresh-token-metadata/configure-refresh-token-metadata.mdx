...
リフレッシュトークンメタデータを設定するには、Auth0 の [Post-Login Action](/docs/ja/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger) と [Management API](https://auth0.com/docs/api/management/v2) を使用できます。

<div id="auth0-post-login-actions">
  ## Auth0 Post-Login Actions
</div>

[post-login Action](/docs/ja/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger) を使用すると、`api.refreshToken` オブジェクトを通じて、リフレッシュトークンメタデータに対する CRUD 操作を管理できます。これにより、ユーザーやコンテキストに応じたロジックに基づいて、リフレッシュトークンメタデータを管理できます。
...
* [Event object](/docs/ja/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/post-login-event-object): リフレッシュトークンの Event オブジェクトとそのプロパティについて説明します。
* [API object](/docs/ja/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/post-login-api-object): リフレッシュトークンの API オブジェクトとそのメソッドについて説明します。
...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  `/api/v2/refresh-tokens/{id}` エンドポイントを呼び出すには、`update:refresh_tokens` スコープを持つ [Management API アクセストークン](/docs/ja/secure/tokens/access-tokens) が必要です。
</Callout>
...
[Auth0 Dashboard &gt; Monitoring &gt; Logs](https://manage.auth0.com/#/logs) に移動してリフレッシュトークンメタデータのログイベントを確認するか、[Management API logs](/docs/ja/api/management/v2/logs/get-logs) エンドポイントを使用してログを取得できます。
...
* [リフレッシュトークンのメタデータ](/docs/ja/secure/tokens/refresh-tokens/refresh-token-metadata)
* [Actions でのリフレッシュトークン](/docs/ja/secure/tokens/refresh-tokens/manage-refresh-tokens-actions)
* [リフレッシュトークン](/docs/ja/secure/tokens/refresh-tokens)
* [Post-Login イベントオブジェクト](/docs/ja/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/post-login-event-object)
* [Post-Login API オブジェクト](/docs/ja/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/post-login-api-object)