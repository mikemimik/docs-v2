...
[partials](/docs/ja/customize/login-pages/universal-login/customize-signup-and-login-prompts#manage-partials-programmatically) を使用して Signup および Login プロンプトをカスタマイズすると、実験のコンテキストが partials に明示的に渡されます。
