...
* ユーザーが [組織](/docs/ja/manage-users/organizations/organizations-overview) を介してログインする場合は、以下の追加変数も使用できます:
  * `organization.id`
  * `organization.name`
...
* 複数の <Tooltip tip="カスタムドメイン: 特別な、または独自の名前を持つサードパーティドメイン。" cta="用語集を見る" href="/docs/ja/glossary?term=custom+domains">カスタムドメイン</Tooltip> 変数:
