...
Write Hooks の詳細については、[Delegated Administration: Write Hook](/docs/ja/customize/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-write-hook) を参照してください。
...
* **blocked&#95;for**: ユーザーが<Tooltip tip="攻撃対策: Auth0 が提供する、攻撃の検出と緩和のための機能です。これには、総当たり攻撃対策、不審な IP スロットリング、漏えいパスワードの検知、ボット検出、適応型多要素認証が含まれます。" cta="用語集を見る" href="/docs/ja/glossary?term=attack+protection">攻撃対策</Tooltip>によってブロックされているかどうか
