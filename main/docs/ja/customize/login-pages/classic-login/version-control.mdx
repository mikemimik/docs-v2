...
<Warning>
  現時点で、Auth0 の開発は Universal Login に注力されており、クラシックログインは現在更新されていません。ログインページをカスタマイズするには、Auth0 は [Advanced Customizations for Universal Login](/docs/ja/customize/login-pages/advanced-customizations) を推奨しています。
</Warning>
