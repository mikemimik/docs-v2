...
4. 以下で使用する必要な資格情報を確認するには、**設定** タブをクリックします。詳しくは、[アプリケーション設定](/docs/ja/get-started/applications/application-settings) を参照してください。
...
* [PHP Web アプリケーション](/docs/ja/quickstart/webapp/php/)
* [PHP Backend API](/docs/ja/quickstart/backend/php/)
...
* [PHP: Auth0-PHP での Management API の使用](/docs/ja/libraries/auth0-php/using-the-management-api-with-auth0-php)
* [PHP: Auth0-PHP での JWT (JSON Web トークン) の検証](/docs/ja/libraries/auth0-php/validating-jwts-with-auth0-php)
