...
アプリケーション向けに Lock をカスタマイズする際、さらに詳しい情報が必要な場合は、[configuration options](/docs/ja/libraries/lock/lock-configuration) ページまたは [Lock API](/docs/ja/libraries/lock/lock-api-reference) ページをご覧ください。
