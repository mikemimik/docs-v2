...
Voici un exemple en pseudo-JavaScript montrant comment vous pourriez implémenter la fonction `login`. Pour des exemples de scripts propres au langage, consultez [Exemples de scripts propres au langage](/fr-CA/docs/authenticate/database-connections/custom-db/templates/verify#language-specific-script-examples).
