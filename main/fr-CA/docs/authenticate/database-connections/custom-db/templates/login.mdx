...
L’objet d’erreur personnalisé `WrongUsernameOrPasswordError` vous permet de transmettre des données qui s’afficheront dans vos [journaux du tenant](/fr-CA/docs/deploy-monitor/logs).
...
* [Modèles de script pour Change Password](/fr-CA/docs/authenticate/database-connections/custom-db/templates/change-password)
* [Modèles de script pour Create](/fr-CA/docs/authenticate/database-connections/custom-db/templates/create)
* [Modèles de script pour Delete](/fr-CA/docs/authenticate/database-connections/custom-db/templates/delete)
* [Modèles de script pour Get User](/fr-CA/docs/authenticate/database-connections/custom-db/templates/get-user)
* [Modèles de script pour Verify](/fr-CA/docs/authenticate/database-connections/custom-db/templates/verify)
* [Modèle de script pour Change Email](/fr-CA/docs/authenticate/database-connections/custom-db/templates/change-email)