...
<Accordion title="Utiliser l’IA pour intégrer Auth0" icon="microchip-ai" iconType="solid" defaultOpen>
  ...
  **Demandez ensuite à votre assistant IA :**
  ...
  Votre assistant IA créera automatiquement votre Auth0 API, récupérera les credentials, installera `@auth0/auth0-fastify-api`, configurera le Plugin et protégera vos API endpoints avec la validation JWT. [Documentation complète sur Agent Skills →](/fr-CA/docs/quickstart/agent-skills)
</Accordion>
...
* **[Quickstart d’application Web Fastify](/fr-CA/docs/quickstart/webapp/fastify)** - Créez une application Web qui appelle votre API
