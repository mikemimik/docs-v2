...
<Accordion title="Organizations (B2B/entreprise)">
  ...
  Pour en savoir plus, consultez [Organizations](/fr-CA/docs/manage-users/organizations).
</Accordion>
...
<Accordion title="Personnaliser Universal Login">
  ...
  Pour en savoir plus, consultez [Customize Universal Login](/fr-CA/docs/customize/universal-login-pages).
</Accordion>
...
<CardGroup cols={3}>
  ...
  <Card title="Pratiques exemplaires relatives aux jetons" icon="key" href="/fr-CA/docs/secure/tokens/token-best-practices">
