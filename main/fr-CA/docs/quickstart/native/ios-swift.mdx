...
<Accordion title="Déploiement en production">
  ...
  * **N’**épinglez **PAS** les certificats de l’Auth0 API - [Auth0 ne recommande pas cette pratique](/fr-CA/docs/troubleshoot/product-lifecycle/past-migrations#avoid-pinning-or-fingerprinting-tls-certificates-for-auth0-endpoints)
