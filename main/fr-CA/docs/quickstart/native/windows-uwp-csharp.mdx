...
<CardGroup cols={2}>
  ...
  <Card title="Organizations" icon="building" href="/fr-CA/docs/manage-users/organizations">
  ...
  <Card title="Role-Based Access Control" icon="shield-halved" href="/fr-CA/docs/manage-users/access-control/rbac">
