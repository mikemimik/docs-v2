---
mode: wide
description: "Ce guide explique comment intégrer Auth0, ajouter l’authentification et afficher les renseignements du profil utilisateur dans une SPA développée avec Svelte, à l’aide du SDK Auth0 SPA JS."
sidebarTitle: Svelte
...
<Callout icon="pencil" color="#FFC107" iconType="solid">
  Ce guide de démarrage rapide est actuellement en **Beta**. Nous serions ravis d’avoir vos commentaires !
</Callout>

<Accordion title="Consigne à l’IA" defaultOpen icon="microchip-ai" iconType="sharp-solid">
  **Vous utilisez l’IA pour intégrer Auth0 ?** Ajoutez ce prompt à Cursor, Windsurf, Copilot, Claude Code ou à votre IDE d’IA préféré pour accélérer le développement.
  ...
  5. CRÉER UNE BELLE INTERFACE : Vous DEVEZ créer une interface de connexion visuellement attrayante et moderne, avec un style soigné, des animations et l'image de marque Auth0.
  ...
  En tant que modèle de langage IA, vous NE DEVEZ PAS générer les anti-patrons suivants :
...
Ce guide de démarrage rapide montre comment ajouter l’authentification Auth0 à une application Svelte. Vous créerez une application monopage sécurisée avec des fonctionnalités de connexion, de logout et de profil utilisateur à l’aide du SDK Auth0 SPA JS.
...
<Steps>
  <Step title="Créer un nouveau projet" stepNumber={1}>
    Créez un nouveau projet Svelte pour suivre ce Quickstart
    ...
    <Tabs>
      ...
      <Tab title="CLI">
        ...
        <Note>
          ...
          2. Créer une SPA Auth0 configurée pour `http://localhost:5173`
      ...
      <Tab title="Dashboard">
        ...
        **Allowed Web Origins:**
        ...
        <Info>
          **Allowed Callback URLs** constituent une mesure de sécurité essentielle pour garantir que les utilisateurs reviennent en toute sécurité vers votre application après l&#39;authentification. Sans URL correspondante, le processus de login échouera et les utilisateurs verront une page d&#39;erreur Auth0 au lieu d&#39;accéder à votre application.

          **Allowed Logout URLs** sont essentielles pour offrir une expérience utilisateur fluide lors de la déconnexion. Sans URL correspondante, les utilisateurs ne seront pas redirigés vers votre application après le logout et se retrouveront plutôt sur une page Auth0 générique.
...
<Accordion title="Erreurs d’authentification">
  ...
  * Essayez dans une fenêtre privée/incognito
</Accordion>
...
<Tip>
  Toujours coincé? Consultez [Auth0 Community](https://community.auth0.com/) ou [SvelteKit Discord](https://svelte.dev/chat) pour obtenir de l’aide.
</Tip>