...
1. [Configurez domaine personnalisé avec Self-Managed Certificates](/docs/fr-CA/customize/custom-domains/self-managed-certificates) si ce n’est pas déjà fait. Prenez en note les valeurs **Origin Domain Name** et `cname-api-key` pour les utiliser plus tard.
