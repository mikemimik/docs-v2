...
<Card title="Avant de commencer">
  ...
  * `create:users_app_metadata`
  ...
  2. Ajoutez une [connexion Vault](/fr-CA/docs/customize/forms/vault) à l’aide des informations d’identification de l’application M2M.
</Card>
...
Les sections ci-dessous expliquent comment créer un formulaire de profil progressif à l’aide de nœuds et de flux, ainsi que les étapes pour ajouter votre formulaire à une [Action Post Login](/fr-CA/docs/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger).
...
Le nœud Step correspond à l’interface graphique visible par les utilisateurs. Ajoutez des [Fields](/fr-CA/docs/customize/forms/nodes-and-components) au nœud Step pour recueillir le nom de l’entreprise de l’utilisateur et son titre de poste en suivant les étapes ci-dessous :
