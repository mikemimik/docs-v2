...
Vous pouvez gérer la configuration du rendu dans l’Auth0 Dashboard, au moyen d’outils d’infrastructure-as-code ou de l’Auth0 Management API. Pour savoir comment faire, consultez [Configurer ACUL](/fr-CA/docs/customize/login-pages/advanced-customizations/configure/overview). Pour le schéma complet de l’API, consultez le endpoint [`PATCH /v2/prompts/{prompt}/screen/{screen}/rendering`](/fr-CA/docs/api/management/v2/prompts/patch-rendering).
