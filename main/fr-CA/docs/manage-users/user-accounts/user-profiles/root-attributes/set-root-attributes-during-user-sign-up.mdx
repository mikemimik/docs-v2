...
* [Définir les attributs racine lors de l’importation des utilisateurs](/docs/fr-CA/manage-users/user-accounts/user-profiles/root-attributes/set-root-attributes-during-user-import)