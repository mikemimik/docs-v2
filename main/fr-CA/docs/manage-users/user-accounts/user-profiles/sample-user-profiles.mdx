...
Voici un exemple de profil utilisateur d’un utilisateur qui s’est connecté avec **Google** :
...
<div id="microsoft-account-user-profile">
  ## Profil utilisateur du compte Microsoft
</div>

Voici un exemple de profil pour **Microsoft Account** :
...
Voici un exemple de profil tiré de **ADFS (Active Directory Federation Services)** :
