...
Le style de la barre de recherche de Lock <Tooltip tip="Passwordless : forme d’authentification qui ne repose pas sur l’utilisation d’un mot de passe comme premier facteur." cta="Voir le glossaire" href="/docs/fr-CA/glossary?term=Passwordless">Passwordless</Tooltip>.
