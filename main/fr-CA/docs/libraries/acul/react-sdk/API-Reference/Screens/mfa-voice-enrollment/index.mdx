...
L’écran `mfa-voice-enrollment` permet à l’utilisateur d’enregistrer un numéro de téléphone pour l’AMF par appel vocal en entrant son numéro.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les configurations de branding, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `mfa-voice-enrollment`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des informations sur l’Organization de l’utilisateur si le flux MFA est limité à une Organization. Retourne `null` lorsqu’aucun contexte d’Organization n’est présent.
...
<ParamField body="useUser" type={<span>() =&gt; <a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/UserMembers">UserMembers</a></span>}>
  Ce hook fournit des informations sur l’utilisateur actif, notamment son `username`, son `email` et les méthodes d’authentification disponibles.
...
<ParamField body="useMfaVoiceEnrollment" type={<a href="/docs/fr-CA/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaVoiceEnrollmentMembers">MfaVoiceEnrollmentMembers</a>}>
  Ce hook renvoie toutes les méthodes et le contexte disponibles sur l’écran `mfa-voice-enrollment`.
</ParamField>
