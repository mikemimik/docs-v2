...
L’écran `login-passwordless-sms-otp` demande à l’utilisateur d’entrer un code à usage unique envoyé à son numéro de téléphone afin de terminer l’authentification SMS sans mot de passe.
...
* L’utilisation de root import vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous souhaitez une compilation unifiée pour gérer tous les écrans possibles.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les configurations de branding, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `login-passwordless-sms-otp`.
...
<ParamField body="submitOTP" type="Promise<void>">
  Cette méthode transmet le code à usage unique pour terminer l’authentification SMS sans mot de passe.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="connection" type="string" required>
      Nom de la connexion vers laquelle basculer. Utilisez &#39;email&#39; ou &#39;sms&#39; pour le mode sans mot de passe, ou un nom de connexion DB pour l’authentification par mot de passe.
    </ParamField>
...
<ParamField body={<a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Ce hook récupère les options du thème actuel à partir de la configuration mise à plat du contexte de branding.
</ParamField>
