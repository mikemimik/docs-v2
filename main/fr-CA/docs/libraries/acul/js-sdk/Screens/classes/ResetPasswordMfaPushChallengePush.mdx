...
<ParamField body="pollingManager" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/MfaPushPollingControl">MfaPushPollingControl</a></span>}>
  ...
  Le [`MfaPushPollingControl`](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/MfaPushPollingControl) retourné expose `startPolling()`, `stopPolling()` et `isRunning()` pour gérer le cycle de vie de l’interrogation.
