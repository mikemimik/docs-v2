  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="captcha?" type="string">
      Le code captcha ou la réponse du fournisseur CAPTCHA. Cette propriété est requise si [Bot Detection](/fr-CA/docs/secure/attack-protection/bot-detection) est activé pour votre tenant Auth0.
    </ParamField>
