...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `interstitial-captcha` de Universal Login."
---

La classe InterstitialCaptcha implémente la fonctionnalité de l’écran `interstitial-captcha`. Cet écran invite l’utilisateur à remplir un CAPTCHA pendant le flux d’authentification.
...
<ParamField body="untrustedData" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Contient les données non fiables transmises au SDK, comme la saisie de l’utilisateur pendant le flux de vérification CAPTCHA.
</ParamField>
