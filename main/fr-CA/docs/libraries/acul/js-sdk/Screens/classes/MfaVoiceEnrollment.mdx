...
Créer une instance du gestionnaire de l’écran d’inscription vocale MFA :
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant l’inscription vocale MFA.
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  Cette méthode poursuit le processus d’inscription vocale MFA avec le numéro de téléphone fourni.
