---
title: "LoginId"
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `login-id` de Universal Login."
---

La classe LoginId implémente les fonctionnalités de l’écran `login-id`. Cet écran recueille l’identifiant et le mot de passe de l’utilisateur. Selon votre tenant, cet identifiant peut être une adresse courriel, un numéro de téléphone ou un nom d’utilisateur.
...
<ParamField body="branding" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Fournit la configuration liée à l’image de marque, comme le thème d’image de marque et les paramètres.
</ParamField>
...
<ParamField body="client" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit la configuration du client, comme `id`, `name` et `logoUrl`, pour l’écran `login-id`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Traite les données non fiables transmises au SDK, comme les saisies de l’utilisateur lors de la connexion.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="language" type="string" required>
      Le code de la locale de la langue voulue (par exemple, `'en'`, `'fr'`, `'es'`).
    </ParamField>
...
<ParamField body="getErrors" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a>[]</span>}>
  Cette méthode récupère le tableau des erreurs de transaction à partir du contexte, ou un tableau vide s’il n’y en a aucune. Un tableau d&#39;objets d&#39;erreur extrait du contexte de la transaction.
</ParamField>
...
<ParamField body="pickCountryCode" type="Promise<void>">
  Cette méthode redirige l’utilisateur vers la liste de sélection de l’indicatif de pays, où il peut modifier l’indicatif associé à son numéro de téléphone.
...
<ParamField body="registerPasskeyAutofill" type="Promise<void>">
  Cette méthode initialise une demande passive de justificatif WebAuthn à l’aide de `navigator.credentials.get()` avec `mediation: conditional`. Lorsque cette fonctionnalité est prise en charge, le navigateur peut afficher les clés d’accès enregistrées directement dans la liste déroulante d’autocomplétion du champ de nom d’utilisateur.
