...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `reset-password-success` de Universal Login."
---

La classe ResetPasswordSuccess implémente la fonctionnalité de l’écran `reset-password-success`. Cet écran confirme à l’utilisateur que son mot de passe a été réinitialisé avec succès.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/5eQfQYCZSu4ZaYaYz3ln8j/d6fdc02e205c14388aa13f868fa747a3/Screenshot_2025-01-28_at_10.16.09.png" alt="Réinitialisation du mot de passe réussie ACUL" />
</Frame>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="persist?" type="&#x22;session&#x22;">
      Lorsqu’il est défini à `'session'`, la langue sélectionnée est conservée pendant toute la durée de la session.
    </ParamField>
  </Expandable>
</ParamField>
