---
title: "RedeemTicket"
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `redeem-ticket` d’Universal Login."
---

La classe RedeemTicket assure la fonctionnalité de l’écran `redeem-ticket`. Cet écran s’affiche lorsqu’un utilisateur doit utiliser un ticket pour poursuivre le flux d’authentification.
...
<ParamField body="untrustedData" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme la saisie de l’utilisateur pendant le flux d’utilisation du ticket.
</ParamField>
