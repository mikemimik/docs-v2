...
La classe MfaOtpEnrollmentQr prend en charge la fonctionnalité de l’écran `mfa-otp-enrollment-qr`. Cet écran affiche un code QR que l’utilisateur peut scanner avec son application d’authentification lors de l’inscription MFA.
...
<ParamField body="screen" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnMfaOtpEnrollmentQr">ScreenMembersOnMfaOtpEnrollmentQr</a></span>}>
  Contient des détails propres à l’écran `mfa-otp-enrollment-qr`, notamment sa configuration et son contexte.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les entrées de l’utilisateur pendant l’inscription MFA OTP.
</ParamField>
...
<ParamField body="toggleView" type="Promise<void>">
  Cette méthode permet de basculer entre les vues par code QR et par saisie manuelle.
