...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `mfa-phone-challenge` dans Universal Login."
---
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant la vérification MFA par téléphone.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="type" type="&#x22;sms&#x22; | &#x22;voice&#x22;" required>
      Le mode de livraison du code MFA.
    </ParamField>
  </Expandable>
</ParamField>
