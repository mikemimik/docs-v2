...
<ParamField body="continue" type="Promise<void>">
  ...
  Une promesse qui est résolue lorsque l’opération se poursuit avec succès.
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/docs/fr-CA/libraries/acul/js-sdk/Screens/interfaces/MfaRecoveryCodeChallengeContinueOptions">MfaRecoveryCodeChallengeContinueOptions</a></span>}>
      Les options de poursuite contenant le code de récupération et des options personnalisées facultatives.
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  Accède à l’écran où l’utilisateur peut choisir une autre méthode AMF.
