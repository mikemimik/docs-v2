...
export interface ScreenMembersOnMfaRecoveryCodeChallengeNewCode extends ScreenMembers {
  ...
  data: {
     ...
     * Il est essentiel que l'utilisateur conserve ce code en lieu sûr, car il sera nécessaire pour les connexions futures si les autres facteurs MFA sont indisponibles.
     */
    textCode: string;
  } | null;
}
