...
Dans le cadre du [scénario d’architecture Serveur + API](/fr-CA/docs/get-started/architecture-scenarios/server-application-api), nous mettrons en œuvre l’API Timesheets en Node.js. Consultez le scénario pour en savoir plus sur la solution mise en œuvre.
