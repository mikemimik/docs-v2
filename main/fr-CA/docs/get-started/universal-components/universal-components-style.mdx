...
Auth0 Universal Components repose sur un système de design flexible qui utilise [Tailwind CSS](https://tailwindcss.com/docs/installation/using-vite) et les [primitives Radix UI](https://www.radix-ui.com/primitives/docs/overview/introduction). La personnalisation visuelle est gérée par [`Auth0ComponentProvider`](/fr-CA/docs/get-started/universal-components/auth0-component-provider), ce qui vous permet de choisir entre des préréglages généraux ou des surcharges précises de variables CSS.
...
<Tabs>
  <Tab title="React">
    ...
    Terminé. Tous les boutons, liens et états actifs utilisent maintenant votre marque.
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>Apparence standard d’Auth0 avec des ombres et des bordures équilibrées</td>
        </tr>
    ...
    ***
    ...
    <Tabs>
      <Tab title="Couleurs (claires)">
        ...
        --muted-foreground: oklch(45% 0 0); /_ texte de remplacement _/
    ...
    ***
    ...
    <Tabs>
      <Tab title="Couleurs (claires)">
        ...
        --card-foreground: oklch(0% 0 0); /_ texte dans les cartes _/
        --popover: oklch(100% 0 0); /_ arrière-plan du menu déroulant/dialogue _/
        --popover-foreground: oklch(9% 0 0); /_ texte dans les popovers _/
        --input: oklch(100% 0 0); /_ arrière-plan du champ de saisie _/

        /_ Secondaire & atténué _/
        --secondary: oklch(96% 0 0);
        --secondary-foreground: oklch(100% 0 0);
        --muted: oklch(96% 0 0); /_ arrière-plans désactivés _/
        --muted-foreground: oklch(45% 0 0); /_ texte d'espace réservé _/

        /_ Accent & destructif _/
        --accent: oklch(97% 0 0); /_ mises en évidence au survol _/
        --accent-foreground: oklch(9% 0 0);
        --destructive: oklch(93% 0.03 17); /_ états d'erreur _/
        --destructive-foreground: oklch(36% 0.14 17);
  ...
  <Tab title="shadcn">
    ...
    ***
    ...
    Toutes les propriétés visuelles sont définies par des propriétés CSS personnalisées. Remplacez-les dans votre feuille de style ou via la prop `themeSettings.variables`.

    <Tabs>
      <Tab title="Couleurs (mode clair)">
        ```css
        :root {
          /* Marque - les variables les plus importantes */
          --primary: oklch(37% 0 0);              /* boutons, liens, états actifs */
    ...
    * `classes` - classes Tailwind ou personnalisées appliquées à des parties précises du composant
    ...
    <Accordion title="Cibles de classe disponibles pour chaque composant">
