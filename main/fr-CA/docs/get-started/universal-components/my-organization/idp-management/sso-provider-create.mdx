...
Le composant `SsoProviderCreate` offre une interface unifiée pour ajouter de nouveaux fournisseurs d’[authentification unique](/fr-CA/docs/authenticate/enterprise-connections/self-service-enterprise-configuration).
  ...
  <Tab title="shadcn">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      **Configuration d’Auth0 requise** - Assurez-vous que votre tenant est configuré avec
      ...
      configuration →](/fr-CA/docs/get-started/universal-components/my-organization/build-delegated-admin#configure-auth0-dashboard)
    </Callout>
