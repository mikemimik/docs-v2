...
<Tabs>
  <Tab title="Management API">
    ...
    1. [Obtenez un jeton d’accès de la Management API](/fr-CA/docs/secure/tokens/access-tokens/management-api-access-tokens/get-management-api-access-tokens-for-production) avec la portée `create:network_acls`.
...
<Tabs>
  <Tab title="Management API">
    ...
    1. [Obtenez un jeton d’accès à la Management API](/fr-CA/docs/secure/tokens/access-tokens/management-api-access-tokens/get-management-api-access-tokens-for-production) avec la portée `create:network_acls`.
