---
description: Décrit comment utiliser la API MFA pour demander aux utilisateurs qui ont perdu l’accès à leur appareil ou à leur compte de s’authentifier à l’aide de codes de récupération.
title: Vérification à l’aide de codes de récupération
---
...
2. Authentifiez l’utilisateur avec un code de récupération. Appelez le point de terminaison OAuth Token avec le code de récupération pour l’authentifier et générer un nouveau code de récupération. Vous devez préciser les paramètres suivants :
...
3. Demandez à l’utilisateur de noter le code de récupération. Si l’appel réussit, vous obtiendrez les jetons d’authentification et un nouveau code de récupération :
...
* [Inscrire et lancer des demandes de vérification pour les authentificateurs SMS et vocaux](/docs/fr-CA/secure/multi-factor-authentication/authenticate-using-ropg-flow-with-mfa/enroll-challenge-sms-voice-authenticators)
* [Inscrire et lancer des demandes de vérification pour les authentificateurs Push](/docs/fr-CA/secure/multi-factor-authentication/authenticate-using-ropg-flow-with-mfa/enroll-and-challenge-push-authenticators)
* [Inscrire et lancer des demandes de vérification pour les authentificateurs OTP](/docs/fr-CA/secure/multi-factor-authentication/authenticate-using-ropg-flow-with-mfa/enroll-and-challenge-otp-authenticators)
* [Inscrire et lancer des demandes de vérification pour les authentificateurs par courriel](/docs/fr-CA/secure/multi-factor-authentication/authenticate-using-ropg-flow-with-mfa/enroll-and-challenge-email-authenticators)
* [Auth0 API MFA](/docs/fr-CA/secure/multi-factor-authentication/multi-factor-authentication-developer-resources/mfa-api)
