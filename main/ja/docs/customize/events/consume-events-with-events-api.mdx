...
* `read:events` スコープを持つ Management API アクセストークン。詳しくは、[Management API Access Tokens](/ja/docs/secure/tokens/access-tokens/management-api-access-tokens) をご覧ください。
