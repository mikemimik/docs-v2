...
イベント配信は自動的に再試行されます。詳しくは、[Best Practices](/ja/docs/customize/events/event-testing-observability-and-failure-recovery#batch-redelivery-of-failed-events)をご覧ください。
