...
[SSO Dashboard 拡張機能を追加](/ja/docs/customize/extensions/single-sign-on-dashboard-extension/install-sso-dashboard-extension)する前に、Auth0 でアプリケーションを作成する必要があります。
...
次に、[SSO Dashboard 拡張機能をインストール](/ja/docs/customize/extensions/single-sign-on-dashboard-extension/install-sso-dashboard-extension)し、[アプリケーションをダッシュボードに追加](/ja/docs/customize/extensions/single-sign-on-dashboard-extension/add-applications-to-the-sso-dashboard)する必要があります。

<div id="learn-more">
  ## 詳しく見る
</div>

* [シングルサインオン Dashboard Extension をインストールする](/ja/docs/customize/extensions/single-sign-on-dashboard-extension/install-sso-dashboard-extension)
