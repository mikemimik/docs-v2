...
[連携のユースケースについて詳しく見る](/docs/ja/customize/integrations/marketplace-partners/defining-an-integration-use-case)
...
[連携の詳細はこちら](/docs/ja/customize/integrations/marketplace-partners/introduction-to-integrating-with-auth0)
...
[Action 連携 の構築方法を見る](/docs/ja/customize/integrations/marketplace-partners/actions-integrations-for-partners)
...
[ソーシャルコネクションの構築方法を見る](/docs/ja/customize/integrations/marketplace-partners/social-connections-for-partners)

<div id="sso-integrations">
  #### SSO 連携
</div>

<Tooltip tip="Single Sign-On (SSO): ユーザーが1つのアプリケーションにログインすると、そのユーザーを他のアプリケーションにも自動的にログインさせるサービス。" cta="用語集を見る" href="/docs/ja/glossary?term=SSO">SSO</Tooltip> 連携では、Auth0 の ID を使用して、<Tooltip tip="Single Sign-On (SSO): ユーザーが1つのアプリケーションにログインすると、そのユーザーを他のアプリケーションにも自動的にログインさせるサービス。" cta="用語集を見る" href="/docs/ja/glossary?term=SAML">SAML</Tooltip> 経由で外部サービスにログインします。

[SSO 連携の構築方法を見る](/docs/ja/customize/integrations/marketplace-partners/sso-integrations-for-partners)
...
Enterprise connections は、顧客が OIDC を使用して外部のフェデレーション対応 <Tooltip tip="Identity Provider (IdP): デジタル ID を保存・管理するサービス。" cta="用語集を見る" href="/docs/ja/glossary?term=identity+provider">ID プロバイダー</Tooltip> でユーザーを認証できるようにする仕組みです。
