...
<AccordionGroup>
  ...
  <Accordion title="カスタムフィールド">
    ...
    詳しくは、[フォームのカスタムフィールドコンポーネント](/docs/ja/customize/forms/custom-field-components)をお読みください。
  </Accordion>
</AccordionGroup>
...
デフォルトでは、ルーターノードには **Default Case** という名前の通過ルールが 1 つあり、他のノードに接続されます。さらに、変数が満たす条件のセットに基づいてルールを追加し、他のノードに接続できます。詳しくは、[Router](/docs/ja/customize/forms/routers) をご覧ください。
...
フローノードを使用すると、フォームにカスタムロジックや統合フローを追加し、作成できます。詳しくは、[Flows](/docs/ja/customize/forms/flows)をご覧ください。
...
開始ノードはユーザーには表示されません。ここでは、[Action を使用してフォームをレンダリングする](/docs/ja/customize/forms/render)際のユーザー属性など、非表示フィールド変数を設定できます。
