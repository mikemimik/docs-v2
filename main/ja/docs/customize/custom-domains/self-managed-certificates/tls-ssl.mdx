...
<Warning>
  一部の環境では引き続き利用可能ですが、以下の TLS 1.2 暗号スイートは非推奨となっており、2026 年 6 月にサポートが終了します。詳細については、[脆弱な TLS 1.2 暗号スイート](/ja/docs/troubleshoot/product-lifecycle/deprecations-and-migrations#weak-tls-1-2-cipher-suites) を参照してください。
</Warning>
...
* [Cloudflareをリバースプロキシとして設定する](/ja/docs/customize/custom-domains/self-managed-certificates/configure-cloudflare-for-use-as-reverse-proxy)