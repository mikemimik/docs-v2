...
[Universal Login](/docs/ja/authenticate/login/auth0-universal-login/universal-login-vs-classic-login/universal-experience#universal-login-experience) の機能を拡張し、マルチブランド対応、複雑なセキュリティ構成、複数の分析プラットフォームとの連携をサポートします。
