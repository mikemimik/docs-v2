---
description: Datadog 向けに SAML2 Web App アドオンを使用して、Auth0 をアイデンティティプロバイダーとして設定する方法を説明します。
title: Datadog を SAML サービスプロバイダーとして設定する
---

Datadog では、次の <Tooltip tip="Security Assertion Markup Language (SAML): パスワードを使わずに 2 者間で認証情報をやり取りできる標準化されたプロトコルです。" cta="用語集を表示" href="/docs/ja/glossary?term=SAML">SAML</Tooltip> 設定を使用します。
