...
アプリケーションの設定に関する追加情報とガイダンスについては、[Measures Against Application Impersonation](/ja/docs/secure/security-guidance/measures-against-app-impersonation) を参照してください。