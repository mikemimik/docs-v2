...
2. アプリケーションがすべての組織ではなく特定の組織にのみアクセスする必要がある場合は、その特定の組織でアクセスする必要がある各 API に対して、[M2M Access を承認する](/ja/docs/manage-users/organizations/organizations-for-m2m-applications/authorize-m2m-access)。
