...
Management API で組織ドメインを削除するには、[organization の discovery domain を削除する endpoint](/docs/ja/api/management/v2/organizations/delete-discovery-domains-by-discovery-domain-id) (`DELETE /organizations/{id}/discovery-domains/{discovery_domain_id}`) を呼び出します。