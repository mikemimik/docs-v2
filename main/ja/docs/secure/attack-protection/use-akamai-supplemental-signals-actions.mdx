...
<Card title="開始する前に">
  ...
  * [Supplemental Signals を送信するように Akamai を設定する](/ja/docs/secure/attack-protection/configure-akamai-supplemental-signals)
</Card>

Akamai で Supplemental Signals を使用するように設定すると、それらのシグナルから提供されるデータを [Auth0 Actions](/ja/docs/customize/actions) で利用できます。
...
<AccordionGroup>
  ...
  <Accordion title="Akamai Bot Manager の結果に基づいて多要素認証（MFA）を要求する">
    ...
    1. **[アプリメタデータ](/ja/docs/manage-users/user-accounts/metadata/metadata-fields-data)を更新する**: score プロパティが指定した値を超えた場合、このセッションで MFA が必要であることを記録します。
