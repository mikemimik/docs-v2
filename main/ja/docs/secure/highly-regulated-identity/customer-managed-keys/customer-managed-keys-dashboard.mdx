...
Bring Your Own Key を使用すると、[Key Management Editor role](/ja/docs/get-started/manage-dashboard-access/add-dashboard-users) を持つユーザーは、<Tooltip tip="Auth0 Dashboard: サービスを設定するための Auth0 の主要製品。" cta="用語集を見る" href="/ja/docs/glossary?term=Auth0+Dashboard">Auth0 Dashboard</Tooltip> から、既定の Auth0 Environment Root Key を自身の 顧客提供ルートキー に置き換えることができます。
