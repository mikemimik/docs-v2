...
<ParamField body="useMfaRecoveryCodeChallenge" type={<a href="/docs/ja/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaRecoveryCodeChallengeMembers">MfaRecoveryCodeChallengeMembers</a>}>
  ...
  **メソッドのパラメータ**
  ...
  <Expandable title="パラメータ">
    <ParamField body="options">
      [MfaRecoveryCodeChallengeContinueOptions](/docs/ja/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaRecoveryCodeChallengeContinueOptions)。
    </ParamField>
