...
<ParamField body="useCurrentScreen()" type={<span><a href="/docs/ja/libraries/acul/react-sdk/API-Reference/Types/interfaces/CurrentScreenOptions">CurrentScreenOptions</a></span>}>
  ...
  * organization 固有の branding にアクセスするには `organization.metadata` を使用します
  ...
  [`CurrentScreenOptions`](/docs/ja/libraries/acul/react-sdk/API-Reference/Types/interfaces/CurrentScreenOptions) | `null`
