...
<ParamField body="useAuth0Themes()" type={<span><a href="/docs/ja/libraries/acul/react-sdk/API-Reference/Types/interfaces/FlattenedTheme">FlattenedTheme</a></span>}>
  ブランディングのコンテキストから、フラット化された設定を持つ現在のテーマオプションを取得する React Hook。

  ## 戻り値

  [`FlattenedTheme`](/docs/ja/libraries/acul/react-sdk/API-Reference/Types/interfaces/FlattenedTheme) | `null`
