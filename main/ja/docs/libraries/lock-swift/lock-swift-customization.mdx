...
以下に、Lock のスタイルや外観を設定するためのさまざまなオプションを示します。さらに、[動作設定オプション](/ja/docs/libraries/lock-swift/lock-swift-configuration-options) のページでは、Lock の動作や機能を変更するためのオプションも多数用意されています。
...
Lock の<Tooltip tip="パスワードレス: 最初の認証要素としてパスワードを使用しない認証方式。" cta="用語集を見る" href="/ja/docs/glossary?term=Passwordless">パスワードレス</Tooltip>検索バーのスタイル。
