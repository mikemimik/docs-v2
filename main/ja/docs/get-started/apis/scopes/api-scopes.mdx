...
2. これらのアクセスレベルをカスタムスコープとして定義します。 (スコープについては、[Scopes](/docs/ja/get-started/apis/scopes)を参照してください。)
...
アプリケーションのカスタム API アクセスを要求する方法を示す例については、[スコープとクレームのユースケース例](/docs/ja/get-started/apis/scopes/sample-use-cases-scopes-and-claims) を参照してください。
...
アプリケーションは、API へのリクエストに、その API で定義されている任意のスコープを含めることができます。ただし、利用可能なすべてのスコープをリクエストできるようにするのではなく、[アプリケーション向け API アクセスポリシー](/docs/ja/get-started/apis/api-access-policies-for-applications) を使用して、アプリケーションの API へのアクセス方法を制御できます。
...
* [API のアクセス許可を追加する](/docs/ja/get-started/apis/add-api-permissions)
...
* [テスト環境用の Management API アクセストークンを取得する](/docs/ja/secure/tokens/access-tokens/management-api-access-tokens/get-management-api-access-tokens-for-testing)