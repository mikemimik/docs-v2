...
`SsoProviderCreate` コンポーネントは、新しい[シングルサインオン](/ja/docs/authenticate/enterprise-connections/self-service-enterprise-configuration)プロバイダーを追加するための共通インターフェースを提供します。
