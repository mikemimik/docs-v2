    ...
    >
      <div className="w-[min(860px,90vw)] text-center px-0 py-2 md:px-6 md:py-12">
        ...
        <span className="mt-4 mb-10 text-center text-black/50 max-w-2xl mx-auto dark:text-white text-xl tracking-tight">
          Découvrez les plus récents exemples de code, articles et tutoriels,
          <br /> ainsi que la référence de l’API.
        </span>

        <div className="flex justify-center rounded-3xl overflow-hidden shadow-lg mt-4">
          {/* Bannière mobile en mode clair (< 420px) */}
          <img
            noZoom
          ...
          {/* Bannière ordinateur en mode clair (>= 420px) */}
          <img
            noZoom
          ...
          />
          {/* Bannière ordinateur en mode sombre (>= 420px) */}
          <img
            noZoom
            src="/docs/images/home/banner-dark.svg"
            alt="Bannière Auth0 Docs (sombre)"
...
export const LearnBasicsGrid = () => {
  const items = [
    ...
    {
      title: "Community",
      desc: "Joignez-vous à la Community pour poser des questions, faire des suggestions et partager vos commentaires sur le produit.",
    ...
    {
      title: "Soutien",
      desc: "Obtenez du soutien pour votre mise en œuvre d’Auth0.",
