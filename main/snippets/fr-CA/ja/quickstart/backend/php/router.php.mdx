...
routeResponse([
  ...
  'token' => $token,
      ...
      // Les routes suivantes sont là pour éviter toute confusion.
      // Comme cette application n'utilise pas de « route d'index », les requêtes sont redirigées vers /api/public.
      Route::add('/', function() {
