...
export const SignUpForm = () => {
  ...
  /**
   * Démo des flux d’authentification (sans bibliothèques d’interface utilisateur externes)
   * - Structure prête pour la production, avec Tailwind uniquement
   * - Liste d’applications stockée dans LocalStorage + configuration des URL par application
   * - 3 flux :
   *   1) Menu : Créer | Intégrer | Exemple
   *   2) Create Application -> ajoute l’application à la liste, puis redirige vers le flux Intégrer avec cette application présélectionnée
   *   3) Intégrer avec une application existante : sélectionner l’application + enregistrer les URL -> toast
   */
  function LoggedInForm({ sampleApp }) {
    ...
    function loadApps() {
      ...
      // initialisé avec les 3 éléments affichés dans les captures d’écran
              ...
              <Card className="p-5 hover:shadow-md transition">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-lg">Intégrer une application existante</h2>
                  </div>
                  <RightChevron className="w-4 h-4 text-zinc-500" />
                </div>
              </Card>
    ...
    return (
      <div className="flex flex-col gap-2 items-center h-full">
        ...
        >
          ...
          à votre compte existant pour vous intégrer directement à votre propre tenant.
        </span>
        <button
