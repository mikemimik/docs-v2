...
Puedes usar el endpoint `POST /api/v2/jobs/users-exports` para crear una tarea que exporte todos los usuarios asociados a una [conexión](/es/docs/authenticate/identity-providers) o todos los usuarios del tenant.
