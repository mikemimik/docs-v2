...
<Accordion title="Usa IA para integrar Auth0" icon="microchip-ai" iconType="solid" defaultOpen>
  ...
  **Luego, pídele a tu asistente de IA:**
  ...
  Tu asistente de IA creará automáticamente tu aplicación de Auth0, obtendrá las credenciales, añadirá la dependencia del SDK Auth0.swift, configurará Auth0.plist, establecerá las URL de devolución de llamada e implementará los flujos de inicio y cierre de sesión. [Documentación completa de agent skills →](/es/docs/quickstart/agent-skills)
</Accordion>
...
<Accordion title="Configuración del dominio personalizado">
  Si usas un [dominio personalizado](/es/docs/customize/custom-domains), utiliza ese valor en lugar de tu dominio de Auth0 en todas partes.
