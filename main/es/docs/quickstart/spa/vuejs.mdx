...
<Accordion title="Usa la IA para integrar Auth0" icon="microchip-ai" iconType="solid" defaultOpen>
  ...
  **Luego pídele a tu asistente de IA:**
  ...
  Tu asistente de IA creará automáticamente tu aplicación de Auth0, obtendrá las credenciales, instalará `@auth0/auth0-vue`, creará el plugin de autenticación y configurará tus rutas. [Documentación completa de agent skills →](/es/docs/quickstart/agent-skills)
</Accordion>
