---
title: Añade el inicio de sesión a tu aplicación Vue
sidebarTitle: Vue
description: Esta guía muestra cómo integrar Auth0, añadir autenticación y mostrar información del perfil del usuario en cualquier aplicación Vue mediante el SDK de Auth0 para Vue.
mode: wide
---
...
Esta guía Quickstart muestra cómo integrar la autenticación de Auth0 en una aplicación de Vue.js 3. Crearás una aplicación adaptable de una sola página con autenticación segura de usuarios mediante la API de composición de Vue y el SDK de Auth0 para Vue.
...
<Steps>
  ...
  <Step title="Instala el SDK de Vue de Auth0" stepNumber={2}>
    ```shellscript
  ...
  <Step title="Configura tu Auth0 App" stepNumber={3}>
    ...
    <Tabs>
      <Tab title="Quick Setup (recomendado)">
        Crea una Auth0 App y copia el archivo `.env` pregenerado con los valores de configuración correctos.
      ...
      <Tab title="Dashboard">
        ...
        **Allowed Web Origins:**
        ...
        <Info>
          ...
          **Allowed Logout URLs** son esenciales para ofrecer una experiencia de usuario fluida al cerrar sesión. Sin una URL coincidente, los usuarios no volverán a ser redirigidos a tu aplicación después del cierre de sesión y, en su lugar, permanecerán en una página genérica de Auth0.
...
<Accordion title="Protección de rutas con Vue Router">
  Usa las guardias de navegación de Vue Router para proteger rutas específicas:
...
<Accordion title="Llamar a APIs protegidas">
  Configura tu plugin de Auth0 para incluir una audience de API y hacer solicitudes autenticadas:
  ...
  Luego, haz llamadas autenticadas a la API en tus componentes:
...
<Accordion title="Usar composables para la lógica de autenticación">
