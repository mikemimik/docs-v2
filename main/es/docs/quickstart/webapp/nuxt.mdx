...
<Accordion title="Usa IA para integrar Auth0" icon="microchip-ai" iconType="solid" defaultOpen>
  ...
  **Luego, pídele a tu asistente de IA:**
  ...
  Tu asistente de IA creará automáticamente tu aplicación de Auth0, obtendrá las credenciales, instalará `@auth0/auth0-nuxt`, configurará el módulo y preparará tus rutas. [Documentación completa de agent skills →](/es/docs/quickstart/agent-skills)
</Accordion>
...
<Note>
  ...
  **Compatibilidad de versiones de Nuxt:** Este quickstart funciona con **Nuxt 3.x** de forma inmediata. Para **Nuxt 4.x**, asegúrate de usar Nuxt 4.2+.
</Note>
...
<Steps>
  ...
  <Step title="Configura tu Auth0 App" stepNumber={3}>
    ...
    <Tabs>
      <Tab title="CLI">
        Ejecuta el siguiente comando de shell en el directorio raíz del proyecto para crear una app de Auth0 y generar un archivo `.env`:
  ...
  <Step title="Configura el módulo Auth0 para Nuxt" stepNumber={4}>
