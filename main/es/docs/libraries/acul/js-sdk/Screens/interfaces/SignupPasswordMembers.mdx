...
<ParamField body="federatedSignup" type="Promise<void>">
  <Expandable title="Parámetros">
    <ParamField body="payload" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/FederatedSignupPasswordPayloadOptions">FederatedSignupPasswordPayloadOptions</a></span>}>
      **Propiedades**
...
<ParamField body="signup" type="Promise<void>">
  <Expandable title="Parámetros">
    <ParamField body="payload" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/SignupPasswordOptions">SignupPasswordOptions</a></span>}>
      **Propiedades**
