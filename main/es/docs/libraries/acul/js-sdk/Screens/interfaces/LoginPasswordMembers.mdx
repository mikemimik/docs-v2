...
<ParamField body="federatedLogin" type="Promise<void>">
  <Expandable title="Parámetros">
    <ParamField body="payload" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/FederatedLoginPasswordOptions">FederatedLoginPasswordOptions</a></span>}>
      **Propiedades**
...
<ParamField body="login" type="Promise<void>">
  <Expandable title="Parámetros">
    <ParamField body="payload" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/LoginPasswordOptions">LoginPasswordOptions</a></span>}>
      **Propiedades**
