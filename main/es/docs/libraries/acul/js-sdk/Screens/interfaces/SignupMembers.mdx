...
<ParamField body="getSignupIdentifiers" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/Identifier">Identifier</a>[]</span>}>
  **`Función utilitaria`**
  ...
  Un arreglo de objetos [identificador](/es/docs/libraries/acul/js-sdk/Screens/interfaces/Identifier) habilitados, o `null` si la transacción no se ha inicializado.
