...
<ParamField body="pollingManager" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/MfaPushPollingControl">MfaPushPollingControl</a></span>}>
  ...
  El [`MfaPushPollingControl`](/es/docs/libraries/acul/js-sdk/Screens/interfaces/MfaPushPollingControl) devuelto expone `startPolling()`, `stopPolling()` e `isRunning()` para gestionar el ciclo de vida del sondeo.
