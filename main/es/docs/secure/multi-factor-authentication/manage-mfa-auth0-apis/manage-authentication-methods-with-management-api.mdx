...
<Card title="Antes de empezar">
  * Configura una [aplicación de máquina a máquina (M2M)](/docs/es/get-started/auth0-overview/create-applications/machine-to-machine-apps) y [otórgale acceso a la Auth0 Management API](/docs/es/secure/tokens/access-tokens/management-api-access-tokens/get-management-api-access-tokens-for-production) con los siguientes scopes:
...
La [Auth0 Management API](https://auth0.com/docs/api/management/v2) proporciona varios endpoints que puedes usar para administrar los métodos de autenticación MFA de tus usuarios. <Tooltip tip="Autenticación multifactor (MFA): Proceso de autenticación del usuario que utiliza un factor además del nombre de usuario y la contraseña, como un código vía SMS." cta="Ver glosario" href="/docs/es/glossary?term=MFA">MFA</Tooltip>

Este método se basa en la autenticación mediante una aplicación confidencial. Para obtener más información sobre las aplicaciones confidenciales y públicas, consulta [Aplicaciones confidenciales y públicas](/docs/es/get-started/applications/confidential-and-public-applications).
