...
<ParamField query="invitation" type="string">
  ID del ticket de invitación de la organización. Al [invitar a un miembro a una Organization](/organizations/invite-members), tu aplicación debe gestionar la aceptación de la invitación reenviando los pares clave-valor `invitation` y `organization` cuando el usuario la acepte.
</ParamField>
