...
El cambio flexible entre conexiones es una función opcional que permite a los usuarios elegir su método de autenticación al iniciar sesión en una aplicación. Cuando se implementa, la pantalla de inicio de sesión de su aplicación ofrece a los usuarios la opción de autenticarse con credenciales tradicionales de base de datos o con una conexión <Tooltip tip="" cta="Ver glosario" href="/es/docs/glossary?term=passwordless">passwordless</Tooltip>. Los usuarios que seleccionan una [conexión passwordless](/es/docs/authenticate/passwordless) reciben una contraseña de un solo uso (OTP) por correo electrónico o SMS, que pueden usar para iniciar sesión en su aplicación.

El cambio flexible entre conexiones usa [prompts personalizados de Universal Login](/es/docs/customize/login-pages/universal-login/customize-signup-and-login-prompts) para ofrecer a los usuarios una experiencia de autenticación con mayor autonomía.
...
* Utilice [Universal Login](/es/docs/authenticate/login/auth0-universal-login).
