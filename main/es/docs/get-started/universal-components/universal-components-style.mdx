...
description: Personaliza el sistema de diseño de Auth0 Universal Components con Tailwind CSS, variables de CSS y preajustes de tema integrados.
...
<Warning>
  ...
  Agreement de Okta](https://www.okta.com/agreements/). Para obtener más información, lee [Product
  Release Stages](/docs/es/troubleshoot/product-lifecycle/product-release-stages).
</Warning>

Auth0 Universal Components se basa en un sistema de diseño flexible que utiliza [Tailwind CSS](https://tailwindcss.com/docs/installation/using-vite) y [primitivas de Radix UI](https://www.radix-ui.com/primitives/docs/overview/introduction). El estilo se gestiona mediante [`Auth0ComponentProvider`](/docs/es/get-started/universal-components/auth0-component-provider), lo que te permite elegir entre preajustes generales o sobrescrituras granulares de variables de CSS.

Esta arquitectura garantiza que tus flujos de identidad tengan la apariencia y el comportamiento nativos de tu aplicación.
...
<Tabs>
  <Tab title="React">
    ...
    <Tabs>
      ...
      <Tab title="Tipografía">
        ...
        :root {
          ...
          --font-size-label:            0.875rem;  /* 14px - etiquetas del formulario */
    ...
    * `variables` - sobrescrituras de propiedades personalizadas de CSS limitadas a ese componente
    * `classes` - clases de Tailwind o personalizadas aplicadas a partes específicas del componente

    <Accordion title="Clases objetivo disponibles por componente">
  ...
  <Tab title="Next.js">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      ...
      **Usuarios de Shadcn:** No hace falta importar nada; los estilos ya están incluidos en tu compilación de Tailwind.
    </Callout>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Menor peso visual, con menos sombras y bordes más suaves</td>
        </tr>
    ...
    * `variables` - sobrescrituras de propiedades personalizadas de CSS para el componente
    * `classes` - clases de Tailwind o personalizadas aplicadas a partes específicas del componente
  ...
  <Tab title="shadcn">
    ...
    * `variables` - sobrescrituras de propiedades personalizadas de CSS acotadas al componente
    * `classes` - clases de Tailwind o personalizadas aplicadas a partes específicas del componente
    ...
    ***
    ...
    Los componentes responden automáticamente a la configuración de `mode` en `themeSettings`. Para sincronizar con el modo oscuro de tu aplicación:
