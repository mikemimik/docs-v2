...
Auth0 Universal Components se basa en un sistema de diseño flexible que utiliza [Tailwind CSS](https://tailwindcss.com/docs/installation/using-vite) y [primitivas de Radix UI](https://www.radix-ui.com/primitives/docs/overview/introduction). El estilo se gestiona mediante [`Auth0ComponentProvider`](/es/docs/get-started/universal-components/auth0-component-provider), lo que te permite elegir entre preajustes generales o sobrescrituras granulares de variables de CSS.
